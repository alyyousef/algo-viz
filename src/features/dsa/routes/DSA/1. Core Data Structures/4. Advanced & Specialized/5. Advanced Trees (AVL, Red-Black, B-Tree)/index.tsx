...
const quickGlossary = [
  ...
  {
    term: 'B-tree',
    definition: 'A multiway search tree optimized for block storage by keeping many keys per node.',
  },
  {
    term: 'B+ tree',
    definition:
...
export default function AdvancedTreesPage(): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <p>
        Balanced trees enforce logarithmic height so lookups and updates stay predictable. AVL
        tightens height strictly, red-black eases balancing for cheaper updates, and B-tree families
        trade depth for wide fanout to minimize cache and disk misses.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          <section id="bp-overview" className="bin98-section">
            ...
            <p>
              Balanced trees solve the same problem with different levers: control height. AVL uses
              strict balance factors, red-black uses color parity, and B-trees widen nodes to slash
              depth.
            </p>
            <p>
              The right choice depends on where time is spent: CPU rotations, cache locality, or
              disk I/O. All three families guarantee logarithmic operations, but with different
              constants and data layout tradeoffs.
            </p>
          </section>
      ...
      {activeTab === 'core-concepts' && (
        <>
          ...
          <section id="core-complexity" className="bin98-section">
            ...
            <p>
              Heights differ subtly but matter: AVL height about 1.44 log2 n, red-black about 2 log2
              n, B-tree height about log base fanout of n. Cache and I/O dominate constants, so
              choose structure with your memory hierarchy in mind.
            </p>
          </section>
