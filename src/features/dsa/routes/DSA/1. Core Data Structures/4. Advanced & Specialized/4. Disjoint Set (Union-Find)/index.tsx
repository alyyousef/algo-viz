...
const quickGlossary = [
  ...
  },
  {
    ...
    definition: 'A find optimization that rewires traversed nodes directly to the component root.',
  },
  {
  ...
  },
  {
    ...
    definition: 'A very slowly growing function that bounds amortized union-find complexity.',
  },
  {
    term: 'Rollback DSU',
...
export default function DisjointSetPage(): JSX.Element {
  const { activeTab, setActiveTab } = useTopicTabs({
    tabs,
    pageTitle: 'Disjoint Set (Union-Find)',
  ...
  return (
    ...
    >
      <h1 className="bin98-doc-title">Disjoint Set (Union-Find)</h1>
      <p>
        Disjoint sets answer a simple question fast: are two elements in the same component, and if
        not, merge their components. With path compression and union by size or rank, the data
        structure delivers almost O(1) amortized finds and unions, powering everything from MST
        construction to connected-component labeling.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          <section id="bp-overview" className="bin98-section">
            ...
            <p>
              Graph algorithms repeatedly ask whether two nodes are already connected. Running a
              full traversal per query is wasteful. Union-find keeps a forest of shallow trees so
              each query or merge touches only a handful of pointers, no matter how many elements
              you track.
            </p>
            <p>
              The core operation pair is <strong>find</strong> for component identity and{' '}
              <strong>union</strong> for component merging. The entire design goal is to make both
              operations cheap over long sequences.
            </p>
          </section>
      ...
      {activeTab === 'core-concepts' && (
        <>
          ...
          <section id="core-mechanics" className="bin98-section">
            <h2 className="bin98-heading">Structure and Operations</h2>
            {mechanics.map((item) => (
          ...
          <section id="core-complexity" className="bin98-section">
            ...
            <p>
              Inverse Ackermann growth means you can treat operation cost as constant in most
              benchmarks. Micro-optimization efforts usually target cache friendliness and branch
              behavior, not asymptotic bounds.
            </p>
          </section>
