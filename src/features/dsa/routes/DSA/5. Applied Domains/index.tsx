...
export default function AppliedDomainsPage(): JSX.Element {
  ...
  return (
    ...
    >
      <h1 className="bin98-doc-title">Applied Domains</h1>
      <p className="app98-intro">
        This page is the top-level overview for the applied part of the DSA material. It explains
        how core algorithms transform when they are embedded in storage engines, distributed
        systems, operating systems, games, ML pipelines, cryptographic protocols, and scientific
        workloads.
      </p>

      {activeTab === 'big-picture' && (
        <>
          <section id="app-overview" className="bin98-section">
          ...
          <section id="app-why" className="bin98-section">
            <h2 className="bin98-heading">Why Applied Domains Matter</h2>
            <ul>
          ...
          <section id="app-history" className="bin98-section">
          ...
          <section id="app-survey" className="bin98-section">
          ...
          <section id="app-themes" className="bin98-section">
          ...
          <section id="app-takeaways" className="bin98-section">
      ...
      {activeTab === 'core-concepts' && (
        <>
          <section id="app-signals" className="bin98-section">
          ...
          <section id="app-foundations" className="bin98-section">
          ...
          <section id="app-proofs" className="bin98-section">
          ...
          <section id="app-failures" className="bin98-section">
          ...
          <section id="app-compare" className="bin98-section">
          ...
          <section id="app-checklist" className="bin98-section">
      ...
      {activeTab === 'glossary' && (
        <section id="app-glossary" className="bin98-section">
