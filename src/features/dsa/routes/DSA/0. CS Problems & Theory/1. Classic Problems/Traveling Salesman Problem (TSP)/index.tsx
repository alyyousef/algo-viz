...
const bigPicture = [
  {
    ...
    notes: 'It is a cornerstone NP-hard optimization problem with huge practical impact.',
  },
  {
    title: 'Why it matters',
    details:
      'TSP models routing, scheduling, circuit design, and logistics, where small improvements save major costs.',
    notes: 'It is used to benchmark exact and heuristic optimization methods.',
  },
  {
    title: 'What it teaches',
    details:
      'Combinatorial explosion, approximation strategies, and tradeoffs between optimality and runtime.',
    notes: 'It illustrates how algorithmic complexity shapes real-world systems.',
  },
]
...
const problemSetup = [
  {
    title: 'Input',
    detail: 'A set of n cities and a distance (or cost) between every pair of cities.',
  },
  {
    title: 'Output',
    detail: 'A minimum-length Hamiltonian cycle that visits all cities exactly once.',
  },
  {
    title: 'Objective',
    detail: 'Minimize total tour length.',
  },
  {
    title: 'Variants',
    detail: 'Symmetric vs asymmetric distances, metric vs non-metric, Euclidean vs arbitrary.',
  },
]
...
const glossary = [
  ...
  {
    term: 'Approximation',
    definition: 'An algorithm that guarantees a tour within a factor of optimal.',
  },
  {
    term: 'Heuristic',
    definition: 'A fast method that often works well but lacks worst-case guarantees.',
  },
  {
    term: 'Branch and bound',
    definition: 'Exact search that prunes partial solutions using lower bounds.',
  },
...
const algorithmLandscape = [
  ...
  },
  {
    ...
    detail: 'Christofides (1.5-approx) for metric TSP; MST-based 2-approx.',
  },
  {
  ...
  {
    title: 'Special cases',
    detail: 'Euclidean TSP allows geometric optimizations and strong practical solvers.',
  },
]
...
const complexity = [
  {
    title: 'NP-hard',
    detail: 'TSP is NP-hard; exact solutions grow exponentially with n.',
  },
  {
    title: 'Exact DP',
    detail: 'Held-Karp runs in O(n^2 2^n) time and O(n 2^n) space.',
  },
  {
    title: 'Lower bounds',
    detail: 'MST and 1-tree bounds help prune search in branch-and-bound solvers.',
  },
  {
    title: 'Approximation limits',
    detail: 'For non-metric TSP, no constant-factor approximation is known unless P=NP.',
  },
]
...
const exactMethods = [
  ...
  },
  {
    ...
    detail: 'Explore tours while pruning partial paths using optimistic lower bounds.',
  },
  {
    title: 'ILP formulations',
    detail: 'Binary variables x_ij with subtour elimination constraints enforce a valid tour.',
  },
  {
    title: 'Cutting planes',
    detail: 'Iteratively add constraints to eliminate subtours found by relaxed ILP solutions.',
  },
  {
    title: '1-tree bounds',
    detail:
...
const approximationAlgorithms = [
  {
    ...
    detail: 'Double an MST, take an Euler tour, then shortcut repeated vertices.',
  },
  {
    title: 'Christofides (1.5-approx)',
    detail: 'MST + minimum perfect matching on odd-degree nodes + Euler tour + shortcut.',
  },
  {
    title: 'ATSP approximations',
    detail: 'Approximation ratios are weaker; algorithms are more complex.',
  },
  {
    title: 'Double-tree variant',
    detail: 'Preorder traversal of an MST yields a 2-approx in metric spaces.',
  },
]
...
const heuristics = [
  {
    ...
    detail: 'Repeatedly go to the closest unvisited city.',
  },
  {
    title: '2-opt / 3-opt',
    detail: 'Iteratively improve a tour by swapping edges to reduce length.',
  },
  {
    title: 'Simulated annealing',
    detail: 'Accept worse moves with a decaying probability to escape local minima.',
  },
  {
    title: 'Genetic algorithms',
    detail: 'Evolve a population of tours using crossover and mutation.',
  },
  {
    title: 'Ant colony optimization',
    detail: 'Probabilistic exploration guided by pheromone trails.',
  },
  {
    title: 'Lin-Kernighan (LK)',
    detail: 'A powerful variable k-opt heuristic used in high-quality TSP solvers.',
  },
  {
    title: 'Greedy insertion',
    detail: 'Build a tour by inserting each city where it increases length the least.',
  },
]
...
const correctnessInsights = [
  {
    ...
    detail: 'DP and ILP methods guarantee optimal solutions but scale exponentially.',
  },
  {
    title: 'Approximation guarantees',
    detail: 'Metric TSP admits constant-factor approximations; non-metric does not.',
  },
  {
    title: 'Heuristic tradeoffs',
    detail: 'Heuristics trade guarantees for speed and practical quality.',
  },
  {
    title: 'Lower bounds matter',
    detail: 'Bounds like MST or 1-tree quantify how far a heuristic is from optimal.',
  },
]
...
const variants = [
  {
    ...
    detail: 'Symmetric distances satisfy d(i,j)=d(j,i); asymmetric relaxes this.',
  },
  {
    title: 'Metric vs non-metric',
    detail: 'Triangle inequality enables better approximations.',
  },
  {
    title: 'Euclidean TSP',
    detail: 'Distances are geometric; specialized solvers can be very effective.',
  },
  {
    title: 'Prize-collecting TSP',
    detail: 'You may skip some cities at a penalty.',
  },
  {
    title: 'Time windows',
    detail: 'Each city must be visited within a time interval, adding scheduling constraints.',
  },
  {
    title: 'Vehicle routing (VRP)',
    detail: 'Multiple tours with capacity constraints generalize TSP.',
  },
]
...
const applications = [
  {
    ...
    detail: 'Delivery routes, warehouse picking paths, and vehicle routing variants.',
  },
  {
    title: 'Circuit design',
    detail: 'PCB drilling paths and microchip wire routing.',
  },
  {
    title: 'Scheduling',
    detail: 'Order of tasks with transition costs.',
  },
  {
    title: 'Bioinformatics',
    detail: 'Genome sequencing and protein folding approximations.',
  },
  {
    title: 'Robotics',
    detail: 'Efficient coverage paths for inspection and mapping.',
  },
]
...
const formulations = [
  ...
  },
  {
    ...
    detail: 'Send one unit of flow through the tour to enforce connectivity.',
  },
  {
    title: 'Assignment relaxation',
    detail: 'Solve assignment then cut subtours; yields a lower bound.',
  },
]
...
const lowerBounds = [
  {
    title: 'MST bound',
    detail: 'Any tour contains a spanning tree, so MST weight is a lower bound for metric TSP.',
  },
  {
    title: '1-tree bound',
    detail: 'Add two cheapest edges to a chosen root plus MST on remaining nodes.',
  },
  {
    title: 'LP relaxation',
    detail: 'Relax integrality to get a fractional solution with a lower bound.',
  },
  {
    title: 'Held-Karp bound',
    detail: 'A strengthened 1-tree bound used in powerful exact solvers.',
  },
]
...
const pitfallsAndCounterexamples = [
  {
    ...
    detail: 'A greedy tour can be arbitrarily worse than optimal on contrived instances.',
  },
  {
  ...
  },
  {
    ...
    detail: 'Best symmetric heuristics can perform poorly when distances are asymmetric.',
  },
]
...
const commonPitfalls = [
  {
    ...
    description: 'Greedy tours can be far from optimal, especially in clustered data.',
  },
  {
  ...
  },
  {
    ...
    description: 'ILP formulations need subtour elimination constraints to prevent invalid cycles.',
  },
  {
    mistake: 'Expecting scalability from exact methods',
    description: 'Exact solvers can handle moderate n but still face exponential growth.',
  },
  {
    mistake: 'Using heuristics without validation',
    description: 'Always benchmark with known lower bounds or smaller exact solutions.',
  },
]
...
answer = min_j(dp[all][j] + dist[j][0])`,
    explanation: 'Exact but exponential: O(n^2 2^n).',
  },
  {
  ...
  for each pair of edges (a,b) and (c,d):
    if swapping reduces length:
      perform swap`,
    explanation: 'A simple yet powerful heuristic for improving tours.',
  },
  {
    title: 'MST 2-approx (metric)',
    code: `build MST
...
return tour`,
    explanation: 'Guarantees at most 2x optimal for metric TSP.',
  },
  {
...
Euler tour + shortcut -> tour`,
    explanation: '1.5-approximation for metric TSP.',
  },
  {
    title: 'Greedy insertion',
...
for each remaining city:
  insert where added length is minimal`,
    explanation: 'A simple constructive heuristic with decent performance in practice.',
  },
]
...
Optimal tour length = 4`,
    explanation: 'The perimeter tour is optimal; any crossing adds extra length.',
  },
  {
    title: 'Nearest neighbor trap',
    code: `Cluster A close together, Cluster B far away
Nearest neighbor can get stuck with a long final jump`,
    explanation: 'Greedy choices can create expensive late edges.',
  },
  {
    title: '2-opt removes crossings',
    code: `If edges (a,b) and (c,d) cross:
swap to (a,c) and (b,d) to reduce length`,
    explanation: 'In Euclidean TSP, removing crossings always improves or preserves length.',
  },
  {
    title: 'Non-metric failure',
    code: `d(A,C) > d(A,B) + d(B,C)
Shortcutting can increase total distance`,
    explanation: 'Triangle inequality is crucial for shortcut-based approximations.',
  },
]
...
const timelineScenarios = [
  {
    ...
    summary: 'DP enumerates subsets to guarantee optimality.',
  },
  {
    id: 'christofides',
    title: 'Christofides (metric)',
    ...
    summary: 'A 1.5-approximation for metric TSP.',
  },
  {
    id: 'two-opt',
    ...
    summary: 'Local search often yields strong solutions quickly.',
  },
  {
    id: 'branch-bound',
    title: 'Branch and bound',
    ...
    summary: 'Exact search becomes feasible by pruning large portions of the search tree.',
  },
]
...
const tspMindMap = [
  {
    id: 'root',
    title: 'TSP',
    detail: 'Shortest tour visiting each city exactly once.',
  },
  {
    id: 'complexity',
    title: 'Complexity',
    detail: 'NP-hard; exponential exact methods.',
  },
  {
    id: 'exact',
    title: 'Exact Methods',
    detail: 'DP, branch and bound, ILP.',
  },
  {
    id: 'approx',
    title: 'Approximation',
    detail: 'Christofides, MST 2-approx (metric).',
  },
  {
    id: 'heuristics',
    title: 'Heuristics',
    detail: 'Nearest neighbor, 2-opt, metaheuristics.',
  },
  {
    id: 'variants',
    title: 'Variants',
    detail: 'Metric, asymmetric, prize-collecting.',
  },
  {
    id: 'applications',
    title: 'Applications',
    detail: 'Routing, circuits, scheduling.',
  },
  {
    id: 'bounds',
    title: 'Lower Bounds',
    detail: 'MST, 1-tree, LP relaxation.',
  },
]
...
const evaluationChecklist = [
  {
    ...
    detail: 'If distances satisfy triangle inequality, use metric-specific algorithms.',
  },
  {
    title: 'Need exact or approximate?',
    detail: 'Exact solvers for small n; heuristics for large n.',
  },
  {
    title: 'Bound quality',
    detail: 'Compare heuristic tours against MST/1-tree or LP bounds.',
  },
  {
    title: 'Time budget',
    detail: 'TSP is exponential; set realistic time limits.',
  },
  {
    title: 'Instance structure',
    detail: 'Euclidean instances are easier than arbitrary distance matrices.',
  },
  {
    title: 'Validation',
    detail: 'Ensure the tour is a Hamiltonian cycle (visits each city exactly once).',
  },
]
...
const faq = [
  {
    ...
    answer: 'The number of tours grows factorially with n, making brute force infeasible.',
  },
  {
    question: 'Is TSP solved in practice?',
    answer: 'Yes for many real-world sizes using advanced exact solvers and heuristics.',
  },
  {
    question: 'Is metric TSP easier?',
    answer: 'It is still NP-hard, but good approximation guarantees exist.',
  },
  {
    question: 'Do heuristics always work well?',
    answer: 'Not always; evaluate with lower bounds or small exact solutions.',
  },
  {
    question: 'What is the best known algorithm?',
    answer: 'No single best algorithm; solvers combine ILP, cutting planes, and heuristics.',
  },
]
...
export default function TspPage(): JSX.Element {
  const { activeTab, setActiveTab } = useTopicTabs({
    tabs,
    pageTitle: 'Traveling Salesman Problem (TSP)',
  ...
  const selectedScenario =
    timelineScenarios.find((scenario) => scenario.id === selectedScenarioId) ?? defaultScenario
  ...
  return (
    ...
    >
      <h1 className="bin98-doc-title">Traveling Salesman Problem (TSP)</h1>
      <p>
        The Traveling Salesman Problem asks for the shortest tour that visits every city once and
        returns to the start. It is a central NP-hard problem with deep theory and massive practical
        relevance. This document keeps the full topic scope intact while reorganizing it into a
        Windows Help style reference.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          <section id="bp-overview" className="bin98-section">
            ...
            <h3 className="bin98-subheading">Problem Setup</h3>
          ...
          <section id="bp-importance" className="bin98-section">
            <h2 className="bin98-heading">Why It Matters</h2>
            <h3 className="bin98-subheading">Algorithm Landscape</h3>
            {algorithmLandscape.map((item) => (
              <p key={item.title}>
                <strong>{item.title}:</strong> {item.detail}
              </p>
            ))}
            <h3 className="bin98-subheading">Applications</h3>
      ...
      {activeTab === 'core-concepts' && (
        <>
          <section id="core-complexity" className="bin98-section">
            <h2 className="bin98-heading">Complexity and Bounds</h2>
            {complexity.map((item) => (
              <p key={item.title}>
                <strong>{item.title}:</strong> {item.detail}
              </p>
            ))}
            <h3 className="bin98-subheading">Lower Bounds</h3>
          ...
          <section id="core-exact" className="bin98-section">
            <h2 className="bin98-heading">Exact Methods</h2>
            {exactMethods.map((item) => (
              <p key={item.title}>
                <strong>{item.title}:</strong> {item.detail}
              </p>
            ))}
            <h3 className="bin98-subheading">Formulations</h3>
          ...
          <section id="core-approx" className="bin98-section">
            <h2 className="bin98-heading">Approximation</h2>
          ...
          <section id="core-heuristics" className="bin98-section">
            <h2 className="bin98-heading">Heuristics and Metaheuristics</h2>
            {heuristics.map((item) => (
              <p key={item.title}>
                <strong>{item.title}:</strong> {item.detail}
              </p>
          ...
          <section id="core-correctness" className="bin98-section">
            <h2 className="bin98-heading">Correctness and Guarantees</h2>
          ...
          <section id="core-pitfalls" className="bin98-section">
            <h2 className="bin98-heading">Pitfalls and Counterexamples</h2>
      ...
      {activeTab === 'examples' && (
        <>
          ...
          <section id="ex-growth" className="bin98-section">
            <h2 className="bin98-heading">Tour Count Growth</h2>
            <p>
          ...
          <section id="ex-mindmap" className="bin98-section">
            <h2 className="bin98-heading">Concept Walkthrough</h2>
            <p>
              <strong>Walkthrough:</strong> Start at TSP -&gt; Complexity, then branch into Exact vs
              Approx vs Heuristic solutions. Finish with Variants and Applications.
            </p>
            <h3 className="bin98-subheading">Nodes</h3>
            {tspMindMap.map((item) => (
              <p key={item.id}>
                <strong>{item.title}:</strong> {item.detail}
              </p>
