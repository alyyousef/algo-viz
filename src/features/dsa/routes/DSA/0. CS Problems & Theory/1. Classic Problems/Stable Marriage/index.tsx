...
const bigPicture = [
  {
    ...
    notes: 'The canonical solution is the Gale-Shapley (deferred acceptance) algorithm.',
  },
  {
    title: 'Why it matters',
    details:
      'It models real-world matching markets like residency assignment, school choice, and job matching.',
    notes: 'Stability prevents incentive-compatible pairs from breaking the matching.',
  },
  {
    title: 'What it teaches',
    details:
      'Greedy algorithms, invariants, and the subtle difference between stability and optimality.',
    notes: 'It illustrates how algorithm design influences fairness and outcomes.',
  },
]
...
const problemSetup = [
  ...
  {
    title: 'Output',
    detail: 'A perfect matching (pairs) between the two sets.',
  },
  {
  ...
  {
    title: 'Goal',
    detail: 'Find a stable matching for every valid input.',
  },
]
...
const glossary = [
  {
    term: 'Matching',
    definition: 'A set of pairings where each participant appears in exactly one pair.',
  },
  { term: 'Stable matching', definition: 'A matching with no blocking pair.' },
  {
    term: 'Blocking pair',
    definition: 'A pair of participants who prefer each other over their assigned matches.',
  },
  {
    term: 'Proposal',
    definition: 'An offer from one participant to another in the Gale-Shapley algorithm.',
  },
  {
    term: 'Deferred acceptance',
    definition: 'A process where proposals are tentatively accepted and can later be replaced.',
  },
  ...
  { term: 'Receiver-optimal', definition: 'The best stable matching for the receiving side.' },
  {
    ...
    definition: 'All participants are matched with exactly one partner.',
  },
]
...
const algorithmOverview = [
  {
    ...
    detail: 'No pairs exist at the start.',
  },
  {
    title: 'Free proposer makes a proposal',
    detail: 'Choose a free proposer and have them propose to their top remaining choice.',
  },
  {
  ...
  {
    title: 'Repeat',
    detail: 'Continue until every proposer is matched.',
  },
  {
    title: 'Output the final matching',
    detail: 'The result is stable and proposer-optimal.',
  },
]
...
const formalDefinitions = [
  {
    title: 'Preferences',
    detail: 'Each participant has a strict total order over all members of the other set.',
  },
  {
    title: 'Matching',
    detail:
  ...
  {
    title: 'Stability',
    detail: 'A matching with no blocking pair is stable.',
  },
  {
    title: 'Optimality',
    detail: 'A matching is proposer-optimal if no proposer can improve without breaking stability.',
  },
]
...
const correctnessInsights = [
  {
    title: 'Termination',
    detail: 'Each proposer makes at most n proposals, so the algorithm always halts.',
  },
  {
    title: 'Stability',
    detail:
  ...
  },
  {
    ...
    detail: 'Every proposer gets the best possible partner among all stable matchings.',
  },
  {
    title: 'Receiver-pessimality',
    detail: 'Receivers get their worst stable partners when the other side proposes.',
  },
]
...
const invariants = [
  {
    ...
    detail: 'Every receiver holds at most one proposal at any time.',
  },
  {
  ...
  },
  {
    ...
    detail: 'Proposers never propose to the same receiver twice and only move down their list.',
  },
  {
    title: 'Invariant 4: Safety of rejection',
    detail: 'Once a receiver rejects a proposer, they will never be matched in a stable outcome.',
  },
]
...
const complexity = [
  ...
  {
    title: 'Space',
    detail: 'O(n^2) to store preference lists, plus O(n) for matches and pointers.',
  },
]
...
const dataStructures = [
  ...
  {
    title: 'Rank lookup',
    detail: 'For each receiver, store a rank map so comparisons are O(1).',
  },
  {
    title: 'Match arrays',
    detail: 'Two arrays map proposer->receiver and receiver->proposer.',
  },
  {
    title: 'Free queue',
    detail: 'A queue or stack holds currently free proposers ready to propose.',
  },
]
...
const latticeFacts = [
  {
    ...
    detail: 'All stable matchings form a lattice ordered by proposer preference.',
  },
  {
    title: 'Extreme matchings',
    detail: 'Gale-Shapley yields the proposer-optimal and receiver-pessimal extremes.',
  },
  {
    title: 'Rotation concept',
    detail: 'Transitions between stable matchings can be described by eliminating rotations.',
  },
  {
...
const strategyInsights = [
  {
    ...
    detail: 'Truthful reporting is a dominant strategy for the proposing side.',
  },
  {
    title: 'Not strategy-proof for receivers',
    detail: 'Receivers can benefit by misreporting in some instances.',
  },
  {
    title: 'Incentive tradeoff',
    detail: 'Choosing which side proposes affects incentives and perceived fairness.',
  },
  {
    title: 'Market design',
    detail: 'Real systems choose the proposing side to optimize policy goals.',
  },
]
...
const variants = [
  {
    ...
    detail: 'Switching the proposing side flips optimality: women become optimal, men pessimal.',
  },
  {
    title: 'Ties in preferences',
    detail: 'Stability must be redefined; algorithms can be more complex.',
  },
  {
    title: 'Incomplete lists',
    detail: 'Participants can deem some partners unacceptable; the output may be partial matching.',
  },
  {
    title: 'Hospitals/residents',
    detail: 'One-to-many matching where hospitals have capacity constraints.',
  },
  {
    title: 'Stable roommates',
    detail: 'Matching within a single set; a stable solution may not exist.',
  },
  {
    title: 'Many-to-many matching',
    detail: 'Each participant can match with multiple partners; stability becomes more complex.',
  },
]
...
const applications = [
  {
    ...
    detail: 'Medical residency assignment uses deferred acceptance to ensure stability.',
  },
  {
    title: 'School choice',
    detail: 'Students and schools are matched with policies that ensure stability and fairness.',
  },
  {
    title: 'Job matching',
    detail: 'Internships and job pipelines can use stable matching to prevent reneging pairs.',
  },
  {
    title: 'Organ exchange',
    detail: 'Matching donors and recipients often uses stability-inspired mechanisms.',
  },
  {
    title: 'Mentor-mentee matching',
    detail: 'Programs pair mentors and mentees based on ranked preferences.',
  },
  {
    title: 'Project assignment',
    detail: 'Teams and projects can be matched to reduce renegotiations.',
  },
]
...
const edgeCases = [
  {
    ...
    detail: 'Multiple stable matchings may exist; the output depends on the proposing side.',
  },
  {
    title: 'Ties',
    detail: 'If preferences include ties, stability must be defined as weak or strong stability.',
  },
  {
    title: 'Incomplete lists',
    detail: 'If some partners are unacceptable, the result may be a partial matching.',
  },
  {
...
const commonPitfalls = [
  ...
  },
  {
    ...
    description: 'Stability depends on strict preference rankings; ties require special handling.',
  },
  {
    mistake: 'Assuming uniqueness',
    description: 'Stable matchings need not be unique; there can be many.',
  },
  {
    mistake: 'Breaking ties arbitrarily without justification',
    description: 'Tie-breaking can change outcomes and fairness properties.',
  },
  {
    mistake: 'Ignoring strategic behavior',
    description: 'The algorithm is strategy-proof for proposers but not for receivers.',
  },
]
...
while freeA not empty:
  ...
  if b is free:
    ...
    // b rejects a
    a remains free`,
    explanation: 'Each proposer advances down their preference list until matched.',
  },
  {
  ...
  if a prefers b over match(a) and b prefers a over match(b):
    unstable`,
    explanation: 'A matching is stable if no blocking pair exists.',
  },
  {
...
if rank[b][a1] < rank[b][a2]:
  b prefers a1`,
    explanation: 'Rank lookup makes comparisons O(1) during proposals.',
  },
]
...
B2: A1 > A2 > A3
B3: A1 > A3 > A2`,
    explanation: 'Run Gale-Shapley with A proposing to get a stable matching that is best for A.',
  },
  {
...
If B proposes:
  B gets best possible stable partners`,
    explanation: 'The proposing side always benefits in terms of stable outcomes.',
  },
  {
...
B1: A1 > A2
Pair (A1,B1) blocks.`,
    explanation: 'A1 and B1 prefer each other, so the matching is unstable.',
  },
]
...
const timelineScenarios = [
  {
    ...
    summary: 'A side achieves its proposer-optimal stable matching.',
  },
  {
    id: 'b-proposes',
    title: 'B proposes',
    ...
    summary: 'B side achieves its proposer-optimal stable matching.',
  },
  {
    id: 'rejection-chain',
    ...
    summary: 'Rejected proposers continue down their lists until matched.',
  },
]
...
const debuggingChecklist = [
  {
    ...
    detail: 'Missing entries can create undefined behavior unless explicitly supported.',
  },
  {
    title: 'Are rank maps built correctly?',
    detail: 'Incorrect ranks cause wrong accept/reject decisions.',
  },
  {
    title: 'Is each proposer advancing?',
    detail: 'Ensure each proposer moves to the next receiver after rejection.',
  },
  {
    title: 'Is the free queue maintained?',
    detail: 'Proposers rejected must re-enter the free queue.',
  },
  {
    title: 'Are matches consistent?',
    detail: 'If A is matched to B, then B must be matched to A.',
  },
  {
    title: 'Does the algorithm stop?',
    detail: 'A proposer should stop once matched, unless later rejected.',
  },
]
...
const faq = [
  {
    ...
    answer: 'Yes for two equally sized sets with strict, complete preferences.',
  },
  {
    question: 'Is the stable matching unique?',
    answer: 'Not necessarily. There can be many stable matchings.',
  },
  {
    question: 'Which side should propose?',
    answer: 'The proposing side gets the best stable outcomes; the choice depends on policy goals.',
  },
  {
    question: 'What if preferences have ties?',
    answer: 'You need a variant of the algorithm and a precise stability definition.',
  },
  {
    question: 'Can participants lie?',
    answer: 'The algorithm is strategy-proof for proposers but not for receivers.',
  },
]
...
export default function StableMarriagePage(): JSX.Element {
  ...
  const [selectedScenarioId, setSelectedScenarioId] = useState(
    timelineScenarios[0]?.id ?? 'a-proposes',
  )
  ...
  return (
    ...
    >
      ...
      <p>
        The Stable Marriage problem asks for a perfect matching with no blocking pairs. The
        Gale-Shapley algorithm solves this efficiently and reveals deep truths about stability,
        optimality, and fairness. This page covers definitions, algorithm mechanics, proofs of
        correctness, and real-world applications.
      </p>
      <p>
      ...
      {activeTab === 'core-concepts' && (
        <>
          <section id="core-algo" className="bin98-section">
            <h2 className="bin98-heading">Algorithm Overview (Gale-Shapley)</h2>
          ...
          <section id="core-correct" className="bin98-section">
          ...
          <section id="core-proofs" className="bin98-section">
            <h2 className="bin98-heading">Proof Sketches</h2>
          ...
          <section id="core-lattice" className="bin98-section">
            <h2 className="bin98-heading">Stable Matching Lattice</h2>
          ...
          <section id="core-strategy" className="bin98-section">
            <h2 className="bin98-heading">Strategy and Incentives</h2>
      ...
      {activeTab === 'examples' && (
        <>
          ...
          <section id="ex-table" className="bin98-section">
            <h2 className="bin98-heading">Preference Table (Example)</h2>
          ...
          <section id="ex-timeline" className="bin98-section">
            ...
            <p>
              Select a scenario and step through proposal rounds to see how deferred acceptance
              builds a stable matching.
            </p>
            ...
            <h3 className="bin98-subheading">Selected: {selectedScenario?.title ?? 'None'}</h3>
            <p>{stepText}</p>
            <p>
