...
const historicalMilestones = [
  ...
  },
  {
    ...
    detail: 'C11 adds threads, atomics, and a formal memory model for concurrency.',
  },
  {
    title: 'C18 and C23 refinements',
    detail: 'Smaller updates improve consistency and clarify the standard without major changes.',
  },
]
...
const languageFundamentals = [
  {
    ...
    detail: 'C compiles directly to machine code with no runtime or garbage collector.',
  },
  {
    title: 'Minimal abstractions',
    detail: 'The language is small; most complexity lives in libraries and code conventions.',
  },
  {
    title: 'Pointers as power tools',
    detail: 'Pointers expose memory directly, enabling performance and portability.',
  },
  {
    title: 'Explicit control flow',
    detail: 'No exceptions or closures; error handling and lifetime are manual.',
  },
]
...
const standardLibraryHighlights = [
  {
    title: 'libc basics',
    detail: 'stdio, stdlib, string, and math provide core utilities and IO.',
  },
  {
    title: 'POSIX APIs',
    detail: 'Open, read, mmap, and sockets enable low-level system interaction.',
  },
  {
    title: 'Time and threading',
    detail: 'time.h and threads.h (C11) provide timers and threading primitives.',
  },
  {
    title: 'Memory utilities',
    detail: 'malloc/free and memcpy/memmove define core memory operations.',
  },
]
...
const memoryModelNotes = [
  ...
  },
  {
    ...
    detail: 'C exposes raw bytes; serialization must specify byte order to stay portable.',
  },
  {
    title: 'Struct padding',
    detail: 'Compilers insert padding for alignment. Reordering fields can reduce wasted space.',
  },
  {
    title: 'Atomics and memory order',
    detail: 'C11 atomics define ordering guarantees; misuse can cause data races.',
  },
]
...
const performanceTradeoffs = [
  ...
  },
  {
    ...
    detail: 'Performance is often gated by system calls and cache behavior, not arithmetic.',
  },
  {
  ...
  },
  {
    ...
    detail: 'Cross-platform code often needs conditional compilation and careful ABI handling.',
  },
]
...
const realWorldUses = [
  ...
  },
  {
    ...
    detail: 'Microcontrollers need deterministic memory usage and minimal runtime overhead.',
  },
  {
    context: 'Databases and storage engines',
    detail: 'Low-level control enables carefully tuned buffering, paging, and serialization.',
  },
  {
  ...
  },
  {
    ...
    detail: 'Low-level primitives and constant-time code are often written in C.',
  },
  {
    context: 'Performance-critical libraries',
    detail: 'C powers core libraries consumed by higher-level languages.',
  },
]
...
int has_flag(int flags, int mask) {
    ...
    explanation: 'Bit flags are compact and fast, ideal for permissions or hardware registers.',
  },
  {
    ...
    explanation: 'C APIs often return status codes and require explicit cleanup on each path.',
  },
  {
...
void buffer_destroy(Buffer *b) {
    ...
    explanation: 'Explicit init/destroy patterns document ownership and lifecycle.',
  },
]
...
const advancedInsights = [
  ...
  },
  {
    ...
    detail: 'libFuzzer and AFL find edge cases in parsers and protocol handlers.',
  },
]
...
const toolingWorkflow = [
  {
    title: 'Build systems',
    detail: 'Make, CMake, and Meson manage builds across platforms.',
  },
  {
    title: 'Static analysis',
    detail: 'clang-tidy, cppcheck, and Coverity catch defects early.',
  },
  {
    title: 'Sanitizers',
    detail: 'ASan, UBSan, and MSan detect memory and undefined behavior issues.',
  },
  {
    title: 'Debugging',
    detail: 'gdb and lldb inspect memory, call stacks, and registers.',
  },
]
...
const concurrencyOptions = [
  {
    title: 'C11 threads',
    detail: 'threads.h provides a portable API for threads and mutexes.',
  },
  {
    title: 'POSIX threads',
    detail: 'pthread remains the standard on Unix-like systems.',
  },
  {
    title: 'Atomics',
    detail: 'stdatomic.h enables lock-free algorithms with memory ordering.',
  },
  {
    title: 'Event-driven IO',
    detail: 'epoll, kqueue, and io_uring enable scalable servers.',
  },
]
...
const interopOptions = [
  {
    title: 'Stable C ABI',
    detail: 'C APIs are the default interop boundary for many languages.',
  },
  {
    title: 'FFI and bindings',
    detail: 'Python, Rust, and Go use C bindings for performance.',
  },
  {
    title: 'Shared libraries',
    detail: '.so and .dll files export symbols for integration.',
  },
  {
    title: 'Embedded firmware',
    detail: 'C integrates directly with bootloaders and hardware SDKs.',
  },
]
...
const deploymentOptions = [
  {
    ...
    detail: 'Static linking simplifies deployment for embedded devices.',
  },
  {
    title: 'Shared libraries',
    detail: 'Dynamic linking reduces binary size and supports plugins.',
  },
  {
    title: 'Cross-compilation',
    detail: 'Toolchains target microcontrollers and custom OSes.',
  },
  {
    title: 'Firmware images',
    detail: 'Build artifacts often deploy as flashable images.',
  },
]
...
const comparisonNotes = [
  {
    title: 'Compared to C++',
    detail: 'C is smaller and more predictable; C++ offers RAII and safer abstractions.',
  },
  {
  ...
  },
  {
    ...
    detail: 'C offers lower-level control; Go provides easier concurrency and safer memory.',
  },
  {
    title: 'Compared to Assembly',
    detail: 'C is portable and expressive while still enabling low-level optimization.',
  },
]
...
const learningPath = [
  {
    ...
    detail: 'Learn types, pointers, arrays, and struct layout.',
  },
  {
    title: 'Memory and ownership',
    detail: 'Practice malloc/free patterns and error handling.',
  },
  {
    title: 'Systems APIs',
    detail: 'Use file IO, sockets, and process APIs.',
  },
  {
    title: 'Tooling and debugging',
    detail: 'Master sanitizers, gdb, and static analysis.',
  },
  {
    title: 'Concurrency',
    detail: 'Learn threads, atomics, and memory ordering.',
  },
]
...
const glossary = [
  {
    ...
    definition:
      'Operations the C standard does not define, enabling aggressive compiler optimization.',
  },
  {
    term: 'Translation Unit',
    definition: 'A source file after preprocessing, compiled independently.',
  },
  {
    term: 'ABI',
    definition: 'Binary calling and layout conventions used by compiled code and libraries.',
  },
  {
    term: 'Pointer Aliasing',
    definition:
      'Multiple pointers referencing overlapping memory, affecting optimization and correctness.',
  },
  {
    term: 'restrict',
    definition: 'A keyword promising non-overlapping pointer targets for optimization.',
  },
  {
    term: 'Stack Allocation',
    definition: 'Automatic storage duration tied to scope and function lifetime.',
  },
  {
    term: 'Heap Allocation',
    definition: 'Dynamic storage managed manually via malloc/free family.',
  },
  {
    term: 'C11 Atomics',
    definition: 'Atomic operations and memory order primitives defined in stdatomic.h.',
  },
  {
    term: 'POSIX',
    definition: 'Standardized Unix APIs for files, processes, sockets, and threads.',
  },
  {
    term: 'Sanitizer',
    definition: 'Runtime instrumentation (ASan/UBSan/MSan) for memory and UB defect detection.',
  },
]
...
export default function CPage(): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <p>
        C is designed for direct control: memory layout, data representation, and system calls are
        all explicit. It rewards careful engineering with unmatched predictability and portability,
        making it the core language for kernels, embedded firmware, and performance-critical
        libraries.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          <section id="bp-overview" className="bin98-section">
            ...
            <p>
              C is a minimal abstraction over hardware. It compiles to efficient machine code,
              exposes raw pointers, and leaves safety checks to the programmer. The language is
              small, but the responsibility it gives you is large.
            </p>
          </section>
      ...
      {activeTab === 'core-concepts' && (
        <>
          ...
          <section id="core-c-fundamentals" className="bin98-section">
          ...
          <section id="core-memory-model" className="bin98-section">
            <h2 className="bin98-heading">How It Works: Memory Model</h2>
          ...
          <section id="core-performance" className="bin98-section">
            ...
            <p>
              C lets you hit tight performance envelopes, but only when you reason about memory,
              cache behavior, and the compiler. The performance ceiling is high, but so is the
              engineering cost.
            </p>
          </section>
