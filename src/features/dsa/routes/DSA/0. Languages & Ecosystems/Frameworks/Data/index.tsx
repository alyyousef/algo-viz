...
const bigPictureSections: ContentSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'The original page was a placeholder. That original intent is preserved here so the subsection can continue expanding while staying aligned with the same coverage goals.',
    ],
    bullets: [
...
.data98-control:focus-visible,
.data98-tab:focus-visible,
.data98-toc-link:focus-visible,
.data98-inline-link:focus-visible {
...
.data98-toc-link:hover,
.data98-toc-link:focus-visible,
.data98-inline-link:hover,
.data98-inline-link:focus-visible {
...
export default function DataAndMlFrameworksPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Data and ML Frameworks (${activeTabLabel})`
  ...
  return (
    <div className="data98-help-page">
      <style>{pageStyles}</style>
      <div className="data98-window" role="presentation">
        <header className="data98-titlebar">
          <span className="data98-title">Data and ML Frameworks</span>
          <div className="data98-controls">
            <button
              className="data98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="data98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="data98-tabs" role="tablist" aria-label="Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`data98-tab ${activeTab === tab.id ? 'data98-tab-active' : ''}`}
        ...
        <div className="data98-main">
          <aside className="data98-toc" aria-label="Table of contents">
            <h2 className="data98-toc-title">Contents</h2>
            <ul className="data98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="data98-toc-item">
                  <a href={`#${section.id}`} className="data98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="data98-content">
            <h1 className="data98-doc-title">Data and ML Frameworks</h1>
            <p className="data98-doc-subtitle">
              Help-style overview of data pipelines, model frameworks, numerical computation,
              training workflows, and production tradeoffs in the data and ML ecosystem.
            </p>
            ...
            {activeTab === 'glossary' ? (
              <section id="data98-glossary" className="data98-section">
                <h2 className="data98-heading">Glossary</h2>
                {glossary.map((item) => (
                  <p key={item.term}>
