...
.mobile98-control:focus-visible,
.mobile98-tab:focus-visible,
.mobile98-toc-link:focus-visible,
.mobile98-inline-link:focus-visible {
...
.mobile98-toc-item + .mobile98-toc-item {
  margin-top: 6px;
}
...
export default function MobileFrameworksPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Mobile Frameworks (${activeTabLabel})`
  ...
  return (
    <div className="mobile98-help-page">
      <style>{pageStyles}</style>
      <div className="mobile98-window" role="presentation">
        <header className="mobile98-titlebar">
          <span className="mobile98-title">Mobile Frameworks</span>
          <div className="mobile98-controls">
            <button
              className="mobile98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="mobile98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="mobile98-tabs" role="tablist" aria-label="Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`mobile98-tab ${activeTab === tab.id ? 'mobile98-tab-active' : ''}`}
        ...
        <div className="mobile98-main">
          <aside className="mobile98-toc" aria-label="Table of contents">
            <h2 className="mobile98-toc-title">Contents</h2>
            <ul className="mobile98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="mobile98-toc-item">
                  <a href={`#${section.id}`} className="mobile98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="mobile98-content">
            <h1 className="mobile98-doc-title">Mobile Frameworks</h1>
            ...
            {activeTab === 'glossary' ? (
              <section id="mobile98-glossary" className="mobile98-section">
                <h2 className="mobile98-heading">Glossary</h2>
                {glossary.map((item) => (
                  <p key={item.term}>
