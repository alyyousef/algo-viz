  ...
  },
  {
    ...
    terms: [
      ...
      },
      {
        term: 'Gunicorn',
        definition:
          'A common Python WSGI server used to run Flask apps in production.',
      },
      {
...
export default function FlaskPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Flask (${activeTabLabel})`
    ...
    <div className="postgres-help-page">
      ...
      <div className="postgres-help-window" role="presentation">
        <header className="postgres-help-titlebar">
          <span className="postgres-help-titletext">Flask</span>
        ...
        <div className="postgres-help-main">
          ...
          <main className="postgres-help-content">
            <h1 className="postgres-help-doc-title">Flask</h1>
            <p className="postgres-help-doc-subtitle">
              Python backend framework reference covering routing, blueprints,
              request handling, templating, extensions, deployment, and tradeoffs.
            </p>
