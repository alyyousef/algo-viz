...
const glossarySections: GlossarySection[] = [
  {
    ...
    terms: [
      ...
      },
      {
        term: 'Engine',
        definition:
          'The server runtime implementation used by Ktor, such as Netty or CIO.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    terms: [
      ...
      },
      {
        term: 'Exposed',
        definition:
          'A Kotlin SQL and database access library often used with Ktor applications.',
      },
      {
        term: 'Cancellation',
        definition:
...
export default function KtorPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Ktor (${activeTabLabel})`
    ...
    <div className="postgres-help-page">
      ...
      <div className="postgres-help-window" role="presentation">
        <header className="postgres-help-titlebar">
          <span className="postgres-help-titletext">Ktor</span>
        ...
        <div className="postgres-help-main">
          ...
          <main className="postgres-help-content">
            <h1 className="postgres-help-doc-title">Ktor</h1>
            <p className="postgres-help-doc-subtitle">
              Kotlin backend framework reference covering coroutines, routing,
              plugins, request pipelines, serialization, testing, and deployment tradeoffs.
            </p>
