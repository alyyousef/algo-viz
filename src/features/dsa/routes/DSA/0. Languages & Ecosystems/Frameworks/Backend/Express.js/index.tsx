  ...
  },
  {
    ...
    terms: [
      ...
      },
      {
        term: 'Prisma',
        definition:
          'A popular Node ORM and query toolkit often used with Express applications.',
      },
      {
...
export default function ExpressJsPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Express.js (${activeTabLabel})`
    ...
    <div className="postgres-help-page">
      ...
      <div className="postgres-help-window" role="presentation">
        <header className="postgres-help-titlebar">
          <span className="postgres-help-titletext">Express.js</span>
        ...
        <div className="postgres-help-main">
          ...
          <main className="postgres-help-content">
            <h1 className="postgres-help-doc-title">Express.js</h1>
            <p className="postgres-help-doc-subtitle">
              Node.js backend framework reference covering middleware, routing,
              request flow, async error handling, deployment, and tradeoffs.
            </p>
