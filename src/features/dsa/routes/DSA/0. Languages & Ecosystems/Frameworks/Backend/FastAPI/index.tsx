...
const glossarySections: GlossarySection[] = [
  {
    ...
    terms: [
      ...
      {
        term: 'Pydantic Model',
        definition: 'A typed data model used for validation, serialization, and schema generation.',
      },
      {
        term: 'Depends',
        definition:
...
export default function FastAPIPage(): JSX.Element {
  ...
  return (
    ...
    >
      <h1 className="bin98-doc-title">FastAPI</h1>
      <p className="postgres-help-doc-subtitle">
        Python API framework reference covering typed contracts, validation, dependencies, async
        behavior, OpenAPI generation, and tradeoffs.
      </p>
