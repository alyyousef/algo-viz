...
export default function NestJsPage(): JSX.Element {
  ...
  return (
    ...
    >
      <h1 className="bin98-doc-title">NestJS</h1>
      <p className="postgres-help-doc-subtitle">
        TypeScript backend framework reference covering modules, dependency injection, controllers,
        providers, middleware, guards, pipes, testing, and deployment tradeoffs.
      </p>
