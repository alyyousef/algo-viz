...
.game98-control:focus-visible,
.game98-tab:focus-visible,
.game98-toc-link:focus-visible,
.game98-inline-link:focus-visible {
...
.game98-toc-item + .game98-toc-item {
  margin-top: 6px;
}
...
export default function GameFrameworksPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Game Frameworks (${activeTabLabel})`
  ...
  return (
    <div className="game98-help-page">
      <style>{pageStyles}</style>
      <div className="game98-window" role="presentation">
        <header className="game98-titlebar">
          <span className="game98-title">Game Frameworks</span>
          <div className="game98-controls">
            <button
              className="game98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="game98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="game98-tabs" role="tablist" aria-label="Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`game98-tab ${activeTab === tab.id ? 'game98-tab-active' : ''}`}
        ...
        <div className="game98-main">
          <aside className="game98-toc" aria-label="Table of contents">
            <h2 className="game98-toc-title">Contents</h2>
            <ul className="game98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="game98-toc-item">
                  <a href={`#${section.id}`} className="game98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="game98-content">
            <h1 className="game98-doc-title">Game Frameworks</h1>
            <p className="game98-doc-subtitle">
              Help-style overview of game engine architecture, runtime models, tooling, content
              workflow, and the framework pages available in this subsection.
            </p>
            ...
            {activeTab === 'glossary' ? (
              <section id="game98-glossary" className="game98-section">
                <h2 className="game98-heading">Glossary</h2>
                {glossary.map((item) => (
                  <p key={item.term}>
