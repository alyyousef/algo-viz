...
function renderContentSection(section: ContentSection, isLast: boolean): JSX.Element {
  return (
    <section key={section.id} id={section.id} className="supabase-help98-section">
      <h2 className="supabase-help98-heading">{section.title}</h2>
      ...
      {!isLast ? <hr className="supabase-help98-divider" /> : null}
    </section>
  )
}
...
function renderExampleSection(section: ExampleSection, isLast: boolean): JSX.Element {
  return (
    <section key={section.id} id={section.id} className="supabase-help98-section">
      ...
      <div className="supabase-help98-codebox">
...
function renderGlossarySection(section: GlossarySection, isLast: boolean): JSX.Element {
  return (
    <section key={section.id} id={section.id} className="supabase-help98-section">
      <h2 className="supabase-help98-heading">{section.title}</h2>
      <dl className="supabase-help98-glossary">
