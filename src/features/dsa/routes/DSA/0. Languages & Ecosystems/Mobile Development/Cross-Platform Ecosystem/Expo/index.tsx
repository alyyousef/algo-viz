...
export default function ExpoPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Expo (${activeTabLabel})`
  ...
  return (
    <div className="expo-help-page">
      <style>{pageStyles}</style>
      <div className="expo-help-window" role="presentation">
        <header className="expo-help-titlebar">
          <span className="expo-help-titletext">Expo</span>
          <div className="expo-help-controls">
            <button
              className="expo-help-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="expo-help-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="expo-help-tabs" role="tablist" aria-label="Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              className={`expo-help-tab ${activeTab === tab.id ? 'expo-help-tab-active' : ''}`}
        ...
        <div className="expo-help-main">
          <aside className="expo-help-toc" aria-label="Table of contents">
            <h2 className="expo-help-toc-title">Contents</h2>
            <ul className="expo-help-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="expo-help-toc-item">
                  <a href={`#${section.id}`} className="expo-help-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="expo-help-content">
            <h1 className="expo-help-doc-title">Expo</h1>
