...
.win98-android-page .win98-window {
...
.win98-android-page .win98-titlebar {
  position: relative;
  display: flex;
  align-items: center;
  padding: 2px 4px;
...
.win98-android-page .win98-title-controls {
  display: flex;
  gap: 2px;
  margin-left: auto;
}

.win98-android-page .win98-title-text {
  position: absolute;
  left: 50%;
...
.win98-android-page .win98-control {
  width: 18px;
  height: 16px;
...
.win98-android-page .win98-tabs {
  display: flex;
  gap: 1px;
  padding: 6px 8px 0;
}

.win98-android-page .win98-tab {
  border-top: 1px solid #fff;
  border-left: 1px solid #fff;
  border-right: 1px solid #404040;
  border-bottom: none;
...
.win98-android-page .win98-tab.active {
  background: #fff;
  position: relative;
  top: 1px;
}

.win98-android-page .win98-main {
...
.win98-android-page .win98-toc-title {
  font-size: 12px;
  font-weight: 700;
  margin: 0 0 10px;
}

.win98-android-page .win98-toc-list {
  list-style: none;
  margin: 0;
  padding: 0;
}

.win98-android-page .win98-toc-list li {
  margin: 0 0 8px;
}

.win98-android-page .win98-toc-list a {
  color: #000;
  text-decoration: none;
  font-size: 12px;
}

.win98-android-page .win98-content {
  padding: 14px 20px 20px;
  overflow: auto;
}

.win98-android-page .win98-doc-title {
  font-size: 20px;
  font-weight: 700;
  margin: 0 0 12px;
}

.win98-android-page .win98-section {
  margin: 0 0 20px;
}

.win98-android-page .win98-heading {
  font-size: 16px;
  font-weight: 700;
  margin: 0 0 8px;
}

.win98-android-page .win98-subheading {
  font-size: 13px;
  font-weight: 700;
  margin: 0 0 6px;
}

.win98-android-page .win98-content p,
.win98-android-page .win98-content li {
  font-size: 12px;
  line-height: 1.5;
}
...
.win98-android-page .win98-content ul {
  margin: 0 0 10px 20px;
  padding: 0;
}

.win98-android-page .win98-divider {
  border: 0;
  border-top: 1px solid #d0d0d0;
  margin: 14px 0;
}

.win98-android-page .win98-codebox {
  background: #f4f4f4;
...
.win98-android-page .win98-codebox code {
...
.win98-android-page .win98-inline-buttons {
  display: flex;
  flex-wrap: wrap;
  gap: 6px;
  margin: 0 0 10px;
...
.win98-android-page .win98-step-box {
  background: #fffff0;
  border-top: 2px solid #808080;
  border-left: 2px solid #808080;
  border-right: 2px solid #fff;
...
.win98-android-page .win98-step-controls {
  display: flex;
  align-items: center;
  gap: 8px;
  margin: 4px 0 10px;
...
export default function AndroidEcosystemPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Android Ecosystem (${activeTabLabel})`
  ...
  return (
    <div className="win98-android-page">
      <style>{win98HelpStyles}</style>
      <div className="win98-window" role="presentation">
        {/* Title bar */}
        <header className="win98-titlebar">
          <span className="win98-title-text">Android Ecosystem</span>
        ...
        <div className="win98-main">
          ...
          <main className="win98-content">
            <h1 className="win98-doc-title">Android Ecosystem</h1>
            <p>
              Android is Google's open-source mobile platform. This document covers the full
              developer ecosystem: OS component model, lifecycle management, Jetpack libraries,
              Kotlin coroutines, networking, persistence, background processing, testing, build
              tooling, and publishing. The goal is practical depth — what to use, why it works, and
              where it breaks.
            </p>
            ...
            {activeTab === 'big-picture' && (
              <>
                ...
                <section id="bp-why" className="win98-section">
                  ...
                  <p>
                    Android development demands reasoning about layers that most platforms hide: the
                    OS lifecycle, the threading model, the permission runtime, and the build/signing
                    pipeline. Bugs in any of these layers manifest as crashes, ANRs, leaks, or Play
                    Store rejections.
                  </p>
                  <p>
                    The ecosystem has consolidated significantly. Teams that adopt Kotlin
                    coroutines, Compose, and the standard Jetpack stack spend less time on framework
                    plumbing and more on product features. Diverging from these defaults needs a
                    clear reason.
                  </p>
                </section>
                <hr className="win98-divider" />
            ...
            {activeTab === 'core-concepts' && (
              <>
                <section id="core-components" className="win98-section">
                  <h2 className="win98-heading">Android Components</h2>
                ...
                <section id="core-lifecycle" className="win98-section">
                  <h2 className="win98-heading">Lifecycle States</h2>
                ...
                <hr className="win98-divider" />
                <section id="core-jetpack" className="win98-section">
                  <h2 className="win98-heading">Jetpack Libraries</h2>
                ...
                <hr className="win98-divider" />
                <section id="core-coroutines" className="win98-section">
                  <h2 className="win98-heading">Kotlin Coroutines</h2>
                ...
                <hr className="win98-divider" />
                <section id="core-persistence" className="win98-section">
                  <h2 className="win98-heading">Persistence</h2>
                ...
                <hr className="win98-divider" />
                <section id="core-background" className="win98-section">
                  <h2 className="win98-heading">Background Processing</h2>
                ...
                <section id="core-testing" className="win98-section">
                  <h2 className="win98-heading">Testing</h2>
                ...
                <hr className="win98-divider" />
                <section id="core-permissions" className="win98-section">
                  <h2 className="win98-heading">Permissions Model</h2>
                ...
                <section id="core-build" className="win98-section">
                  <h2 className="win98-heading">Build System</h2>
                ...
                <hr className="win98-divider" />
                <section id="core-release" className="win98-section">
                  <h2 className="win98-heading">App Signing and Release</h2>
                ...
                <section id="core-security" className="win98-section">
                  <h2 className="win98-heading">Security Best Practices</h2>
            ...
            {activeTab === 'examples' && (
              <>
                ...
                <hr className="win98-divider" />
                <section id="ex-lifecycle" className="win98-section">
                  <h2 className="win98-heading">Lifecycle Walkthrough</h2>
                  <p>
