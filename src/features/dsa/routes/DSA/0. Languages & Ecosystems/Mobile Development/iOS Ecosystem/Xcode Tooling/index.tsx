    ...
    terms: [
      {
        term: 'Project',
        definition:
          'An Xcode container that defines targets, groups, build settings, and related build configuration metadata.',
      },
      {
        term: 'Workspace',
        definition:
          'A container that coordinates one or more projects and often serves as the correct entry point for dependency-managed builds.',
      },
      {
        term: 'Target',
        definition:
          'A concrete buildable output such as an app, framework, extension, or test bundle.',
      },
      {
        term: 'Scheme',
        definition:
          'A named set of actions and target selections that controls how Xcode builds, runs, tests, profiles, or archives a project.',
      },
      {
        term: 'Build configuration',
        definition:
          'A named settings profile such as Debug or Release that changes how the build is compiled, signed, and optimized.',
      },
      {
        term: 'Derived Data',
        definition:
          'Xcodes intermediate build and indexing output area, which can affect build state, caching, and troubleshooting.',
      },
    ],
  },
  {
    ...
    terms: [
      {
        term: 'Simulator',
        definition:
          'A software environment that emulates many device behaviors for Apple platforms without requiring physical hardware.',
      },
      {
        term: 'Destination',
        definition:
          'The selected runtime target for a build action, such as a specific simulator or connected device.',
      },
      {
        term: 'Breakpoint',
      ...
      },
      {
        term: 'Memory graph',
        definition:
          'A debugging view used to inspect object relationships and potential retain cycles or leaks.',
      },
      {
        term: 'Instruments',
        definition:
          'A profiling environment used for performance analysis such as time profiling, memory analysis, and hangs investigation.',
      },
      {
        term: 'simctl',
    ...
    terms: [
      {
        term: 'Code signing',
        definition:
          'The process of applying cryptographic identity to a build so Apple platforms can trust and run or distribute it.',
      },
      {
        term: 'Provisioning profile',
        definition:
          'A configuration artifact that links app identifiers, certificates, devices, and capabilities for development or distribution.',
      },
      {
        term: 'Entitlement',
        definition:
          'A signed capability declaration that grants an app permission to use certain platform services.',
      },
      {
        term: 'Archive',
        definition:
          'A release-oriented build artifact produced for export, validation, and distribution workflows.',
      },
      {
        term: 'Export options plist',
        definition:
          'A configuration file that tells Xcode how to export an archive for a chosen distribution method.',
      },
      {
        term: 'xcodebuild',
        definition:
          'The command-line interface for building, testing, archiving, and exporting Xcode projects and workspaces.',
      },
    ],
  },
]
...
export default function XcodeToolingPage(): JSX.Element {
  const { activeTab, setActiveTab, handleMinimize } = useTopicTabs({
    tabs,
    pageTitle: 'Xcode Tooling Page',
    defaultTab: 'big-picture',
  })

  return (
    <TopicPageShell
      title="Xcode Tooling Page"
      tabs={tabs}
      activeTab={activeTab}
