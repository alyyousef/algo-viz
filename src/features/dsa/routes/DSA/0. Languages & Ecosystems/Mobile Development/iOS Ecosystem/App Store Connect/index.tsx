...
const glossarySections: GlossarySection[] = [
  {
    ...
    terms: [
      {
        term: 'App record',
        definition: 'The long-lived product entry in App Store Connect that holds builds, versions, metadata, pricing, and related distribution settings for an app.',
      },
      {
        term: 'Version',
        definition: 'The customer-facing release identifier associated with an App Store submission line.',
      },
      {
        term: 'Build',
        definition: 'The uploaded binary artifact processed by App Store Connect and attached to TestFlight or App Store release workflows.',
      },
      {
        term: 'Processed build',
        definition: 'A build that App Store Connect has finished ingesting and made available for further testing or submission workflows.',
      },
      {
        term: 'Ready for distribution',
        definition: 'A post-review state indicating the app version is approved and positioned for release according to the configured release controls.',
      },
      {
        term: 'Phased release',
        definition: 'A rollout mode that gradually exposes an approved update to increasing portions of the eligible audience over time.',
      },
    ],
  },
  {
    ...
    terms: [
      {
        term: 'Localization',
        definition: 'Store text and media variants tailored for different supported languages or regions.',
      },
      {
        term: 'Promotional text',
        definition: 'Store copy shown on the App Store listing that can highlight updates or positioning without requiring a new binary.',
      },
      {
        term: 'Release notes',
        definition: 'Version-specific text shown to users describing what changed in the submitted update.',
      },
      {
        term: 'Territory availability',
        definition: 'The storefront or country selection controlling where the app can be distributed.',
      },
      {
        term: 'SKU',
        definition: 'An internal identifier associated with the app record, commonly used for organizational or operational tracking.',
      },
      {
        term: 'App Review notes',
        definition: 'Submission notes provided to Apple reviewers to explain accounts, gated flows, feature access, or context needed to review the app correctly.',
      },
    ],
  },
  {
    ...
    terms: [
      {
        term: 'TestFlight',
        definition: 'Apple\'s beta distribution system inside the broader App Store Connect platform.',
      },
      {
        term: 'Role',
        definition: 'A permission grouping that controls what a user can see or change within App Store Connect.',
      },
      {
        term: 'Submission',
        definition: 'The package of metadata, build selection, review information, and release intent sent into Apple\'s review workflow.',
      },
      {
        term: 'Subscription product',
        definition: 'A recurring commercial offering configured in App Store Connect and linked to the app\'s monetization model.',
      },
      {
        term: 'Sales and trends',
        definition: 'App Store Connect reporting views that summarize downloads, purchases, subscriptions, and related commercial performance signals.',
      },
      {
        term: 'Manual release',
        definition: 'A release mode where the team waits to publish the approved version until it explicitly chooses to do so.',
      },
    ],
  },
]
...
const appStoreConnectHelpStyles = `
.app-store-connect-help98-page {
  min-height: 100dvh;
  background: #c0c0c0;
  color: #000;
...
.app-store-connect-help98-window {
  width: 100%;
  min-height: 100dvh;
  display: flex;
...
.app-store-connect-help98-titlebar {
  position: relative;
  display: flex;
  align-items: center;
  min-height: 24px;
...
.app-store-connect-help98-title {
  position: absolute;
  left: 50%;
...
.app-store-connect-help98-controls {
  display: flex;
  gap: 2px;
  margin-left: auto;
}

.app-store-connect-help98-control {
  width: 18px;
  height: 16px;
  display: inline-flex;
  align-items: center;
...
.app-store-connect-help98-tab.active {
  position: relative;
  top: 1px;
  background: #ffffff;
}

.app-store-connect-help98-main {
  display: grid;
...
.app-store-connect-help98-toc {
  overflow: auto;
  padding: 12px;
  background: #f2f2f2;
  border-right: 1px solid #808080;
}
.app-store-connect-help98-toc-title {
  margin: 0 0 10px;
  font-size: 12px;
  font-weight: 700;
}

.app-store-connect-help98-toc-list {
  margin: 0;
  padding: 0;
  list-style: none;
}

.app-store-connect-help98-toc-list li {
  margin: 0 0 8px;
}

.app-store-connect-help98-toc-list a {
  color: #000;
  font-size: 12px;
  text-decoration: none;
}

.app-store-connect-help98-content {
  overflow: auto;
  padding: 14px 20px 24px;
}

.app-store-connect-help98-doc-title {
  margin: 0 0 12px;
  font-size: 20px;
  font-weight: 700;
}

.app-store-connect-help98-section {
  margin: 0 0 20px;
}

.app-store-connect-help98-heading {
  margin: 0 0 8px;
  font-size: 16px;
  font-weight: 700;
}

.app-store-connect-help98-content p,
.app-store-connect-help98-content li,
.app-store-connect-help98-content dd,
.app-store-connect-help98-content dt {
  font-size: 12px;
  line-height: 1.5;
}
...
.app-store-connect-help98-content ul {
  margin: 0 0 10px 18px;
  padding: 0;
}

.app-store-connect-help98-divider {
  margin: 14px 0;
  border: 0;
  border-top: 1px solid #d0d0d0;
}

.app-store-connect-help98-codebox {
  margin: 8px 0 10px;
  padding: 8px;
  overflow-x: auto;
  background: #f4f4f4;
...
.app-store-connect-help98-codebox code {
  display: block;
  white-space: pre;
...
.app-store-connect-help98-glossary {
  margin: 0;
}

.app-store-connect-help98-glossary dt {
  margin: 0 0 2px;
  font-weight: 700;
}
...
export default function AppStoreConnectPage(): JSX.Element {
  ...
  return (
    <div className="app-store-connect-help98-page">
      <style>{appStoreConnectHelpStyles}</style>
      <div className="app-store-connect-help98-window" role="presentation">
        <header className="app-store-connect-help98-titlebar">
          <span className="app-store-connect-help98-title">{PAGE_TITLE}</span>
          <div className="app-store-connect-help98-controls">
            <button className="app-store-connect-help98-control" type="button" aria-label="Minimize" onClick={handleMinimize}>
              _
            </button>
            <Link to="/algoViz" className="app-store-connect-help98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="app-store-connect-help98-tabs" role="tablist" aria-label="Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              className={`app-store-connect-help98-tab ${activeTab === tab.id ? 'active' : ''}`}
        ...
        <div className="app-store-connect-help98-main">
          <aside className="app-store-connect-help98-toc" aria-label="Table of contents">
            <h2 className="app-store-connect-help98-toc-title">Contents</h2>
            <ul className="app-store-connect-help98-toc-list">
          ...
          <main className="app-store-connect-help98-content">
            <h1 className="app-store-connect-help98-doc-title">{PAGE_TITLE}</h1>
            {introParagraphs.map((paragraph) => (
              <p key={paragraph}>{paragraph}</p>
            ))}
            <hr className="app-store-connect-help98-divider" />
