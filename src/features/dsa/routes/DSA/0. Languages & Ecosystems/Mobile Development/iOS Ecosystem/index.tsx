...
.win98-ios-page .win98-title-text {
  position: absolute;
  left: 50%;
  transform: translateX(-50%);
  font-size: 16px;
}
.win98-ios-page .win98-title-controls {
  display: flex;
  gap: 2px;
  margin-left: auto;
}
.win98-ios-page .win98-control {
  width: 18px;
  height: 16px;
...
.win98-ios-page .win98-tabs {
  display: flex;
  gap: 1px;
  padding: 6px 8px 0;
}
.win98-ios-page .win98-tab {
  border-top: 1px solid #fff;
  border-left: 1px solid #fff;
  border-right: 1px solid #404040;
  border-bottom: none;
...
.win98-ios-page .win98-tab.active {
  background: #fff;
  position: relative;
  top: 1px;
}
.win98-ios-page .win98-main {
...
.win98-ios-page .win98-toc {
  border-right: 1px solid #808080;
  background: #f2f2f2;
  padding: 12px;
  overflow: auto;
}
.win98-ios-page .win98-toc-title {
  font-size: 12px;
  font-weight: 700;
  margin: 0 0 10px;
}
.win98-ios-page .win98-toc-list {
  list-style: none;
  margin: 0;
  padding: 0;
}
.win98-ios-page .win98-toc-list li { margin: 0 0 8px; }
.win98-ios-page .win98-toc-list a {
  color: #000;
  text-decoration: none;
  font-size: 12px;
}
.win98-ios-page .win98-content {
  padding: 14px 20px 20px;
  overflow: auto;
}
.win98-ios-page .win98-doc-title {
  font-size: 20px;
  font-weight: 700;
  margin: 0 0 12px;
}
.win98-ios-page .win98-section { margin: 0 0 20px; }
.win98-ios-page .win98-heading {
  font-size: 16px;
  font-weight: 700;
  margin: 0 0 8px;
}
.win98-ios-page .win98-subheading {
  font-size: 13px;
  font-weight: 700;
  margin: 0 0 6px;
}
.win98-ios-page .win98-content p,
.win98-ios-page .win98-content li {
  font-size: 12px;
  line-height: 1.5;
}
.win98-ios-page .win98-content p { margin: 0 0 10px; }
.win98-ios-page .win98-content ul {
  margin: 0 0 10px 20px;
  padding: 0;
}
.win98-ios-page .win98-divider {
  border: 0;
  border-top: 1px solid #d0d0d0;
  margin: 14px 0;
}
.win98-ios-page .win98-codebox {
  background: #f4f4f4;
...
.win98-ios-page .win98-codebox code {
  font-family: "Courier New", Courier, monospace;
  font-size: 12px;
  white-space: pre;
  display: block;
}
.win98-ios-page .win98-inline-buttons {
  display: flex;
  flex-wrap: wrap;
  gap: 6px;
  margin: 0 0 10px;
}
.win98-ios-page .win98-push {
  border-top: 1px solid #fff;
  border-left: 1px solid #fff;
  border-right: 1px solid #404040;
  border-bottom: 1px solid #404040;
...
.win98-ios-page .win98-step-controls {
  display: flex;
  align-items: center;
  gap: 8px;
  margin: 4px 0 10px;
...
@media (max-width: 900px) {
  .win98-ios-page .win98-main { grid-template-columns: 1fr; }
  .win98-ios-page .win98-toc {
    border-right: none;
...
export default function IOSEcosystemPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `iOS Ecosystem (${activeTabLabel})`
  ...
  return (
    <div className="win98-ios-page">
      <style>{win98HelpStyles}</style>
      <div className="win98-window" role="presentation">
        <header className="win98-titlebar">
          <span className="win98-title-text">iOS Ecosystem</span>
        ...
        <div className="win98-main">
          ...
          <main className="win98-content">
            <h1 className="win98-doc-title">iOS Ecosystem</h1>
            <p>
              iOS is Apple's mobile platform for iPhone and iPad. This document covers the full
              developer ecosystem: Swift language, SwiftUI and UIKit, Swift Concurrency, networking,
              persistence, background processing, app lifecycle, testing, build tooling, App Store,
              and security. The goal is practical depth — what to use, why it works, and where it
              breaks.
            </p>
            ...
            {activeTab === 'big-picture' && (
              <>
                ...
                <section id="bp-why" className="win98-section">
                  ...
                  <p>
                    iOS development rewards deep understanding of Apple's stack. Surface-level
                    knowledge gets you to a working prototype; platform mastery determines app
                    quality, stability, and App Store success. The most common failure modes —
                    retain cycles, threading violations, signing issues, rejection — each require
                    understanding a different layer of the system.
                  </p>
                  <p>
                    Apple's platform evolves rapidly at WWDC each June. SwiftUI, SwiftData, Swift
                    Concurrency, and visionOS each represent major paradigm shifts that landed
                    within a few years of each other. Staying current matters more on iOS than on
                    almost any other platform.
                  </p>
                </section>
                <hr className="win98-divider" />
            ...
            {activeTab === 'core-concepts' && (
              <>
                <section id="core-swift" className="win98-section">
                  <h2 className="win98-heading">Swift Language</h2>
                ...
                <hr className="win98-divider" />
                <section id="core-swiftui" className="win98-section">
                  <h2 className="win98-heading">SwiftUI</h2>
                ...
                <hr className="win98-divider" />
                <section id="core-uikit" className="win98-section">
                  <h2 className="win98-heading">UIKit (Legacy and Interop)</h2>
                ...
                <section id="core-concurrency" className="win98-section">
                  <h2 className="win98-heading">Concurrency</h2>
                ...
                <section id="core-lifecycle" className="win98-section">
                  <h2 className="win98-heading">App Lifecycle</h2>
                ...
                <section id="core-build" className="win98-section">
                  <h2 className="win98-heading">Build System and Xcode</h2>
                ...
                <section id="core-release" className="win98-section">
                  <h2 className="win98-heading">App Store and Release</h2>
