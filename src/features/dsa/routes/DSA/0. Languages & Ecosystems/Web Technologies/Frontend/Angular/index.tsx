...
.ang98-control:focus-visible,
.ang98-tab:focus-visible,
.ang98-toc-link:focus-visible {
...
export default function AngularPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Angular (Frontend) (${activeTabLabel})`
  ...
  return (
    <div className="ang98-help-page">
      <style>{angularHelpStyles}</style>
      <div className="ang98-window" role="presentation">
        <header className="ang98-titlebar">
          <span className="ang98-title">Angular (Frontend)</span>
          <div className="ang98-title-controls">
            <button
              className="ang98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="ang98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="ang98-tabs" role="tablist" aria-label="Angular Frontend Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`ang98-tab ${activeTab === tab.id ? 'ang98-tab-active' : ''}`}
        ...
        <div className="ang98-main">
          <aside className="ang98-toc" aria-label="Table of contents">
            <h2 className="ang98-toc-title">Contents</h2>
            <ul className="ang98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="ang98-toc-item">
                  <a href={`#${section.id}`} className="ang98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="ang98-content">
            <h1 className="ang98-doc-title">Angular (Frontend)</h1>
            <p className="ang98-intro">
              This page is a frontend-focused overview of Angular as a structured application
              framework. It explains components, templates, services, dependency injection, routing,
              RxJS, forms, operational tradeoffs, and the architectural discipline needed to keep
              Angular applications clear as they grow.
            </p>

            {activeTab === 'big-picture' && (
              <>
                <section id="ang98-overview" className="ang98-section">
                  <h2 className="ang98-heading">Overview</h2>
                  {overviewSections.map((section) => (
                    <div key={section.title}>
                      <h3 className="ang98-subheading">{section.title}</h3>
                      <p>{section.body}</p>
                    </div>
                  ))}
                </section>

                <hr className="ang98-divider" />

                <section id="ang98-why" className="ang98-section">
                  <h2 className="ang98-heading">Why It Matters</h2>
                  <ul>
                ...
                <section id="ang98-history" className="ang98-section">
                  <h2 className="ang98-heading">Historical Context</h2>
                  {historicalContext.map((item) => (
                    <div key={item.title}>
                      <h3 className="ang98-subheading">{item.title}</h3>
                      <p>{item.detail}</p>
                    </div>
                  ))}
                </section>
                ...
                <section id="ang98-themes" className="ang98-section">
                  <h2 className="ang98-heading">Big Picture Themes</h2>
                ...
                <section id="ang98-takeaways" className="ang98-section">
                  <h2 className="ang98-heading">Key Takeaways</h2>
                  <ul>
            ...
            {activeTab === 'core-concepts' && (
              <>
                <section id="ang98-signals" className="ang98-section">
                  <h2 className="ang98-heading">Topic Signals</h2>
                ...
                <section id="ang98-foundations" className="ang98-section">
                  <h2 className="ang98-heading">Foundations</h2>
                ...
                <section id="ang98-features" className="ang98-section">
                  <h2 className="ang98-heading">Framework Features</h2>
                ...
                <section id="ang98-runtime" className="ang98-section">
                  <h2 className="ang98-heading">Runtime and Operations</h2>
                ...
                <section id="ang98-uses" className="ang98-section">
                  <h2 className="ang98-heading">Ecosystem Uses</h2>
                ...
                <section id="ang98-compare" className="ang98-section">
                  <h2 className="ang98-heading">Compare and Contrast</h2>
                ...
                <section id="ang98-failures" className="ang98-section">
                  <h2 className="ang98-heading">Failure Modes</h2>
                ...
                <section id="ang98-checklist" className="ang98-section">
                  <h2 className="ang98-heading">Study Checklist</h2>
                  <ul>
            ...
            {activeTab === 'examples' && (
              <>
                {examples.map((example) => (
                  <section key={example.id} id={example.id} className="ang98-section">
                    <h2 className="ang98-heading">{example.title}</h2>
                    <p>
            ...
            {activeTab === 'glossary' && (
              <section id="ang98-glossary" className="ang98-section">
                <h2 className="ang98-heading">Glossary</h2>
                {glossary.map((entry) => (
                  <p key={entry.term}>
