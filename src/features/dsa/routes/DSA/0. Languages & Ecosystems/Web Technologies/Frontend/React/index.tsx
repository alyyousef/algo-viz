...
.react98-control:focus-visible,
.react98-tab:focus-visible,
.react98-toc-link:focus-visible {
...
.react98-toc-item + .react98-toc-item {
  margin-top: 8px;
}
...
export default function ReactPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `React (Frontend) (${activeTabLabel})`
  ...
  return (
    <div className="react98-help-page">
      <style>{reactHelpStyles}</style>
      <div className="react98-window" role="presentation">
        <header className="react98-titlebar">
          <span className="react98-title">React (Frontend)</span>
          <div className="react98-title-controls">
            <button
              className="react98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="react98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="react98-tabs" role="tablist" aria-label="React Frontend Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`react98-tab ${activeTab === tab.id ? 'react98-tab-active' : ''}`}
        ...
        <div className="react98-main">
          <aside className="react98-toc" aria-label="Table of contents">
            <h2 className="react98-toc-title">Contents</h2>
            <ul className="react98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="react98-toc-item">
                  <a href={`#${section.id}`} className="react98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="react98-content">
            <h1 className="react98-doc-title">React (Frontend)</h1>
            <p className="react98-intro">
              This page is a frontend-focused overview of React as a UI library. It explains
              components, props, state, hooks, effects, data flow, ecosystem choices, performance
              tradeoffs, and the architectural discipline required to keep a React codebase
              understandable as it grows.
            </p>

            {activeTab === 'big-picture' && (
              <>
                <section id="react98-overview" className="react98-section">
                  <h2 className="react98-heading">Overview</h2>
                  {overviewSections.map((section) => (
                    <div key={section.title}>
                      <h3 className="react98-subheading">{section.title}</h3>
                      <p>{section.body}</p>
                    </div>
                  ))}
                </section>

                <hr className="react98-divider" />

                <section id="react98-why" className="react98-section">
                  <h2 className="react98-heading">Why It Matters</h2>
                  <ul>
                ...
                <section id="react98-history" className="react98-section">
                  <h2 className="react98-heading">Historical Context</h2>
                  {historicalContext.map((item) => (
                    <div key={item.title}>
                      <h3 className="react98-subheading">{item.title}</h3>
                      <p>{item.detail}</p>
                    </div>
                  ))}
                </section>
                ...
                <section id="react98-themes" className="react98-section">
                  <h2 className="react98-heading">Big Picture Themes</h2>
                ...
                <section id="react98-takeaways" className="react98-section">
                  <h2 className="react98-heading">Key Takeaways</h2>
                  <ul>
            ...
            {activeTab === 'core-concepts' && (
              <>
                <section id="react98-signals" className="react98-section">
                  <h2 className="react98-heading">Topic Signals</h2>
                ...
                <section id="react98-foundations" className="react98-section">
                  <h2 className="react98-heading">Foundations</h2>
                ...
                <section id="react98-features" className="react98-section">
                  <h2 className="react98-heading">Framework Features</h2>
                ...
                <section id="react98-runtime" className="react98-section">
                  <h2 className="react98-heading">Runtime and Operations</h2>
                ...
                <section id="react98-uses" className="react98-section">
                  <h2 className="react98-heading">Ecosystem Uses</h2>
                ...
                <section id="react98-compare" className="react98-section">
                  <h2 className="react98-heading">Compare and Contrast</h2>
                ...
                <section id="react98-failures" className="react98-section">
                  <h2 className="react98-heading">Failure Modes</h2>
                ...
                <section id="react98-checklist" className="react98-section">
                  <h2 className="react98-heading">Study Checklist</h2>
                  <ul>
            ...
            {activeTab === 'examples' && (
              <>
                {examples.map((example) => (
                  <section key={example.id} id={example.id} className="react98-section">
                    <h2 className="react98-heading">{example.title}</h2>
                    <p>
            ...
            {activeTab === 'glossary' && (
              <section id="react98-glossary" className="react98-section">
                <h2 className="react98-heading">Glossary</h2>
                {glossary.map((entry) => (
                  <p key={entry.term}>
