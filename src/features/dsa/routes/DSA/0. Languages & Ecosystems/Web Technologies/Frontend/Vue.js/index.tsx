...
.vue98-control:focus-visible,
.vue98-tab:focus-visible,
.vue98-toc-link:focus-visible {
...
export default function VuePage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Vue.js (Frontend) (${activeTabLabel})`
  ...
  return (
    <div className="vue98-help-page">
      <style>{vueHelpStyles}</style>
      <div className="vue98-window" role="presentation">
        <header className="vue98-titlebar">
          <span className="vue98-title">Vue.js (Frontend)</span>
          <div className="vue98-title-controls">
            <button
              className="vue98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="vue98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="vue98-tabs" role="tablist" aria-label="Vue Frontend Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`vue98-tab ${activeTab === tab.id ? 'vue98-tab-active' : ''}`}
        ...
        <div className="vue98-main">
          <aside className="vue98-toc" aria-label="Table of contents">
            <h2 className="vue98-toc-title">Contents</h2>
            <ul className="vue98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="vue98-toc-item">
                  <a href={`#${section.id}`} className="vue98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="vue98-content">
            <h1 className="vue98-doc-title">Vue.js (Frontend)</h1>
            <p className="vue98-intro">
              This page is a frontend-focused overview of Vue.js as a reactive component framework.
              It explains templates, refs, computed values, watchers, composables, stores, ecosystem
              tradeoffs, and the design discipline required to keep a Vue codebase understandable as
              it grows.
            </p>

            {activeTab === 'big-picture' && (
              <>
                <section id="vue98-overview" className="vue98-section">
                  <h2 className="vue98-heading">Overview</h2>
                  {overviewSections.map((section) => (
                    <div key={section.title}>
                      <h3 className="vue98-subheading">{section.title}</h3>
                      <p>{section.body}</p>
                    </div>
                  ))}
                </section>

                <hr className="vue98-divider" />

                <section id="vue98-why" className="vue98-section">
                  <h2 className="vue98-heading">Why It Matters</h2>
                  <ul>
                ...
                <section id="vue98-history" className="vue98-section">
                  <h2 className="vue98-heading">Historical Context</h2>
                  {historicalContext.map((item) => (
                    <div key={item.title}>
                      <h3 className="vue98-subheading">{item.title}</h3>
                      <p>{item.detail}</p>
                    </div>
                  ))}
                </section>
                ...
                <section id="vue98-themes" className="vue98-section">
                  <h2 className="vue98-heading">Big Picture Themes</h2>
                ...
                <section id="vue98-takeaways" className="vue98-section">
                  <h2 className="vue98-heading">Key Takeaways</h2>
                  <ul>
            ...
            {activeTab === 'core-concepts' && (
              <>
                <section id="vue98-signals" className="vue98-section">
                  <h2 className="vue98-heading">Topic Signals</h2>
                ...
                <section id="vue98-foundations" className="vue98-section">
                  <h2 className="vue98-heading">Foundations</h2>
                ...
                <section id="vue98-features" className="vue98-section">
                  <h2 className="vue98-heading">Framework Features</h2>
                ...
                <section id="vue98-runtime" className="vue98-section">
                  <h2 className="vue98-heading">Runtime and Operations</h2>
                ...
                <section id="vue98-uses" className="vue98-section">
                  <h2 className="vue98-heading">Ecosystem Uses</h2>
                ...
                <section id="vue98-compare" className="vue98-section">
                  <h2 className="vue98-heading">Compare and Contrast</h2>
                ...
                <section id="vue98-failures" className="vue98-section">
                  <h2 className="vue98-heading">Failure Modes</h2>
                ...
                <section id="vue98-checklist" className="vue98-section">
                  <h2 className="vue98-heading">Study Checklist</h2>
                  <ul>
            ...
            {activeTab === 'examples' && (
              <>
                {examples.map((example) => (
                  <section key={example.id} id={example.id} className="vue98-section">
                    <h2 className="vue98-heading">{example.title}</h2>
                    <p>
            ...
            {activeTab === 'glossary' && (
              <section id="vue98-glossary" className="vue98-section">
                <h2 className="vue98-heading">Glossary</h2>
                {glossary.map((entry) => (
                  <p key={entry.term}>
