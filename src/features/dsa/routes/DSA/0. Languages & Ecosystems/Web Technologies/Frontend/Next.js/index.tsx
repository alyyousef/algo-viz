...
.next98-control:focus-visible,
.next98-tab:focus-visible,
.next98-toc-link:focus-visible {
...
.next98-toc-item + .next98-toc-item {
  margin-top: 8px;
}
...
.next98-content li + .next98-content li {
  margin-top: 4px;
}
...
export default function NextJsPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Next.js (Frontend) (${activeTabLabel})`
  ...
  return (
    <div className="next98-help-page">
      <style>{nextJsHelpStyles}</style>
      <div className="next98-window" role="presentation">
        <header className="next98-titlebar">
          <span className="next98-title">Next.js (Frontend)</span>
          <div className="next98-title-controls">
            <button
              className="next98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="next98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="next98-tabs" role="tablist" aria-label="Next.js Frontend Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`next98-tab ${activeTab === tab.id ? 'next98-tab-active' : ''}`}
        ...
        <div className="next98-main">
          <aside className="next98-toc" aria-label="Table of contents">
            <h2 className="next98-toc-title">Contents</h2>
            <ul className="next98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="next98-toc-item">
                  <a href={`#${section.id}`} className="next98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="next98-content">
            <h1 className="next98-doc-title">Next.js (Frontend)</h1>
            <p className="next98-intro">
              This page is a frontend-focused overview of Next.js as a React application framework.
              It explains route structure, layouts, server and client component boundaries,
              rendering strategies, caching, deployment-aware behavior, operational tradeoffs, and
              the architectural discipline required to keep a hybrid web application understandable
              as it grows.
            </p>

            {activeTab === 'big-picture' && (
              <>
                <section id="next98-overview" className="next98-section">
                  <h2 className="next98-heading">Overview</h2>
                  {overviewSections.map((section) => (
                    <div key={section.title}>
                      <h3 className="next98-subheading">{section.title}</h3>
                      <p>{section.body}</p>
                    </div>
                  ))}
                </section>

                <hr className="next98-divider" />

                <section id="next98-why" className="next98-section">
                  <h2 className="next98-heading">Why It Matters</h2>
                  <ul>
                ...
                <section id="next98-history" className="next98-section">
                  <h2 className="next98-heading">Historical Context</h2>
                  {historicalContext.map((item) => (
                    <div key={item.title}>
                      <h3 className="next98-subheading">{item.title}</h3>
                      <p>{item.detail}</p>
                    </div>
                  ))}
                </section>
                ...
                <section id="next98-themes" className="next98-section">
                  <h2 className="next98-heading">Big Picture Themes</h2>
                ...
                <section id="next98-takeaways" className="next98-section">
                  <h2 className="next98-heading">Key Takeaways</h2>
                  <ul>
            ...
            {activeTab === 'core-concepts' && (
              <>
                <section id="next98-signals" className="next98-section">
                  <h2 className="next98-heading">Topic Signals</h2>
                ...
                <section id="next98-foundations" className="next98-section">
                  <h2 className="next98-heading">Foundations</h2>
                ...
                <section id="next98-features" className="next98-section">
                  <h2 className="next98-heading">Framework Features</h2>
                ...
                <section id="next98-runtime" className="next98-section">
                  <h2 className="next98-heading">Runtime and Operations</h2>
                ...
                <section id="next98-uses" className="next98-section">
                  <h2 className="next98-heading">Ecosystem Uses</h2>
                ...
                <section id="next98-compare" className="next98-section">
                  <h2 className="next98-heading">Compare and Contrast</h2>
                ...
                <section id="next98-failures" className="next98-section">
                  <h2 className="next98-heading">Failure Modes</h2>
                ...
                <section id="next98-checklist" className="next98-section">
                  <h2 className="next98-heading">Study Checklist</h2>
                  <ul>
            ...
            {activeTab === 'examples' && (
              <>
                {examples.map((example) => (
                  <section key={example.id} id={example.id} className="next98-section">
                    <h2 className="next98-heading">{example.title}</h2>
                    <p>
            ...
            {activeTab === 'glossary' && (
              <section id="next98-glossary" className="next98-section">
                <h2 className="next98-heading">Glossary</h2>
                {glossary.map((entry) => (
                  <p key={entry.term}>
