...
.nest98-control:focus-visible,
.nest98-tab:focus-visible,
.nest98-toc-link:focus-visible {
...
.nest98-toc-item + .nest98-toc-item {
  margin-top: 8px;
}
...
export default function NestJsPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `NestJS (Backend) (${activeTabLabel})`
  ...
  return (
    <div className="nest98-help-page">
      <style>{nestHelpStyles}</style>
      <div className="nest98-window" role="presentation">
        <header className="nest98-titlebar">
          <span className="nest98-title">NestJS (Backend)</span>
          <div className="nest98-title-controls">
            <button
              className="nest98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="nest98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="nest98-tabs" role="tablist" aria-label="NestJS Backend Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`nest98-tab ${activeTab === tab.id ? 'nest98-tab-active' : ''}`}
        ...
        <div className="nest98-main">
          <aside className="nest98-toc" aria-label="Table of contents">
            <h2 className="nest98-toc-title">Contents</h2>
            <ul className="nest98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="nest98-toc-item">
                  <a href={`#${section.id}`} className="nest98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="nest98-content">
            <h1 className="nest98-doc-title">NestJS (Backend)</h1>
            <p className="nest98-intro">
              This page is a backend-focused overview of NestJS as an opinionated Node and
              TypeScript framework. It explains NestJS modules, controllers, providers, dependency
              injection, request lifecycle abstractions, transport flexibility, operational
              tradeoffs, and the architectural discipline needed to keep NestJS services clear as
              they grow.
            </p>

            {activeTab === 'big-picture' && (
              <>
                <section id="nest98-overview" className="nest98-section">
                  <h2 className="nest98-heading">Overview</h2>
                  {overviewSections.map((section) => (
                    <div key={section.title}>
                      <h3 className="nest98-subheading">{section.title}</h3>
                      <p>{section.body}</p>
                    </div>
                  ))}
                </section>

                <hr className="nest98-divider" />

                <section id="nest98-why" className="nest98-section">
                  <h2 className="nest98-heading">Why It Matters</h2>
                  <ul>
                ...
                <section id="nest98-history" className="nest98-section">
                  <h2 className="nest98-heading">Historical Context</h2>
                  {historicalContext.map((item) => (
                    <div key={item.title}>
                      <h3 className="nest98-subheading">{item.title}</h3>
                      <p>{item.detail}</p>
                    </div>
                  ))}
                </section>
                ...
                <section id="nest98-themes" className="nest98-section">
                  <h2 className="nest98-heading">Big Picture Themes</h2>
                ...
                <section id="nest98-takeaways" className="nest98-section">
                  <h2 className="nest98-heading">Key Takeaways</h2>
                  <ul>
            ...
            {activeTab === 'core-concepts' && (
              <>
                <section id="nest98-signals" className="nest98-section">
                  <h2 className="nest98-heading">Topic Signals</h2>
                ...
                <section id="nest98-foundations" className="nest98-section">
                  <h2 className="nest98-heading">Foundations</h2>
                ...
                <section id="nest98-features" className="nest98-section">
                  <h2 className="nest98-heading">Framework Features</h2>
                ...
                <section id="nest98-runtime" className="nest98-section">
                  <h2 className="nest98-heading">Runtime and Operations</h2>
                ...
                <section id="nest98-uses" className="nest98-section">
                  <h2 className="nest98-heading">Ecosystem Uses</h2>
                ...
                <section id="nest98-compare" className="nest98-section">
                  <h2 className="nest98-heading">Compare and Contrast</h2>
                ...
                <section id="nest98-failures" className="nest98-section">
                  <h2 className="nest98-heading">Failure Modes</h2>
                ...
                <section id="nest98-checklist" className="nest98-section">
                  <h2 className="nest98-heading">Study Checklist</h2>
                  <ul>
            ...
            {activeTab === 'examples' && (
              <>
                {examples.map((example) => (
                  <section key={example.id} id={example.id} className="nest98-section">
                    <h2 className="nest98-heading">{example.title}</h2>
                    <p>
            ...
            {activeTab === 'glossary' && (
              <section id="nest98-glossary" className="nest98-section">
                <h2 className="nest98-heading">Glossary</h2>
                {glossary.map((entry) => (
                  <p key={entry.term}>
