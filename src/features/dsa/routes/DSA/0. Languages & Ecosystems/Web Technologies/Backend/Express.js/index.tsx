...
.exp98-control:focus-visible,
.exp98-tab:focus-visible,
.exp98-toc-link:focus-visible {
...
export default function ExpressJsPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Express.js (Backend) (${activeTabLabel})`
  ...
  return (
    <div className="exp98-help-page">
      <style>{expressHelpStyles}</style>
      <div className="exp98-window" role="presentation">
        <header className="exp98-titlebar">
          <span className="exp98-title">Express.js (Backend)</span>
          <div className="exp98-title-controls">
            <button
              className="exp98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="exp98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="exp98-tabs" role="tablist" aria-label="Express Backend Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`exp98-tab ${activeTab === tab.id ? 'exp98-tab-active' : ''}`}
        ...
        <div className="exp98-main">
          <aside className="exp98-toc" aria-label="Table of contents">
            <h2 className="exp98-toc-title">Contents</h2>
            <ul className="exp98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="exp98-toc-item">
                  <a href={`#${section.id}`} className="exp98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="exp98-content">
            <h1 className="exp98-doc-title">Express.js (Backend)</h1>
            <p className="exp98-intro">
              This page is a backend-focused overview of Express.js as a Node web framework. It
              explains the middleware pipeline, routing model, ecosystem fit, operational tradeoffs,
              and the architectural discipline needed to keep Express applications maintainable as
              they grow.
            </p>

            {activeTab === 'big-picture' && (
              <>
                <section id="exp98-overview" className="exp98-section">
                  <h2 className="exp98-heading">Overview</h2>
                  {overviewSections.map((section) => (
                    <div key={section.title}>
                      <h3 className="exp98-subheading">{section.title}</h3>
                      <p>{section.body}</p>
                    </div>
                  ))}
                </section>

                <hr className="exp98-divider" />

                <section id="exp98-why" className="exp98-section">
                  <h2 className="exp98-heading">Why It Matters</h2>
                  <ul>
                ...
                <section id="exp98-history" className="exp98-section">
                  <h2 className="exp98-heading">Historical Context</h2>
                  {historicalContext.map((item) => (
                    <div key={item.title}>
                      <h3 className="exp98-subheading">{item.title}</h3>
                      <p>{item.detail}</p>
                    </div>
                  ))}
                </section>
                ...
                <section id="exp98-themes" className="exp98-section">
                  <h2 className="exp98-heading">Big Picture Themes</h2>
                ...
                <section id="exp98-takeaways" className="exp98-section">
                  <h2 className="exp98-heading">Key Takeaways</h2>
                  <ul>
            ...
            {activeTab === 'core-concepts' && (
              <>
                <section id="exp98-signals" className="exp98-section">
                  <h2 className="exp98-heading">Topic Signals</h2>
                ...
                <section id="exp98-foundations" className="exp98-section">
                  <h2 className="exp98-heading">Foundations</h2>
                ...
                <section id="exp98-features" className="exp98-section">
                  <h2 className="exp98-heading">Framework Features</h2>
                ...
                <section id="exp98-runtime" className="exp98-section">
                  <h2 className="exp98-heading">Runtime and Operations</h2>
                ...
                <section id="exp98-uses" className="exp98-section">
                  <h2 className="exp98-heading">Ecosystem Uses</h2>
                ...
                <section id="exp98-compare" className="exp98-section">
                  <h2 className="exp98-heading">Compare and Contrast</h2>
                ...
                <section id="exp98-failures" className="exp98-section">
                  <h2 className="exp98-heading">Failure Modes</h2>
                ...
                <section id="exp98-checklist" className="exp98-section">
                  <h2 className="exp98-heading">Study Checklist</h2>
                  <ul>
            ...
            {activeTab === 'examples' && (
              <>
                {examples.map((example) => (
                  <section key={example.id} id={example.id} className="exp98-section">
                    <h2 className="exp98-heading">{example.title}</h2>
                    <p>
            ...
            {activeTab === 'glossary' && (
              <section id="exp98-glossary" className="exp98-section">
                <h2 className="exp98-heading">Glossary</h2>
                {glossary.map((entry) => (
                  <p key={entry.term}>
