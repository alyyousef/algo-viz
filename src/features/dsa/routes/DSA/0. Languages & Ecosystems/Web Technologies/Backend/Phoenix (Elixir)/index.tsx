...
.phx98-control:focus-visible,
.phx98-tab:focus-visible,
.phx98-toc-link:focus-visible {
...
export default function PhoenixElixirPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Phoenix (Elixir) (Backend) (${activeTabLabel})`
  ...
  return (
    <div className="phx98-help-page">
      <style>{phoenixHelpStyles}</style>
      <div className="phx98-window" role="presentation">
        <header className="phx98-titlebar">
          <span className="phx98-title">Phoenix (Elixir) (Backend)</span>
          <div className="phx98-title-controls">
            <button
              className="phx98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="phx98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="phx98-tabs" role="tablist" aria-label="Phoenix Backend Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`phx98-tab ${activeTab === tab.id ? 'phx98-tab-active' : ''}`}
        ...
        <div className="phx98-main">
          <aside className="phx98-toc" aria-label="Table of contents">
            <h2 className="phx98-toc-title">Contents</h2>
            <ul className="phx98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="phx98-toc-item">
                  <a href={`#${section.id}`} className="phx98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="phx98-content">
            <h1 className="phx98-doc-title">Phoenix (Elixir) (Backend)</h1>
            <p className="phx98-intro">
              This page is a backend-focused overview of Phoenix as an Elixir web framework. It
              explains Plug pipelines, OTP and supervision, contexts, channels, LiveView, Ecto,
              operational tradeoffs, and the architectural discipline needed to keep Phoenix systems
              clear as they grow.
            </p>

            {activeTab === 'big-picture' && (
              <>
                <section id="phx98-overview" className="phx98-section">
                  <h2 className="phx98-heading">Overview</h2>
                  {overviewSections.map((section) => (
                    <div key={section.title}>
                      <h3 className="phx98-subheading">{section.title}</h3>
                      <p>{section.body}</p>
                    </div>
                  ))}
                </section>

                <hr className="phx98-divider" />

                <section id="phx98-why" className="phx98-section">
                  <h2 className="phx98-heading">Why It Matters</h2>
                  <ul>
                ...
                <section id="phx98-history" className="phx98-section">
                  <h2 className="phx98-heading">Historical Context</h2>
                  {historicalContext.map((item) => (
                    <div key={item.title}>
                      <h3 className="phx98-subheading">{item.title}</h3>
                      <p>{item.detail}</p>
                    </div>
                  ))}
                </section>
                ...
                <section id="phx98-themes" className="phx98-section">
                  <h2 className="phx98-heading">Big Picture Themes</h2>
                ...
                <section id="phx98-takeaways" className="phx98-section">
                  <h2 className="phx98-heading">Key Takeaways</h2>
                  <ul>
            ...
            {activeTab === 'core-concepts' && (
              <>
                <section id="phx98-signals" className="phx98-section">
                  <h2 className="phx98-heading">Topic Signals</h2>
                ...
                <section id="phx98-foundations" className="phx98-section">
                  <h2 className="phx98-heading">Foundations</h2>
                ...
                <section id="phx98-features" className="phx98-section">
                  <h2 className="phx98-heading">Framework Features</h2>
                ...
                <section id="phx98-runtime" className="phx98-section">
                  <h2 className="phx98-heading">Runtime and Operations</h2>
                ...
                <section id="phx98-uses" className="phx98-section">
                  <h2 className="phx98-heading">Ecosystem Uses</h2>
                ...
                <section id="phx98-compare" className="phx98-section">
                  <h2 className="phx98-heading">Compare and Contrast</h2>
                ...
                <section id="phx98-failures" className="phx98-section">
                  <h2 className="phx98-heading">Failure Modes</h2>
                ...
                <section id="phx98-checklist" className="phx98-section">
                  <h2 className="phx98-heading">Study Checklist</h2>
                  <ul>
            ...
            {activeTab === 'examples' && (
              <>
                {examples.map((example) => (
                  <section key={example.id} id={example.id} className="phx98-section">
                    <h2 className="phx98-heading">{example.title}</h2>
                    <p>
            ...
            {activeTab === 'glossary' && (
              <section id="phx98-glossary" className="phx98-section">
                <h2 className="phx98-heading">Glossary</h2>
                {glossary.map((entry) => (
                  <p key={entry.term}>
