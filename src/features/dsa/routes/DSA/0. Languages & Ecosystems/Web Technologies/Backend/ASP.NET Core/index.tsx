...
.asp98-control:focus-visible,
.asp98-tab:focus-visible,
.asp98-toc-link:focus-visible {
...
export default function AspNetCorePage(): JSX.Element {
  ...
  return (
    <div className="asp98-help-page">
      <style>{aspNetCoreHelpStyles}</style>
      <div className="asp98-window" role="presentation">
        <header className="asp98-titlebar">
          <span className="asp98-title">ASP.NET Core</span>
          <div className="asp98-title-controls">
            <button
              className="asp98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="asp98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="asp98-tabs" role="tablist" aria-label="ASP.NET Core Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`asp98-tab ${activeTab === tab.id ? 'asp98-tab-active' : ''}`}
        ...
        <div className="asp98-main">
          <aside className="asp98-toc" aria-label="Table of contents">
            <h2 className="asp98-toc-title">Contents</h2>
            <ul className="asp98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="asp98-toc-item">
                  <a href={`#${section.id}`} className="asp98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="asp98-content">
            <h1 className="asp98-doc-title">ASP.NET Core</h1>
            <p className="asp98-intro">
              This page is a detailed overview of ASP.NET Core as a backend web framework in the
              .NET ecosystem. It covers the host model, middleware pipeline, DI system, endpoint
              styles, runtime behavior, and the framework\'s role in modern service and API
              engineering.
            </p>

            {activeTab === 'big-picture' && (
              <>
                <section id="asp98-overview" className="asp98-section">
                  <h2 className="asp98-heading">Overview</h2>
                  {overviewSections.map((section) => (
                    <div key={section.title}>
                      <h3 className="asp98-subheading">{section.title}</h3>
                      <p>{section.body}</p>
                    </div>
                  ))}
                </section>

                <hr className="asp98-divider" />

                <section id="asp98-why" className="asp98-section">
                  <h2 className="asp98-heading">Why It Matters</h2>
                  <ul>
                ...
                <section id="asp98-history" className="asp98-section">
                  <h2 className="asp98-heading">Historical Context</h2>
                  {historicalContext.map((item) => (
                    <div key={item.title}>
                      <h3 className="asp98-subheading">{item.title}</h3>
                      <p>{item.detail}</p>
                    </div>
                  ))}
                </section>
                ...
                <section id="asp98-themes" className="asp98-section">
                  <h2 className="asp98-heading">Big Picture Themes</h2>
                ...
                <section id="asp98-takeaways" className="asp98-section">
                  <h2 className="asp98-heading">Key Takeaways</h2>
                  <ul>
            ...
            {activeTab === 'core-concepts' && (
              <>
                <section id="asp98-signals" className="asp98-section">
                  <h2 className="asp98-heading">Topic Signals</h2>
                ...
                <section id="asp98-foundations" className="asp98-section">
                  <h2 className="asp98-heading">Foundations</h2>
                ...
                <section id="asp98-features" className="asp98-section">
                  <h2 className="asp98-heading">Framework Features</h2>
                ...
                <section id="asp98-runtime" className="asp98-section">
                  <h2 className="asp98-heading">Runtime and Operations</h2>
                ...
                <section id="asp98-uses" className="asp98-section">
                  <h2 className="asp98-heading">Ecosystem Uses</h2>
                ...
                <section id="asp98-compare" className="asp98-section">
                  <h2 className="asp98-heading">Compare and Contrast</h2>
                ...
                <section id="asp98-failures" className="asp98-section">
                  <h2 className="asp98-heading">Failure Modes</h2>
                ...
                <section id="asp98-checklist" className="asp98-section">
                  <h2 className="asp98-heading">Study Checklist</h2>
                  <ul>
            ...
            {activeTab === 'examples' && (
              <>
                {examples.map((example) => (
                  <section key={example.id} id={example.id} className="asp98-section">
                    <h2 className="asp98-heading">{example.title}</h2>
                    <p>
            ...
            {activeTab === 'glossary' && (
              <section id="asp98-glossary" className="asp98-section">
                <h2 className="asp98-heading">Glossary</h2>
                {glossary.map((entry) => (
                  <p key={entry.term}>
