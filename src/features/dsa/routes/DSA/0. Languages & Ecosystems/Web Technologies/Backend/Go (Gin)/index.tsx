...
.gin98-control:focus-visible,
.gin98-tab:focus-visible,
.gin98-toc-link:focus-visible {
...
export default function GoGinPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Go (Gin) (Backend) (${activeTabLabel})`
  ...
  return (
    <div className="gin98-help-page">
      <style>{ginHelpStyles}</style>
      <div className="gin98-window" role="presentation">
        <header className="gin98-titlebar">
          <span className="gin98-title">Go (Gin) (Backend)</span>
          <div className="gin98-title-controls">
            <button
              className="gin98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="gin98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="gin98-tabs" role="tablist" aria-label="Go Gin Backend Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`gin98-tab ${activeTab === tab.id ? 'gin98-tab-active' : ''}`}
        ...
        <div className="gin98-main">
          <aside className="gin98-toc" aria-label="Table of contents">
            <h2 className="gin98-toc-title">Contents</h2>
            <ul className="gin98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="gin98-toc-item">
                  <a href={`#${section.id}`} className="gin98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="gin98-content">
            <h1 className="gin98-doc-title">Go (Gin) (Backend)</h1>
            <p className="gin98-intro">
              This page is a backend-focused overview of Gin as a lightweight Go web framework. It
              explains Gin's routing and middleware model, request binding and validation helpers,
              route grouping patterns, operational tradeoffs, and the architectural discipline
              needed to keep Gin services maintainable as they grow.
            </p>

            {activeTab === 'big-picture' && (
              <>
                <section id="gin98-overview" className="gin98-section">
                  <h2 className="gin98-heading">Overview</h2>
                  {overviewSections.map((section) => (
                    <div key={section.title}>
                      <h3 className="gin98-subheading">{section.title}</h3>
                      <p>{section.body}</p>
                    </div>
                  ))}
                </section>

                <hr className="gin98-divider" />

                <section id="gin98-why" className="gin98-section">
                  <h2 className="gin98-heading">Why It Matters</h2>
                  <ul>
                ...
                <section id="gin98-history" className="gin98-section">
                  <h2 className="gin98-heading">Historical Context</h2>
                  {historicalContext.map((item) => (
                    <div key={item.title}>
                      <h3 className="gin98-subheading">{item.title}</h3>
                      <p>{item.detail}</p>
                    </div>
                  ))}
                </section>
                ...
                <section id="gin98-themes" className="gin98-section">
                  <h2 className="gin98-heading">Big Picture Themes</h2>
                ...
                <section id="gin98-takeaways" className="gin98-section">
                  <h2 className="gin98-heading">Key Takeaways</h2>
                  <ul>
            ...
            {activeTab === 'core-concepts' && (
              <>
                <section id="gin98-signals" className="gin98-section">
                  <h2 className="gin98-heading">Topic Signals</h2>
                ...
                <section id="gin98-foundations" className="gin98-section">
                  <h2 className="gin98-heading">Foundations</h2>
                ...
                <section id="gin98-features" className="gin98-section">
                  <h2 className="gin98-heading">Framework Features</h2>
                ...
                <section id="gin98-runtime" className="gin98-section">
                  <h2 className="gin98-heading">Runtime and Operations</h2>
                ...
                <section id="gin98-uses" className="gin98-section">
                  <h2 className="gin98-heading">Ecosystem Uses</h2>
                ...
                <section id="gin98-compare" className="gin98-section">
                  <h2 className="gin98-heading">Compare and Contrast</h2>
                ...
                <section id="gin98-failures" className="gin98-section">
                  <h2 className="gin98-heading">Failure Modes</h2>
                ...
                <section id="gin98-checklist" className="gin98-section">
                  <h2 className="gin98-heading">Study Checklist</h2>
                  <ul>
            ...
            {activeTab === 'examples' && (
              <>
                {examples.map((example) => (
                  <section key={example.id} id={example.id} className="gin98-section">
                    <h2 className="gin98-heading">{example.title}</h2>
                    <p>
            ...
            {activeTab === 'glossary' && (
              <section id="gin98-glossary" className="gin98-section">
                <h2 className="gin98-heading">Glossary</h2>
                {glossary.map((entry) => (
                  <p key={entry.term}>
