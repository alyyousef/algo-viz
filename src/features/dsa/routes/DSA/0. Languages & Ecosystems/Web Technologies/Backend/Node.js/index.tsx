...
const historicalMilestones = [
  {
    ...
    detail: 'Node brings the V8 JavaScript engine to the server with a non-blocking event loop.',
  },
  {
    title: 'npm ecosystem explodes (2010)',
    detail: 'The npm registry accelerates adoption with reusable packages and tooling.',
  },
  {
    title: 'Node.js Foundation forms (2015)',
    detail: 'Governance stabilizes the platform and unifies community efforts.',
  },
  {
    title: 'ES modules and async/await mature (2017)',
    detail: 'Modern JavaScript features become first-class in server-side development.',
  },
  {
    title: 'Serverless and containers mainstream (2018+)',
    detail: 'Fast startup and low memory footprints make Node a default for cloud workloads.',
  },
  {
    title: 'LTS cadence matures (2019+)',
    detail: 'Predictable long-term support aligns Node with enterprise upgrade cycles.',
  },
  {
    title: 'TypeScript becomes the backend default (2020+)',
    detail: 'Typed JS improves large codebase safety and collaboration across teams.',
  },
]
...
const mentalModels = [
  ...
  },
  {
    ...
    detail: 'I/O is asynchronous; CPU-heavy work must be moved off the main thread.',
  },
  {
  ...
  },
  {
    ...
    detail: 'Node is V8 plus libuv and system APIs like fs, net, crypto, and timers.',
  },
]
...
const architectureNotes = [
  {
    ...
    detail: 'The event loop avoids per-request threads, but blocking code halts all requests.',
  },
  {
  ...
  },
  {
    ...
    detail: 'Multiple processes share the same port to utilize multi-core CPUs.',
  },
  {
    title: 'Environment-driven config',
    detail: 'Twelve-factor practices keep config outside code via environment variables.',
  },
  {
    title: 'Graceful shutdown',
    detail: 'Handle SIGTERM/SIGINT to stop accepting new requests and drain existing connections.',
  },
  {
    title: 'Load balancing',
    detail: 'Use a reverse proxy to route traffic and enforce timeouts and headers.',
  },
]
...
const performanceTradeoffs = [
  {
    ...
    detail: 'Node excels at I/O-bound workloads thanks to non-blocking networking.',
  },
  {
    title: 'CPU-bound bottlenecks',
    detail: 'Single-threaded execution struggles with heavy CPU tasks unless offloaded.',
  },
  {
    title: 'Startup and cold starts',
    detail: 'Node startups are fast, but large dependency graphs can slow cold starts.',
  },
  {
    title: 'Garbage collection',
    detail: 'GC pauses are typically short but can affect latency-sensitive services.',
  },
  {
    title: 'Memory profile',
    detail: 'Large heaps improve throughput but can increase GC pause times.',
  },
  {
    title: 'Native add-ons',
    detail: 'Native modules can improve performance but add build complexity.',
  },
]
...
const realWorldUses = [
  {
    ...
    detail: 'Node is popular for REST and GraphQL APIs with high concurrency needs.',
  },
  {
    context: 'Realtime apps',
    detail: 'WebSockets and event-driven design suit chat, collaboration, and live dashboards.',
  },
  {
    context: 'Serverless functions',
    detail: 'Fast startup and lightweight runtime make Node a common serverless choice.',
  },
  {
    context: 'Developer tooling',
    detail: 'CLIs, build tools, and compilers often leverage Node for cross-platform scripting.',
  },
  {
    context: 'Streaming pipelines',
    detail: 'Data ingest, ETL, and log processing benefit from streaming and backpressure.',
  },
  {
    context: 'Edge and CDN logic',
    detail: 'Lightweight handlers run close to users with low latency requirements.',
  },
]
...
server.listen(3000);`,
  ...
  return user;
    ...
    explanation: 'Async/await reads like synchronous code but keeps I/O non-blocking.',
  },
  {
...
readStream.pipe(process.stdout);`,
    explanation: 'Streams handle large data efficiently by applying backpressure automatically.',
  },
  {
    title: 'Graceful shutdown',
    code: `const shutdown = () => {
...
process.on("SIGINT", shutdown);`,
    explanation: 'Stop accepting new requests, drain existing ones, and exit cleanly.',
  },
  {
...
worker.on("message", (result) => console.log(result));`,
    explanation: 'Offload expensive computation to keep the event loop responsive.',
  },
]
...
const advancedInsights = [
  ...
  {
    title: 'Native add-ons',
    detail: 'C++ add-ons and N-API allow pushing hot paths into native code for performance.',
  },
  {
    title: 'Edge deployment patterns',
    detail: 'Lightweight handlers and minimal dependencies keep latency low in edge environments.',
  },
  {
    title: 'Backpressure signals',
    detail: 'Streams return false from write when buffers are full; honoring it prevents overload.',
  },
  {
    title: 'Runtime flags',
    detail: 'V8 and Node flags can tune memory limits, debugging, and stack traces.',
  },
]
...
const productionChecklist = [
  {
    title: 'Reliability',
    detail: 'Set timeouts, retries with backoff, and circuit breakers for upstream calls.',
  },
  {
    title: 'Security',
    detail: 'Use strict headers, validate input, and keep dependencies patched.',
  },
  {
    title: 'Performance',
    detail: 'Warm caches, reuse connections, and measure p95/p99 latencies.',
  },
  {
    title: 'Deployability',
    detail: 'Graceful shutdown, health probes, and rolling deploys reduce downtime.',
  },
]
...
const glossary = [
  {
    term: 'Event Loop',
    definition: 'Single-threaded scheduler that processes callbacks and asynchronous completions.',
  },
  {
    term: 'libuv',
    definition: 'Cross-platform async I/O library underpinning Node concurrency primitives.',
  },
  {
    term: 'Microtask',
    definition: 'High-priority queue used by Promise callbacks and async continuations.',
  },
  {
    term: 'Macrotask',
    definition: 'Queue for timers, I/O callbacks, and other event loop phase tasks.',
  },
  {
    term: 'Backpressure',
    definition: 'Flow-control mechanism in streams that prevents memory overload.',
  },
  {
    term: 'Worker Thread',
    definition: 'Separate JS thread used for CPU-bound jobs outside the main event loop.',
  },
  { term: 'Cluster', definition: 'Multi-process model sharing server load across CPU cores.' },
  {
    term: 'LTS',
    definition: 'Long-term support release line with stability and extended maintenance.',
  },
...
export default function NodeJsPage(): JSX.Element {
  ...
  return (
    ...
    >
      <h1 className="bin98-doc-title">Node.js</h1>
      <p>
        Node.js brings JavaScript to the server with a non-blocking event loop and a huge ecosystem
        of packages. It shines in I/O-heavy applications, realtime systems, and tooling, while
        requiring care around CPU-heavy workloads. Under the hood, V8, libuv, and streams cooperate
        to keep latency low and throughput high.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          <section id="bp-overview" className="bin98-section">
            ...
            <p>
              Node.js is a runtime built around an event loop that handles thousands of concurrent
              connections without spawning a thread per request. Its model is simple and fast for
              I/O-bound systems, but design choices around asynchronous execution, timeouts, and CPU
              offloading are critical.
            </p>
          </section>
      ...
      {activeTab === 'core-concepts' && (
        <>
          <section id="core-fundamentals" className="bin98-section">
            <h2 className="bin98-heading">How It Works: Node.js Fundamentals</h2>
          ...
          <section id="core-tradeoffs" className="bin98-section">
            ...
            <p>
              Node gives excellent I/O throughput and developer velocity, but it needs careful
              architecture for CPU-heavy workloads and latency-sensitive services.
            </p>
          </section>
