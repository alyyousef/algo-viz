...
export default function MongoDbPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `MongoDB (${activeTabLabel})`
    ...
    <div className="postgres-help-page">
      ...
      <div className="postgres-help-window" role="presentation">
        <header className="postgres-help-titlebar">
          <span className="postgres-help-titletext">MongoDB</span>
          <div className="postgres-help-controls">
            <button
              className="postgres-help-control"
              type="button"
              aria-label="Minimize"
        ...
        <div className="postgres-help-main">
          ...
          <main className="postgres-help-content">
            <h1 className="postgres-help-doc-title">MongoDB</h1>
            <p className="postgres-help-doc-subtitle">
              Document database reference covering BSON, schema design, indexes,
              aggregation, transactions, replica sets, sharding, and operational tradeoffs.
            </p>
