...
.par98-control:focus-visible,
.par98-tab:focus-visible,
.par98-toc-link:focus-visible,
.par98-inline-link:focus-visible {
...
export default function ParadigmsPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Paradigms (${activeTabLabel})`
  ...
  return (
    <div className="par98-help-page">
      <style>{paradigmsHelpStyles}</style>
      <div className="par98-window" role="presentation">
        <header className="par98-titlebar">
          <span className="par98-title">Paradigms</span>
          <div className="par98-title-controls">
            <button
              className="par98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="par98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="par98-tabs" role="tablist" aria-label="Paradigms Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`par98-tab ${activeTab === tab.id ? 'par98-tab-active' : ''}`}
        ...
        <div className="par98-main">
          <aside className="par98-toc" aria-label="Table of contents">
            <h2 className="par98-toc-title">Contents</h2>
            <ul className="par98-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="par98-toc-item">
                  <a href={`#${section.id}`} className="par98-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="par98-content">
            <h1 className="par98-doc-title">Paradigms</h1>
            <p className="par98-intro">
              This page is the overview for the Paradigms subsection inside Languages &amp;
              Ecosystems. It explains how major programming styles organize state, composition, and
              control flow, and how those choices shape the structure of real software systems.
            </p>

            {activeTab === 'big-picture' && (
              <>
                <section id="par98-overview" className="par98-section">
                  <h2 className="par98-heading">Overview</h2>
                  {overviewSections.map((section) => (
                    <div key={section.title}>
                      <h3 className="par98-subheading">{section.title}</h3>
                      <p>{section.body}</p>
                    </div>
                  ))}
                </section>

                <hr className="par98-divider" />

                <section id="par98-why" className="par98-section">
                  <h2 className="par98-heading">Why It Matters</h2>
                  <ul>
                ...
                <section id="par98-history" className="par98-section">
                  <h2 className="par98-heading">Historical Context</h2>
                  {historicalContext.map((item) => (
                    <div key={item.title}>
                      <h3 className="par98-subheading">{item.title}</h3>
                      <p>{item.detail}</p>
                    </div>
                  ))}
                </section>
                ...
                <section id="par98-survey" className="par98-section">
                  <h2 className="par98-heading">Section Survey</h2>
                  {sectionSurvey.map((item) => (
                    <div key={item.name}>
                      <h3 className="par98-subheading">{item.name}</h3>
                      <p>{item.summary}</p>
                      <p>
                ...
                <section id="par98-themes" className="par98-section">
                  <h2 className="par98-heading">Paradigm Themes</h2>
                ...
                <section id="par98-takeaways" className="par98-section">
                  <h2 className="par98-heading">Key Takeaways</h2>
                  <ul>
            ...
            {activeTab === 'core-concepts' && (
              <>
                <section id="par98-signals" className="par98-section">
                  <h2 className="par98-heading">Topic Signals</h2>
                ...
                <section id="par98-foundations" className="par98-section">
                  <h2 className="par98-heading">Foundations</h2>
                ...
                <section id="par98-tradeoffs" className="par98-section">
                  <h2 className="par98-heading">Tradeoff Themes</h2>
                ...
                <section id="par98-compare" className="par98-section">
                  <h2 className="par98-heading">Compare and Contrast</h2>
                ...
                <section id="par98-failures" className="par98-section">
                  <h2 className="par98-heading">Failure Modes</h2>
                ...
                <section id="par98-checklist" className="par98-section">
                  <h2 className="par98-heading">Study Checklist</h2>
                  <ul>
            ...
            {activeTab === 'examples' && (
              <>
                {examples.map((example) => (
                  <section key={example.id} id={example.id} className="par98-section">
                    <h2 className="par98-heading">{example.title}</h2>
                    <p>
            ...
            {activeTab === 'glossary' && (
              <section id="par98-glossary" className="par98-section">
                <h2 className="par98-heading">Glossary</h2>
                {glossary.map((entry) => (
                  <p key={entry.term}>
