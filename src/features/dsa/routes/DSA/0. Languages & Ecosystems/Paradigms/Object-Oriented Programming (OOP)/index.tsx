...
const milestones = [
  ...
  },
  {
    ...
    detail: 'Android and iOS SDKs make object models the default for app architecture.',
  },
  {
...
const mentalModels = [
  ...
  },
  {
    ...
    detail: 'Interfaces formalize expectations and allow collaborators to change independently.',
  },
  {
...
const applications = [
  ...
  },
  {
    ...
    detail: 'Controllers, services, and repositories encapsulate business logic behind clear APIs.',
  },
  {
    context: 'Simulation systems',
    detail: 'OOP maps naturally to entities and interactions in physics and modeling systems.',
  },
]
...
double total_area(const std::vector<Shape*>& shapes) {
  ...
  },
  {
    ...
    explanation: 'Value objects model domain rules without exposing mutable state.',
  },
  {
...
class Checkout {
  ...
  total(base: number) { return this.strategy.price(base) }
    ...
    explanation: 'Strategies swap behavior without subclassing, keeping dependencies explicit.',
  },
]
...
const advancedInsights = [
  ...
  },
  {
    ...
    detail: 'Entities, aggregates, and bounded contexts bring clarity to complex business models.',
  },
  {
...
const toolingEcosystem = [
  ...
  },
  {
    ...
    detail: 'Mocking frameworks, contract tests, and refactoring tools strengthen OOP workflows.',
  },
  {
    title: 'Frameworks',
    detail:
  ...
  {
    title: 'Architecture',
    detail: 'Layered and hexagonal architectures keep dependencies flowing inward.',
  },
]
...
const debuggingWorkflow = [
  {
    ...
    detail: 'Profile allocations and garbage collection to locate leaks or hotspots.',
  },
  {
    title: 'Inspect polymorphism',
    detail: 'Confirm dynamic dispatch targets when behavior is unexpected.',
  },
  {
    title: 'Test boundaries',
    detail: 'Use interface-driven tests to isolate side effects and dependencies.',
  },
  {
    title: 'Reduce coupling',
    detail: 'Refactor large classes into focused objects to improve clarity.',
  },
]
...
const productionChecklist = [
  {
    title: 'Design',
    detail: 'Validate boundaries and ensure responsibilities are clear.',
  },
  {
    title: 'Performance',
    detail: 'Measure dispatch-heavy code paths and reduce object churn.',
  },
  {
    title: 'Reliability',
    detail: 'Guard invariants and enforce contracts through tests and types.',
  },
  {
    title: 'Maintainability',
    detail: 'Prefer composition and small interfaces over deep inheritance.',
  },
]
...
export default function OOPPage(): JSX.Element {
  const { activeTab, setActiveTab } = useTopicTabs({
    tabs,
    pageTitle: 'Object-Oriented Programming (OOP)',
  ...
  return (
    ...
    >
      ...
      <p>
        Object-oriented programming treats software as collaborating objects that hold state and
        expose behavior. It excels at encapsulating invariants and modeling rich domains, but
        requires discipline to avoid brittle hierarchies, overuse of patterns, and performance
        surprises from indirection.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          <section id="bp-overview">
            <h2>Overview</h2>
            <p>
              OOP centers on objects that guard their own state and respond to messages. Interfaces
              and polymorphism allow code to depend on contracts instead of concrete types, enabling
              extension without changing callers. The costs are extra indirection, potential cache
              misses, and the risk of tangled hierarchies if design discipline slips.
            </p>
          </section>
          ...
          <section id="bp-complexity">
            ...
            <p>
              Optimize by flattening hot paths: reduce allocations, consider final classes to allow
              devirtualization, and batch work to improve cache locality. When abstraction cost is
              too high, isolate data-oriented or functional slices for critical code.
            </p>
          </section>
      ...
      {activeTab === 'glossary' && (
        <>
          <section id="glossary-terms">
            ...
            <p>
              <strong>Object:</strong> An instance that combines state and behavior behind a defined
              interface.
            </p>
            <p>
              <strong>Class:</strong> A blueprint that defines structure and behavior for objects.
            </p>
            <p>
              <strong>Encapsulation:</strong> Hiding internal state and exposing controlled
              operations to protect invariants.
            </p>
            <p>
              <strong>Interface:</strong> A contract that specifies behavior independent of concrete
              implementation.
            </p>
            <p>
              <strong>Polymorphism:</strong> Ability to use one interface with multiple
              implementations through substitution.
            </p>
            <p>
              <strong>Dynamic dispatch:</strong> Runtime selection of the method implementation for
              a polymorphic call.
            </p>
            <p>
              <strong>Inheritance:</strong> Reusing behavior and contracts through an is-a
              relationship.
            </p>
            <p>
              <strong>Composition:</strong> Building behavior by assembling collaborating objects
              rather than extending a base class.
            </p>
            <p>
              <strong>Liskov Substitution Principle (LSP):</strong> Subtypes must preserve expected
              behavior of base contracts.
            </p>
            <p>
              <strong>RAII:</strong> Resource Acquisition Is Initialization; ties resource lifetime
              to object lifetime.
            </p>
            <p>
              <strong>Value object:</strong> Immutable domain value typically compared by contents
              rather than identity.
            </p>
            <p>
              <strong>Dependency injection:</strong> Supplying dependencies from outside to reduce
