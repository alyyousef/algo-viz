...
.java-csharp-help-controls {
  display: flex;
  gap: 2px;
  margin-left: auto;
}

.java-csharp-help-control {
  width: 18px;
  height: 16px;
  padding: 0;
...
.java-csharp-help-tab-active {
  background: #fff;
  position: relative;
  top: 1px;
}

.java-csharp-help-main {
  flex: 1;
  min-height: 0;
  display: grid;
...
.java-csharp-help-toc-title {
  margin: 0 0 10px;
  font-size: 12px;
  font-weight: 700;
}

.java-csharp-help-toc-list {
  margin: 0;
  padding: 0;
  list-style: none;
}

.java-csharp-help-toc-item {
  margin: 0 0 8px;
}

.java-csharp-help-toc-link {
  color: #000;
  text-decoration: none;
  font-size: 12px;
}

.java-csharp-help-content {
  overflow: auto;
  padding: 14px 20px 20px;
}

.java-csharp-help-doc-title {
  margin: 0 0 10px;
  font-size: 20px;
  font-weight: 700;
}

.java-csharp-help-section {
  margin: 0 0 20px;
}

.java-csharp-help-heading {
  margin: 0 0 8px;
  font-size: 16px;
  font-weight: 700;
}

.java-csharp-help-content p,
.java-csharp-help-content li {
  font-size: 12px;
  line-height: 1.5;
}
...
.java-csharp-help-content ul {
  margin: 0 0 10px 20px;
  padding: 0;
}

.java-csharp-help-divider {
  margin: 14px 0;
  border: 0;
  border-top: 1px solid #d0d0d0;
}

.java-csharp-help-codebox {
  margin: 6px 0 10px;
  padding: 8px;
  background: #f4f4f4;
...
export default function JavaVsCSharpPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Java vs C# (${activeTabLabel})`
  ...
  return (
    <div className="java-csharp-help-page">
      <style>{pageStyles}</style>
      <div className="java-csharp-help-window" role="presentation">
        <header className="java-csharp-help-titlebar">
          <span className="java-csharp-help-titletext">Java vs C#</span>
          <div className="java-csharp-help-controls">
            <button
              className="java-csharp-help-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="java-csharp-help-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="java-csharp-help-tabs" role="tablist" aria-label="Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              className={`java-csharp-help-tab ${activeTab === tab.id ? 'java-csharp-help-tab-active' : ''}`}
        ...
        <div className="java-csharp-help-main">
          <aside className="java-csharp-help-toc" aria-label="Table of contents">
            <h2 className="java-csharp-help-toc-title">Contents</h2>
            <ul className="java-csharp-help-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="java-csharp-help-toc-item">
                  <a href={`#${section.id}`} className="java-csharp-help-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="java-csharp-help-content">
            <h1 className="java-csharp-help-doc-title">Java vs C#</h1>
