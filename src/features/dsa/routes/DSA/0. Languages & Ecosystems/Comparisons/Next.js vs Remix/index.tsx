...
.next-remix-help-controls {
  display: flex;
  gap: 2px;
  margin-left: auto;
}

.next-remix-help-control {
  width: 18px;
  height: 16px;
  padding: 0;
...
.next-remix-help-tab-active {
  background: #fff;
  position: relative;
  top: 1px;
}

.next-remix-help-main {
  flex: 1;
  min-height: 0;
  display: grid;
...
.next-remix-help-toc-title {
  margin: 0 0 10px;
  font-size: 12px;
  font-weight: 700;
}

.next-remix-help-toc-list {
  margin: 0;
  padding: 0;
  list-style: none;
}

.next-remix-help-toc-item {
  margin: 0 0 8px;
}

.next-remix-help-toc-link {
  color: #000;
  text-decoration: none;
  font-size: 12px;
}

.next-remix-help-content {
  overflow: auto;
  padding: 14px 20px 20px;
}

.next-remix-help-doc-title {
  margin: 0 0 10px;
  font-size: 20px;
  font-weight: 700;
}

.next-remix-help-section {
  margin: 0 0 20px;
}

.next-remix-help-heading {
  margin: 0 0 8px;
  font-size: 16px;
  font-weight: 700;
}

.next-remix-help-content p,
.next-remix-help-content li {
  font-size: 12px;
  line-height: 1.5;
}
...
.next-remix-help-content ul {
  margin: 0 0 10px 20px;
  padding: 0;
}

.next-remix-help-divider {
  margin: 14px 0;
  border: 0;
  border-top: 1px solid #d0d0d0;
}

.next-remix-help-codebox {
  margin: 6px 0 10px;
  padding: 8px;
  background: #f4f4f4;
...
export default function NextJsVsRemixPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Next.js vs Remix (${activeTabLabel})`
  ...
  return (
    <div className="next-remix-help-page">
      <style>{pageStyles}</style>
      <div className="next-remix-help-window" role="presentation">
        <header className="next-remix-help-titlebar">
          <span className="next-remix-help-titletext">Next.js vs Remix</span>
          <div className="next-remix-help-controls">
            <button
              className="next-remix-help-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="next-remix-help-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="next-remix-help-tabs" role="tablist" aria-label="Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              className={`next-remix-help-tab ${activeTab === tab.id ? 'next-remix-help-tab-active' : ''}`}
        ...
        <div className="next-remix-help-main">
          <aside className="next-remix-help-toc" aria-label="Table of contents">
            <h2 className="next-remix-help-toc-title">Contents</h2>
            <ul className="next-remix-help-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="next-remix-help-toc-item">
                  <a href={`#${section.id}`} className="next-remix-help-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="next-remix-help-content">
            <h1 className="next-remix-help-doc-title">Next.js vs Remix</h1>
