...
const fitGuide = [
  {
    ...
    choice:
      'Use group-based IAM on the resource hierarchy, with federation or Google-managed identities as appropriate.',
  },
  {
    title: 'Need workload access inside Google Cloud',
    choice:
      'Use attached service accounts and short-lived credentials, not downloaded service account keys.',
  },
  {
    title: 'Need external users from another identity system',
    choice:
      'Use Workforce Identity Federation instead of creating redundant local accounts wherever possible.',
  },
  {
    title: 'Need external workloads to call Google Cloud APIs',
    choice:
      'Use Workload Identity Federation and service account impersonation patterns instead of static keys.',
  },
  {
    title: 'Need time-bound privileged access',
    choice:
      'Use Privileged Access Manager or other just-in-time elevation patterns instead of permanent broad grants.',
  },
]
...
const glossaryTerms = [
  ...
  },
  {
    ...
    definition: 'A Google Cloud capability for just-in-time, temporary elevated access workflows.',
  },
  {
    ...
    >
      ...
      {activeTab === 'big-picture' && (
        <>
          ...
          <section id="bp-identities" className="bin98-section">
            <h2 className="bin98-heading">Identity Choices</h2>
          ...
          <section id="bp-flow" className="bin98-section">
            <h2 className="bin98-heading">Evaluation Flow</h2>
            <ol>
          ...
          <section id="bp-fit" className="bin98-section">
            <h2 className="bin98-heading">When to Use Which Model</h2>
            <ul>
              {fitGuide.map((item) => (
                <li key={item.title}>
        ...
        <>
          ...
          <section id="glossary-sources" className="bin98-section">
            ...
            <p>
              ...
              15, 2026. IAM features, policy capabilities, and product guidance can change, so
