...
const fitGuide = [
  ...
  {
    title:
      'Need durable event transport with pull workers, push webhooks, and analytics export from the same event source',
    choice:
      'Pub/Sub is a strong fit because subscriptions provide separate delivery contracts over one topic.',
  },
  {
    title:
      'Need explicit deferred task execution with countdown scheduling and queue-by-queue worker control',
  ...
  {
    title:
      'Need synchronous request-response or immediate transactional confirmation from a downstream service',
    ...
    >
      ...
      {activeTab === 'big-picture' && (
        <>
          ...
          <section id="bp-delivery" className="bin98-section">
            <h2 className="bin98-heading">Subscription Choices</h2>
          ...
          <section id="bp-flow" className="bin98-section">
            <h2 className="bin98-heading">Delivery Flow</h2>
            <ol>
          ...
          <section id="bp-fit" className="bin98-section">
            <h2 className="bin98-heading">When to Use Pub/Sub</h2>
            <ul>
              {fitGuide.map((item) => (
                <li key={item.title}>
        ...
        <>
          ...
          <section id="glossary-sources" className="bin98-section">
            ...
            <p>
              ...
              15, 2026. Pub/Sub delivery features, limits, and subscription capabilities can change,
              so production decisions should always be verified against the current documentation.
            </p>
            <ul>
