  ...
  return (
    ...
    >
      ...
      <p className="gcp-stack-help-intro">
        ...
        architectural patterns that recur across real systems built on Google Cloud.
      </p>
      ...
      {activeTab === 'core-concepts' && (
        <>
          <section id="core-governance" className="bin98-section">
            <h2 className="bin98-heading">Projects and Governance</h2>
          ...
          <section id="core-integration" className="bin98-section">
            <h2 className="bin98-heading">Messaging and Eventing</h2>
