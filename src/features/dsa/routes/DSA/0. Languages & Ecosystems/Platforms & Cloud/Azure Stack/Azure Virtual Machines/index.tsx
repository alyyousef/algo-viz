...
export default function AzureVirtualMachinesPage(): JSX.Element {
  const { activeTab, setActiveTab } = useTopicTabs({
    tabs,
    pageTitle: 'Azure Virtual Machines Page',
    defaultTab: 'big-picture',
  })

  return (
    <TopicPageShell
      title="Azure Virtual Machines Page"
      tabs={tabs}
      activeTab={activeTab}
        ...
        <>
          ...
          <section id="glossary-sources" className="bin98-section">
            ...
            <p>
              ...
              checked on March 13, 2026. Azure Virtual Machines features, retirement dates, pricing
              options, and size availability can change, so production decisions should always be
