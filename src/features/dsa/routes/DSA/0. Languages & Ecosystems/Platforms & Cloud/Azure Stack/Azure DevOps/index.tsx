...
export default function AzureDevOpsPage(): JSX.Element {
  const { activeTab, setActiveTab, handleMinimize } = useTopicTabs({
    tabs,
    pageTitle: 'Azure Dev Ops Page',
    defaultTab: 'big-picture',
  })

  return (
    <TopicPageShell
      title="Azure Dev Ops Page"
      tabs={tabs}
      activeTab={activeTab}
        ...
        <>
          ...
          <section id="glossary-sources" className="bin98-section">
            ...
            <p>
              ...
              checked on March 13, 2026. Azure DevOps features, licensing details, preview states,
              and service behavior can change, so production decisions should always be revalidated
