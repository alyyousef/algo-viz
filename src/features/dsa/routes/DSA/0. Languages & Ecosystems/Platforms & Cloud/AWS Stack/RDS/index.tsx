...
const fitGuide = [
  ...
  {
    title:
      'Need read scaling and automatic failover in one managed topology without moving to Aurora',
  ...
  {
    title:
      'Need pooled connection management for bursty clients or many short-lived app connections',
  ...
  {
    title:
      'Need engine-specific cluster features, global database patterns, or Aurora-specific storage behavior',
    choice:
      'Evaluate Aurora instead of treating it as interchangeable with standard RDS DB instances.',
  },
]
...
const glossaryTerms = [
  ...
  },
  {
    ...
    definition: 'The compute and memory profile assigned to the database instance.',
  },
  {
    ...
    >
      ...
      {activeTab === 'big-picture' && (
        <>
          ...
          <section id="bp-deployments" className="bin98-section">
            <h2 className="bin98-heading">Deployment Models</h2>
        ...
        <>
          ...
          <section id="glossary-sources" className="bin98-section">
            ...
            <p>
              ...
              12, 2026. Feature support and engine-specific details can change, so production
              decisions should always be verified against the current engine and Region
              documentation.
            </p>
            <ul>
