...
const pageSubtitle =
  'Identity, roles, policies, and permission evaluation across AWS accounts and resources.'
...
const glossaryTerms = [
  ...
  {
    term: 'Trust policy',
    definition: 'The policy on a role that defines who may assume that role.',
  },
  {
  ...
  },
  {
    ...
    definition: 'The AWS container used to attach an IAM role to an EC2 instance.',
  },
  {
    term: 'Federation',
    definition:
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        and roles. The real work is understanding principals, trust, policy layers, effective
        permission calculation, and how governance scales across accounts and workloads.
      </p>
      <p>
      ...
      {activeTab === 'big-picture' && (
        <>
          ...
          <section id="bp-fit" className="bin98-section">
            <h2 className="bin98-heading">When to Choose Which Model</h2>
            <ul>
              {fitGuide.map((item) => (
                <li key={item.title}>
