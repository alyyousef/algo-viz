...
const problemPatterns = [
  ...
  },
  {
    ...
    detail: 'No data-dependent early exits: cost is predictable and independent of input order.',
  },
  {
    title: 'Teaching invariants',
    detail: 'Great for explaining loop invariants and the idea of growing a sorted prefix.',
  },
  {
...
const loopInvariants = [
  ...
  },
  {
    ...
    detail: 'Selection sort only swaps elements, so the output is a permutation of the input.',
  },
]
...
const inputSensitivity = [
  {
    ...
    detail: 'Still O(n^2) comparisons because the inner scan always runs. It only saves swaps.',
  },
  {
    title: 'Reverse sorted input',
    detail: 'Same number of comparisons as any input. Swaps are still one per pass.',
  },
  {
...
const performanceProfile = [
  {
    title: 'Comparisons',
    detail: 'About n(n-1)/2 comparisons every time, which dominates runtime.',
  },
  {
    title: 'Swaps',
    detail: 'At most n-1 swaps. This is the main advantage over bubble or insertion sort.',
  },
  {
    title: 'Memory',
    detail: 'In-place with O(1) extra memory and simple control flow.',
  },
  {
    title: 'Branch predictability',
    detail: 'The inner loop is regular and predictable, but still heavy for large n.',
  },
]
...
const variantsAndTweaks = [
  {
    ...
    detail: 'Find min and max in one pass, then place them at the front and back to shrink faster.',
  },
  {
...
const glossary = [
  ...
  {
    term: 'Sorted prefix',
    definition: 'The left side of the array that is already sorted and finalized after each pass.',
  },
  {
    term: 'Unsorted suffix',
    definition: 'The remaining right side scanned each pass to find the next minimum.',
  },
  {
    term: 'Loop invariant',
    definition: 'A property that stays true during execution, used to reason about correctness.',
  },
  {
    term: 'Stable sort',
    definition: 'A sort that preserves the relative order of equal elements.',
  },
  {
    term: 'In-place',
    definition: 'Uses constant extra memory beyond the input array, typically O(1).',
  },
  {
    term: 'Write-sparing',
    definition: 'A behavior that minimizes data writes, useful on wear-limited storage.',
  },
  {
...
export default function SelectionSortPage(): JSX.Element {
  ...
  return (
    ...
    >
      <h1 className="bin98-doc-title">Selection Sort</h1>
      <p>
        Selection sort walks the unsorted region to find an extreme element, then performs a single
        swap to grow the sorted prefix. It is in-place, swap-light, and predictably Theta(n^2),
        making it interesting for write-sensitive cases but unfit for large inputs.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          <section id="bp-overview" className="bin98-section">
            ...
            <p>
              Each pass locks one element into its final position at the boundary of sorted and
              unsorted regions. Comparisons dominate runtime, while swaps are capped at one per
              pass, which is why selection sort can win in write-constrained environments despite
              its quadratic comparisons.
            </p>
          </section>
      ...
      {activeTab === 'core-concepts' && (
        <>
          ...
          <section id="core-uses" className="bin98-section">
            <h2 className="bin98-heading">Real-World Uses</h2>
