...
const implementationTips = [
  {
    ...
    detail: 'Store a[i] in a temporary key to avoid repeated array reads while shifting.',
  },
  {
    title: 'Prefer index arithmetic over swaps',
    detail: 'Shifting contiguous memory is faster than repeated swapping and preserves stability.',
  },
  {
...
const glossary = [
  ...
  },
  {
    term: 'Hybrid cutoff',
    definition:
      'Threshold where recursive O(n log n) sorts switch to insertion sort on tiny partitions.',
  },
]
...
export default function InsertionSortPage(): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <p>
        Insertion sort builds a sorted prefix by shifting larger elements right to make space for
        each new key. It is stable, in-place, and adaptive on nearly sorted data, which makes it a
        staple for tiny arrays, streaming inserts, and hybrid cutoffs in faster sorts.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          <section id="bp-overview" className="bin98-section">
            ...
            <p>
              Each iteration keeps the left side sorted while one new element slides left to its
              place. On sorted data, the algorithm is linear; on random data it is quadratic. That
              balance makes it perfect for small buffers, nearly ordered sequences, and as the
              finishing step inside faster divide-and-conquer sorts.
            </p>
      ...
      {activeTab === 'core-concepts' && (
        <>
          ...
          <section id="core-complexity" className="bin98-section">
            ...
            <p>
              Rule of thumb: for n under a few dozen or when inversions are rare, insertion sort can
              outrun O(n log n) sorts because of its low overhead and cache friendliness. Beyond
              that, switch to merge, heap, quick, or TimSort.
            </p>
          </section>
      ...
      {activeTab === 'glossary' && (
        <section id="glossary-terms" className="bin98-section">
          ...
          <h2 className="bin98-heading">Quick Checks</h2>
