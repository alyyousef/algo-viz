...
const formalDefinition = [
  {
    title: 'State',
    detail: 'dp[l][r] is the optimal value for the subarray or substring from l to r (inclusive).',
  },
  {
    title: 'Transition',
    detail: 'dp[l][r] = best over k in [l, r]: combine(dp[l][k], dp[k+1][r], cost(l, k, r)).',
  },
  {
    title: 'Order',
    detail:
...
const mentalModels = [
  ...
  },
  {
    ...
    detail: 'You cannot compute dp[l][r] until all shorter intervals inside it are done.',
  },
  {
    title: 'Combine with boundary cost',
    detail: 'Many interval problems add a cost that depends on the endpoints and the split choice.',
  },
]
...
const algorithmSteps = [
  {
    ...
    detail: 'Decide what dp[l][r] represents and what the base case should return.',
  },
  {
    title: 'Pick transition',
    detail: 'Choose the split rule or last-action rule and write the combine cost.',
  },
  {
    title: 'Loop by length',
    detail: 'For len from 1..n, compute dp[l][r] for every interval of that length.',
  },
  {
    title: 'Read final answer',
    detail: 'The result is usually dp[0][n-1] for the full interval.',
  },
]
...
const workedExample = [
  {
    ...
    detail: 'Matrices A, B, C with dims 10x30, 30x5, 5x60. dims = [10, 30, 5, 60].',
  },
  {
    title: 'Base cases',
    detail: 'dp[i][i] = 0, a single matrix costs no multiplications.',
  },
  {
    title: 'Length 2',
    detail: 'dp[0][1] = 10*30*5 = 1500. dp[1][2] = 30*5*60 = 9000.',
  },
  {
    title: 'Length 3',
    detail:
...
const implementationNotes = [
  {
    title: 'Indexing',
    detail: 'Use inclusive indices for clarity and be consistent about endpoints.',
  },
  {
    title: 'Infinity guards',
    detail: 'Initialize dp with large values and take min or max carefully.',
  },
  {
    title: 'Prefix sums',
    detail: 'Precompute sums for interval costs like merge stones.',
  },
  {
    title: 'Reconstruction',
    detail: 'Store the best split k to rebuild the structure (tree, parentheses, cut points).',
  },
]
...
const complexityNotes = [
  {
    ...
    detail: 'Most interval DP runs in O(n^3) time and O(n^2) space because of the split loop.',
  },
  {
    title: 'When it is too slow',
    detail: 'n around 500 or more can be heavy; consider optimizations or pruning.',
  },
  {
    title: 'Common optimizations',
    detail: 'Knuth or quadrangle inequality optimizations can reduce some problems to O(n^2).',
  },
]
...
const optimizationPlaybook = [
  ...
  },
  {
    ...
    detail: 'If the cost is convex or has monotone opt, compute dp rows in O(n log n).',
  },
  {
    title: 'Prune by constraints',
    detail: 'If only certain k are valid (like merge piles in groups), skip invalid splits early.',
  },
]
...
const miniFaq = [
  ...
  },
  {
    ...
    answer: 'Either works, but inclusive [l, r] is common. Stay consistent and test small cases.',
  },
  {
    question: 'How do I reconstruct the answer?',
    answer: 'Store the best split k in a separate table and recursively rebuild the structure.',
  },
  {
...
export default function IntervalDPPage(): JSX.Element {
  ...
  return (
    ...
    >
      <h1 className="bin98-doc-title">Interval DP</h1>
      <p>
        Interval DP is the template for problems where the optimal solution for a segment is built
        by choosing a split inside that segment. It appears in matrix chain multiplication,
        merge-style costs, string cuts, and game intervals.
      </p>
      <p>
        This page keeps the full concept set: formal state and transitions, recurrence patterns,
        algorithm order, worked examples, implementation details, and optimization guidance.
      </p>
      ...
      {activeTab === 'core-concepts' && (
        <>
          <section id="core-patterns" className="bin98-section">
            <h2 className="bin98-heading">Recurrence Patterns</h2>
          ...
          <section id="core-gallery" className="bin98-section">
            <h2 className="bin98-heading">Problem Gallery</h2>
      ...
      {activeTab === 'examples' && (
        <>
          <section id="ex-worked" className="bin98-section">
            <h2 className="bin98-heading">Worked Example (Matrix Chain)</h2>
