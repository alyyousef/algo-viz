...
const problemPatterns = [
  {
    ...
    detail: 'DFS finds all nodes in the same component; repeating DFS yields connected components.',
  },
  {
    title: 'Ordering problems',
    detail: 'Topological ordering and dependency resolution use DFS finish times.',
  },
  {
    title: 'Cycle detection',
    detail: 'Back edges in directed graphs indicate cycles quickly and cleanly.',
  },
  {
    title: 'Structural graph insights',
    detail: 'Low-link values reveal bridges and articulation points in networks.',
  },
  {
    title: 'Not for shortest paths',
    detail: 'DFS does not minimize hops or weights; use BFS or Dijkstra instead.',
  },
]
...
const loopInvariants = [
  ...
  },
  {
    ...
    detail: 'A node finishes after all nodes in its DFS subtree have finished.',
  },
]
...
const inputSensitivity = [
  {
    title: 'Deep graphs',
    detail: 'Very deep paths can overflow recursion stacks; iterative DFS avoids this.',
  },
  {
    title: 'High branching',
    detail: 'DFS does not blow up memory like BFS, but it may explore irrelevant branches deeply.',
  },
  {
    title: 'Graph cycles',
    detail: 'Visited marking prevents infinite loops; forgetting it causes exponential blowups.',
  },
  {
    title: 'Neighbor order',
    detail: 'Traversal sequence depends on neighbor ordering, affecting deterministic outputs.',
  },
]
...
const performanceProfile = [
  {
    ...
    detail: 'Stores only the current path and visited set, making it memory-light compared to BFS.',
  },
  {
    title: 'Stack depth',
    detail: 'Worst-case depth is V on a chain; choose iterative DFS if recursion limits are tight.',
  },
  {
...
const variantsAndTweaks = [
  ...
  {
    title: 'Color marking',
    detail: 'Use white/gray/black states to classify edges and detect cycles in directed graphs.',
  },
  {
    title: 'Tarjan low-link',
    detail: 'Augment DFS with low-link values to extract SCCs, bridges, and articulation points.',
  },
  {
    title: 'Graph pruning',
    detail: 'Stop exploring branches that violate constraints to accelerate backtracking search.',
  },
]
...
const implementationTips = [
  {
    title: 'Mark on entry',
    detail: 'Record visited as soon as you first see a node to prevent cycles.',
  },
  {
    title: 'Avoid recursion limits',
    detail: 'Use an explicit stack for very deep or adversarial graphs.',
  },
  {
    title: 'Track timestamps',
    detail: 'Entry/exit times enable edge classification and topological ordering.',
  },
  {
    title: 'Control neighbor order',
    detail: 'If deterministic output matters, sort neighbors or push in reverse order.',
  },
  {
    title: 'Guard against disconnected graphs',
    detail: 'Loop over all nodes to cover every component, not just the start node.',
  },
]
...
const glossaryTerms = [
  ...
  {
    term: 'Discovery time',
    definition: 'Timestamp captured when a node is first visited in DFS.',
  },
  {
    term: 'Finish time',
    definition: 'Timestamp captured when DFS finishes exploring a node and its descendants.',
  },
  {
    term: 'Back edge',
    definition: 'An edge to an ancestor in the DFS tree; in directed graphs it indicates a cycle.',
  },
  {
    term: 'Low-link value',
    definition:
  ...
  },
  {
    ...
    definition: 'A DAG ordering often produced by reversing DFS finish times.',
  },
]
...
export default function DepthFirstSearchPage(): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <p>
        Depth-first search explores by diving until it must backtrack. With O(V + E) work and a
        simple stack discipline, it powers topological sorts, cycle detection, articulation point
        finding, and SCC algorithms.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          <section id="bp-overview" className="bin98-section">
            ...
            <p>
              DFS is the opposite of BFS: it commits to a branch until blocked, then rewinds. This
              behavior exposes ancestry relationships and finishing times that become the backbone
              of many graph analyses beyond mere reachability.
            </p>
