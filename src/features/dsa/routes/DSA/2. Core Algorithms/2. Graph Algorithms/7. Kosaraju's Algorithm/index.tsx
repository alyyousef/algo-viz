...
const inputsOutputs = [
  {
    title: 'Input',
    detail: 'Directed graph G = (V, E), usually as an adjacency list; can be disconnected.',
  },
  {
    title: 'Output',
    detail:
...
const dataStructures = [
  ...
  {
    title: 'Visited flags',
    detail: 'Separate visited arrays for the two passes keep traversals independent and correct.',
  },
  {
    title: 'Transpose adjacency',
    detail: 'Either an explicit reversed adjacency list or an in-edge iterator, both O(V + E).',
  },
  {
    title: 'Component labels',
    detail: 'An array mapping vertex -> component ID enables fast SCC membership queries.',
  },
]
...
export default function KosarajusAlgorithmPage(): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <p>
        Kosaraju&apos;s algorithm finds strongly connected components with two DFS passes. The first
        records finishing order on the original graph; the second, on the reversed graph, peels
        components in reverse topological order of the condensation DAG.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          <section id="bp-overview" className="bin98-section">
            ...
            <p>
              SCCs collapse a directed graph into a DAG. Kosaraju achieves this in O(V + E): one DFS
              to capture finishing order, and a second on the reversed graph to collect components.
              Sink components become sources after reversal, ensuring each search stays inside one
              SCC.
            </p>
          </section>
          ...
          <section id="bp-prereq" className="bin98-section">
      ...
      {activeTab === 'core-concepts' && (
        <>
          ...
          <section id="core-correct" className="bin98-section">
            ...
            <p>
              The finish order ensures that when you start DFS on the transpose graph, you can only
              reach vertices within the same SCC. This prevents cross-component leakage and
              guarantees every SCC is found exactly once.
            </p>
          </section>
          ...
          <section id="core-variants" className="bin98-section">
            <h2 className="bin98-heading">Variants and Alternatives</h2>
      ...
      {activeTab === 'examples' && (
        <>
          ...
          <section id="ex-trace" className="bin98-section">
            <h2 className="bin98-heading">Trace Notes</h2>
