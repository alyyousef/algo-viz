...
const loopInvariants = [
  ...
  },
  {
    ...
    detail: 'Within any cycle, the heaviest edge is never required in an MST.',
  },
  {
...
const inputSensitivity = [
  {
    ...
    detail: 'Algorithms return a minimum spanning forest, one MST per connected component.',
  },
  {
    title: 'Duplicate weights',
    detail: 'Multiple valid MSTs can exist; do not assume uniqueness in tests.',
  },
  {
    title: 'Dense graphs',
    detail: 'Prim with an array-based priority queue can be competitive due to O(V^2) scanning.',
  },
  {
    title: 'Sparse graphs',
    detail: 'Kruskal with Union-Find tends to be fastest because edge sorting dominates.',
  },
]
...
const performanceProfile = [
  {
    title: 'Sorting cost',
    detail: 'Kruskal spends most time sorting; for large E, sorting dominates everything else.',
  },
  {
    title: 'Union-Find efficiency',
    detail: 'Path compression and union by rank make merges nearly constant amortized.',
  },
  {
    title: 'Priority queue overhead',
    detail: 'Prim depends on heap operations; decrease-key efficiency can matter in dense graphs.',
  },
  {
...
const variantsAndTweaks = [
  ...
  {
    title: 'Dynamic MST',
    detail: 'Maintain an MST under edge insertions/deletions with link-cut or Euler tour trees.',
  },
]
...
const implementationTips = [
  {
    ...
    detail: 'Kruskal can stop after V - 1 edges, which saves time on dense graphs.',
  },
  {
    title: 'Use Union-Find with path compression',
    detail: 'It keeps find/union operations nearly constant amortized.',
  },
  {
    title: 'Track visited vertices in Prim',
    detail: 'It prevents cycles and ensures the tree only grows outward.',
  },
  {
    title: 'Keep edges compact',
    detail: 'Store edges in a flat list to improve sorting and cache locality.',
  },
  {
    title: 'Handle duplicates in tests',
    detail: 'If weights tie, multiple MSTs are valid; compare total weight instead of exact edges.',
  },
]
...
const glossaryTerms = [
  ...
  {
    term: 'Cut Property',
    definition: 'For any cut, the lightest edge crossing it is safe to include in an MST.',
  },
  {
    term: 'Cycle Property',
    definition: 'For any cycle, the heaviest edge is not required in an MST.',
  },
  {
    term: 'Union-Find',
    definition: 'A disjoint-set structure with near-constant amortized find/union used by Kruskal.',
  },
  {
    term: 'Kruskal',
    definition:
...
export default function MinimumSpanningTreePage(): JSX.Element {
  ...
  return (
    ...
    >
      <h1 className="bin98-doc-title">Minimum Spanning Tree</h1>
      <p>
        A minimum spanning tree keeps every vertex connected with the smallest possible total
        weight. The secret is the cut and cycle properties: pick the lightest edge that crosses a
        frontier, or drop the heaviest edge in a cycle, and you never hurt optimality. Kruskal,
        Prim, and Boruvka are greedy by design, but their guardrails make the greed safe.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          <section id="bp-overview" className="bin98-section">
            ...
            <p>
              MSTs strip a weighted graph to its essential scaffold: no cycles, exactly V - 1 edges,
              and minimum cost to keep the graph connected. They are perfect for designing cheap
              infrastructure, benchmarking redundancy, and seeding approximation algorithms that
              need a low-cost baseline.
            </p>
          </section>
      ...
      {activeTab === 'core-concepts' && (
        <>
          ...
          <section id="core-mechanics" className="bin98-section">
            <h2 className="bin98-heading">Mechanics</h2>
            {mechanics.map((block) => (
          ...
          <section id="core-complexity" className="bin98-section">
            ...
            <p>
              In practice, sorting edges plus fast Union-Find often dominates. On dense graphs, Prim
              with a heap can edge ahead by avoiding a full sort. When weights are small integers,
              bucketed approaches remove the log factors entirely.
            </p>
          </section>

          <section id="core-input" className="bin98-section">
