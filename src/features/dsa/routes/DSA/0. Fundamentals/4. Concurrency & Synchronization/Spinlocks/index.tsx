...
const bigPicture = [
  ...
  },
  {
    ...
    notes: 'Misuse can burn CPU, reduce throughput, and starve other threads.',
  },
  {
    title: 'What it teaches',
    details:
      'Correctness depends on atomic operations, memory ordering, and careful usage constraints.',
    notes: 'Understanding spinlocks clarifies when blocking locks are preferable.',
  },
]
...
const mentalModel = [
  {
    title: 'Busy wait',
    detail: 'Threads loop until the lock becomes free instead of sleeping.',
  },
  {
    title: 'Atomic test-and-set',
    detail: 'Acquire attempts use atomic instructions that update the lock state.',
  },
  {
    title: 'Short critical section',
    detail: 'Spinning is only effective if the lock is released quickly.',
  },
  {
    title: 'CPU-bound cost',
    detail: 'While spinning, threads consume CPU cycles that could be used elsewhere.',
  },
]
...
const coreRules = [
  {
    ...
    detail: 'If the critical section can block or take long, use a mutex instead.',
  },
  {
    title: 'Avoid spinning on single-core systems',
    detail: 'If the lock holder cannot run, spinning wastes CPU and prevents progress.',
  },
  {
    title: 'Disable preemption carefully',
    detail: 'Kernel spinlocks may disable preemption; user-space spinlocks cannot.',
  },
  {
    title: 'Keep critical sections minimal',
    detail: 'Short, constant-time work is ideal; avoid I/O or system calls.',
  },
  {
    title: 'Use backoff under contention',
    detail: 'Exponential backoff or pause instructions reduce cache contention.',
  },
  {
    title: 'Prefer queues for fairness',
    detail: 'Ticket or MCS locks reduce starvation under high contention.',
  },
]
...
const spinlockTypes = [
  {
    ...
    detail: 'Fast but unfair; all threads hammer the same memory location.',
  },
  {
    title: 'Ticket lock',
    detail: 'Provides FIFO ordering with two counters (next, serving).',
  },
  {
    title: 'MCS lock',
    detail: 'Threads spin on local nodes; scalable under high contention.',
  },
  {
    title: 'Backoff lock',
    detail: 'Adds delay between retries to reduce cache coherency traffic.',
  },
]
...
const whenToUse = [
  {
    ...
    detail: 'Best when the lock is held for just a few instructions.',
  },
  {
    title: 'Non-blocking contexts',
    detail: 'Kernel interrupt handlers or low-level runtime code where sleeping is unsafe.',
  },
  {
    title: 'Very low contention',
    detail: 'Contention amplifies cache line traffic and wastes CPU.',
  },
  {
    title: 'Hybrid strategies',
    detail: 'Spin briefly, then fall back to blocking for longer waits.',
  },
]
...
const backoffStrategies = [
  {
    ...
    detail: 'Reduce power and give sibling threads a chance to progress.',
  },
  {
    title: 'Exponential backoff',
    detail: 'Wait longer after repeated failures to reduce contention.',
  },
  {
    title: 'Randomized backoff',
    detail: 'Jitter reduces lock-step collisions across threads.',
  },
  {
    title: 'Queue-based locks',
    detail: 'Ticket or MCS locks avoid global spinning on a single cache line.',
  },
]
...
const debuggingChecklist = [
  {
    ...
    detail: 'If yes, other threads may spin for a long time.',
  },
  {
    title: 'Is the critical section bounded?',
    detail: 'Unbounded work under a spinlock can stall the system.',
  },
  {
    title: 'Is contention too high?',
    detail: 'High contention suggests a mutex or a queue-based lock.',
  },
  {
    title: 'Are memory fences correct?',
    detail: 'Acquire/release ordering is required for correctness.',
  },
  {
    title: 'Is backoff used?',
    detail: 'Tight loops can cause cache thrash and poor HT performance.',
  },
  {
    title: 'Is the platform single-core?',
    detail: 'Spinlocks can prevent the lock holder from running.',
  },
]
...
const faq = [
  {
    ...
    answer: 'Yes, but only for extremely short critical sections and low contention.',
  },
  {
    question: 'Why not always use a mutex?',
    answer: 'Mutexes can incur kernel scheduling overhead; spinlocks avoid sleep/wake latency.',
  },
  {
    question: 'What is a hybrid lock?',
    answer: 'A lock that spins briefly and then falls back to a blocking mutex.',
  },
  {
    question: 'Do spinlocks provide fairness?',
    answer: 'Simple spinlocks do not. Ticket and MCS locks improve fairness.',
  },
  {
    question: 'Can a spinlock deadlock?',
    answer: 'Yes, if the lock holder never runs or if interrupts/preemption are mishandled.',
  },
]
...
const compareTools = [
  ...
  },
  {
    ...
    detail: 'Semaphores block when unavailable; spinlocks never sleep.',
  },
  {
  ...
  },
  {
    ...
    detail: 'RW locks allow concurrent readers; spinlocks provide only mutual exclusion.',
  },
]
...
const correctnessChecklist = [
  {
    title: 'Safety',
    detail: 'Only one thread enters the critical section at a time.',
  },
  {
    title: 'Liveness',
    detail: 'The lock holder can always make progress and release the lock.',
  },
  {
    title: 'No starvation',
    detail: 'Use fair locks (ticket/MCS) if starvation is a risk.',
  },
  {
    title: 'Bounded wait',
    detail: 'Ensure the lock is held for a bounded, short duration.',
  },
  {
    title: 'Preemption safe',
    detail: 'Avoid holding a spinlock across preemptible or blocking operations.',
  },
  {
    title: 'Memory ordering',
    detail: 'Acquire/release semantics are required around lock/unlock.',
  },
]
...
const implementationNotes = [
  {
    ...
    detail: 'Spinlocks rely on test-and-set or compare-and-swap operations.',
  },
  {
    title: 'CPU pause instruction',
    detail: 'Using a pause/yield reduces power and improves hyperthreading performance.',
  },
  {
    title: 'Cache coherence',
    detail: 'Aggressive spinning can cause cache line ping-pong.',
  },
  {
    title: 'Kernel usage',
    detail: 'Kernel spinlocks may disable interrupts to avoid deadlocks in interrupt context.',
  },
]
...
const performanceTips = [
  {
    ...
    detail: 'Otherwise the CPU cost outweighs any latency gains.',
  },
  {
    title: 'Hybrid locks',
    detail: 'Spin briefly, then block if the lock is still held.',
  },
  {
    title: 'Use backoff',
    detail: 'Backoff reduces contention on the lock cache line.',
  },
  {
    title: 'Shard shared state',
    detail: 'Reduce contention by splitting a lock into multiple locks.',
  },
  {
    title: 'Measure',
    detail: 'Spinlocks can regress performance; measure before and after.',
  },
]
...
const commonPitfalls = [
  {
    ...
    description: 'If the lock holder blocks, all other threads spin and waste CPU.',
  },
  {
    mistake: 'Overusing spinlocks',
    description: 'They scale poorly on contended hot paths in user space.',
  },
  {
    mistake: 'No backoff',
    description: 'Tight loops cause cache thrashing and power drain.',
  },
  {
    mistake: 'Unbounded critical sections',
    description: 'Long work under a spinlock can freeze progress.',
  },
  {
    mistake: 'Ignoring fairness',
    description: 'Simple test-and-set locks can starve threads.',
  },
  {
    mistake: 'Spinning on single-core',
    description: 'The lock holder cannot run to release the lock.',
  },
]
const pseudocode = [
  {
...
critical_section()
lock = 0`,
    explanation: 'The simplest form: spin until the atomic operation succeeds.',
  },
  {
    title: 'Ticket lock',
...
critical_section()
serving++`,
    explanation: 'Ticket locks enforce FIFO ordering and reduce starvation.',
  },
  {
    title: 'Hybrid lock',
    code: `for i in 1..K:
  ...
  pause()
blockOnMutex()`,
    explanation: 'Spin briefly then sleep to avoid wasting CPU.',
  },
]
...
updateRunQueue()
spinUnlock()`,
    explanation: 'Kernel code often uses spinlocks for fast updates.',
  },
  {
...
stats.counter++
spinUnlock()`,
    explanation: 'Small counters may be protected by spinlocks if contention is low.',
  },
  {
...
doWork()
unlock()`,
    explanation: 'Hybrid approaches reduce CPU waste under contention.',
  },
]
...
const timelineScenarios = [
  {
    ...
    summary: 'Short critical sections make spinlocks effective.',
  },
  {
    id: 'preempted',
    ...
    summary: 'If the lock holder cannot run, spinlocks waste CPU.',
  },
  {
    id: 'contention',
    ...
    summary: 'Use backoff or queueing locks to mitigate contention.',
  },
]
...
export default function SpinlocksPage(): JSX.Element {
  ...
  const [selectedScenarioId, setSelectedScenarioId] = useState(
    timelineScenarios[0]?.id ?? 'short-hold',
  )
  ...
  return (
    ...
    >
      <h1 className="bin98-doc-title">Spinlocks</h1>
      <p>
        Spinlocks avoid sleeping by continuously polling the lock state. This can be efficient for
        very short critical sections or in contexts where sleeping is impossible (like certain
        kernel paths). Used incorrectly, spinlocks waste CPU and harm throughput. This page explains
      ...
      {activeTab === 'big-picture' && (
        <>
          ...
          <section id="bp-why" className="bin98-section">
            <h2 className="bin98-heading">Why Spinlocks</h2>
            <p>
              Spinlocks are about latency, not throughput. Use them only when the lock hold time is
              tiny.
            </p>
            <p>
              The core tradeoff is simple: a spinlock avoids a sleep/wake cycle, but it burns CPU
              while it waits.
            </p>
          </section>
          <hr className="bin98-divider" />
          ...
          <hr className="bin98-divider" />
          <section id="bp-faq" className="bin98-section">
      ...
      {activeTab === 'core-concepts' && (
        <>
          ...
          <section id="core-types" className="bin98-section">
            <h2 className="bin98-heading">Types of Spinlocks</h2>
          ...
          <section id="core-backoff" className="bin98-section">
            <h2 className="bin98-heading">Backoff and Fairness Strategies</h2>
      ...
      {activeTab === 'examples' && (
        <>
          ...
          <section id="ex-variants" className="bin98-section">
            <h2 className="bin98-heading">Spinlock Variants</h2>
