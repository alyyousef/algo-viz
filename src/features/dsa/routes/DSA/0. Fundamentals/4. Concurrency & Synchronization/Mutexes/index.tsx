...
const bigPicture = [
  {
    ...
    notes: 'It protects shared state by serializing access to code that reads or writes it.',
  },
  {
    title: 'Why it matters',
    details:
      'Without mutual exclusion, data races corrupt shared state and produce nondeterministic bugs.',
    notes: 'Mutexes are the foundational primitive used by higher-level concurrency constructs.',
  },
  {
    title: 'What it teaches',
    details:
      'Correctness relies on invariants, careful lock ordering, and keeping critical sections small.',
    notes: 'Understanding deadlocks and contention starts with understanding mutexes.',
  },
]
...
const mentalModel = [
  ...
  },
  {
    ...
    detail: 'At most one thread holds the lock; all others block or spin.',
  },
  {
    title: 'Happens-before',
    detail: 'Unlocking a mutex publishes prior writes; locking later makes those writes visible.',
  },
]
...
const glossary = [
  { term: 'Mutex', definition: 'A lock that guarantees mutual exclusion for a critical section.' },
  {
    ...
    definition: 'Code that must be executed atomically with respect to other threads.',
  },
  ...
  { term: 'Try-lock', definition: 'A non-blocking attempt to acquire the lock.' },
  {
    ...
    definition: 'A mutex that allows re-entrant locking by the same thread.',
  },
  ...
  { term: 'Starvation', definition: 'A thread repeatedly loses the race to acquire a lock.' },
  {
    ...
    definition: 'A low-priority thread holds a lock needed by a high-priority thread.',
  },
...
const coreRules = [
  {
    ...
    detail: 'Any read or write that participates in a shared invariant must hold the mutex.',
  },
  {
    title: 'Keep critical sections small',
    detail: 'Do the minimal work under the lock, then release it.',
  },
  {
    title: 'Use consistent lock ordering',
    detail: 'Acquire multiple locks in a global order to avoid deadlock.',
  },
  {
    title: 'Avoid calling out',
    detail: 'Do not call unknown code while holding a mutex; it can re-enter or block.',
  },
  {
...
const mutexTypes = [
  {
    ...
    detail: 'The simplest and fastest option. Relocking by the same thread deadlocks.',
  },
  {
    title: 'Recursive',
    detail: 'Allows a thread to lock the same mutex multiple times, with a recursion count.',
  },
  {
    title: 'Timed',
    detail: 'Supports lock attempts with a timeout to avoid indefinite blocking.',
  },
  {
    title: 'Read-write lock',
    detail: 'Allows multiple readers or one writer; higher-level than a basic mutex.',
  },
]
...
const deadlockPrevention = [
  {
    title: 'Lock ordering',
    detail: 'Acquire multiple locks in a global, consistent order across the codebase.',
  },
  {
    title: 'Lock leveling',
    detail:
  ...
  },
  {
    ...
    detail: 'Use try-lock to avoid deadlock and retry after releasing other locks.',
  },
  {
    title: 'Timeouts',
    detail: 'Timed locks detect stalls and allow recovery paths.',
  },
  {
    title: 'Avoid nested locks',
    detail: 'When possible, redesign to minimize locking multiple resources at once.',
  },
]
...
const lockGranularity = [
  {
    ...
    detail: 'One mutex protects a large structure. Simpler but can limit concurrency.',
  },
  {
    title: 'Fine-grained',
    detail:
  ...
  {
    title: 'Sharded',
    detail: 'Partition state by hash or key to reduce contention hot spots.',
  },
  {
    title: 'Striped',
    detail: 'Use a fixed set of locks mapped to data shards for scalable access.',
  },
]
...
const debuggingChecklist = [
  {
    ...
    detail: 'If any path reads or writes without the lock, invariants can break.',
  },
  {
    title: 'Is lock ordering consistent?',
    detail: 'Check for lock acquisition cycles across threads.',
  },
  {
    title: 'Are locks released on all paths?',
    detail: 'Use scoped guards to prevent leaks on errors or early returns.',
  },
  {
    title: 'Is a lock held during I/O?',
    detail: 'I/O can block indefinitely and amplify contention.',
  },
  {
    title: 'Are critical sections minimal?',
    detail: 'Large critical sections can look like deadlocks under load.',
  },
  {
    title: 'Is lock contention measured?',
    detail: 'Use profiling tools to identify hot locks and bottlenecks.',
  },
]
...
const usagePatterns = [
  {
    ...
    detail: 'All operations on an object are wrapped in a single mutex to preserve invariants.',
  },
  {
    title: 'Split read/write paths',
    detail: 'Use a separate lock for read-mostly data to reduce contention.',
  },
  {
    title: 'Two-phase work',
    detail: 'Copy shared state under lock, then compute outside the lock.',
  },
  {
    title: 'Lock striping',
    detail: 'Map keys to one of many locks for scalable concurrent access.',
  },
]
...
const faq = [
  ...
  },
  {
    ...
    answer: 'Most mutexes require the owner to unlock. Violating this can crash or corrupt state.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Mutexes are slower for tiny operations but simpler and safer for complex invariants.',
  },
  {
...
const compareTools = [
  ...
  },
  {
    ...
    detail: 'Mutexes guard ownership; semaphores manage counts of available resources.',
  },
  {
    title: 'Mutex vs atomic',
    detail: 'Atomics handle simple operations without blocking; mutexes handle complex invariants.',
  },
  {
    title: 'Mutex vs monitor',
    detail: 'A monitor wraps a mutex plus condition variables into a disciplined module.',
  },
]
...
const correctnessChecklist = [
  {
    title: 'Safety',
    detail: 'Shared invariants are protected by the mutex and never accessed without it.',
  },
  {
    title: 'Liveness',
    detail: 'Threads can eventually acquire the lock and make progress.',
  },
  {
    title: 'Deadlock freedom',
    detail: 'No cycles in the lock acquisition graph.',
  },
  {
    title: 'Fairness',
    detail: 'If starvation is a risk, use fair mutexes or explicit queues.',
  },
  {
    title: 'Exception safety',
    detail: 'Locks are released even if errors occur inside the critical section.',
  },
  {
    title: 'Contention hotspots',
    detail: 'Identify hot locks and consider finer-grained locking or sharding.',
  },
]
...
const implementationNotes = [
  {
    ...
    detail: 'Fast paths often use user-space atomics; slow paths block in the kernel.',
  },
  {
    title: 'Ownership tracking',
    detail: 'Some mutexes track owner thread IDs to detect misuse.',
  },
  {
    title: 'Priority inversion handling',
    detail: 'Some systems support priority inheritance to reduce inversion.',
  },
  {
    title: 'Memory fences',
    detail: 'Lock/unlock act as acquire/release fences for shared memory.',
  },
]
...
const performanceTips = [
  {
    ...
    detail: 'Move non-essential work outside the lock.',
  },
  {
    title: 'Shard shared state',
    detail: 'Split a single lock into many to reduce contention.',
  },
  {
    title: 'Avoid lock convoys',
    detail: 'Keep critical sections short to prevent queues from forming.',
  },
  {
    title: 'Batch updates',
    detail: 'Amortize lock overhead by applying multiple changes in one critical section.',
  },
  {
    title: 'Prefer lock-free reads when safe',
    detail: 'Use read-mostly patterns or atomics when invariants allow it.',
  },
]
...
const commonPitfalls = [
  {
    ...
    description: 'Reads participate in invariants; skipping locks still causes data races.',
  },
  {
    mistake: 'Double locking',
    description: 'Re-locking a non-recursive mutex by the same thread deadlocks.',
  },
  {
    mistake: 'Inconsistent lock order',
    description: 'Acquiring locks in different orders across code paths can deadlock.',
  },
  {
    mistake: 'Calling external code',
    description: 'Unknown callbacks can re-enter and cause deadlocks or long stalls.',
  },
  {
    mistake: 'Holding a lock during I/O',
    description: 'Blocking I/O while holding the lock increases contention and latency.',
  },
  {
    mistake: 'Using one lock for everything',
    description: 'Over-serialization destroys parallelism; use finer-grained locking.',
  },
]
...
const pseudocode = [
  {
    ...
    explanation: 'Locks protect invariants over shared variables.',
  },
  {
    title: 'Try-lock fast path',
    code: `if (mutex.tryLock()):\n  // do quick work\n  mutex.unlock()\nelse:\n  // skip or queue work`,
    explanation: 'Try-lock avoids blocking but must handle failure paths correctly.',
  },
  {
    title: 'Two-lock ordering',
    code: `lock(A)\nlock(B)\n// work using A and B\nunlock(B)\nunlock(A)`,
    explanation: 'Always lock in a consistent global order.',
  },
]
...
const workedExamples = [
  {
    ...
    code: `lock(accountA)\nlock(accountB)\naccountA.balance -= 50\naccountB.balance += 50\nunlock(accountB)\nunlock(accountA)`,
    explanation: 'Multiple locks require consistent ordering to avoid deadlock.',
  },
  {
    title: 'Simple counter',
    code: `lock(counterMutex)\ncount = count + 1\nunlock(counterMutex)`,
    explanation: 'Even a single increment needs protection when multiple threads update it.',
  },
  {
    title: 'Guarded cache access',
    code: `lock(cacheMutex)\nvalue = cache[key]\nunlock(cacheMutex)`,
    explanation: 'Protect both reads and writes to maintain cache consistency.',
  },
]
...
const timelineScenarios = [
  {
    ...
    summary: 'Mutual exclusion ensures only one thread executes the critical section at a time.',
  },
  {
    id: 'deadlock',
    ...
    summary: 'Avoid by locking in a consistent order or using a higher-level protocol.',
  },
  {
    ...
    summary: 'Priority inheritance mitigates this in some systems.',
  },
]
...
export default function MutexesPage(): JSX.Element {
  ...
  const [selectedScenarioId, setSelectedScenarioId] = useState(
    timelineScenarios[0]?.id ?? 'contended',
  )
  ...
  return (
    ...
    >
      <h1 className="bin98-doc-title">Mutexes</h1>
      <p>
        Mutexes protect shared state by allowing only one thread at a time to execute critical
        sections. They provide the simplest and most common way to avoid data races, and they
        establish the memory ordering that makes shared writes visible to other threads. This
        document covers correct usage, pitfalls, and the patterns built on top of mutexes.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          ...
          <section id="bp-why" className="bin98-section">
            ...
            <p>
              Mutual exclusion is the simplest way to keep invariants consistent under concurrency.
              Without a lock, even simple reads can observe partial or inconsistent updates.
            </p>
            <p>
              Correct locking protocols also establish the happens-before relationships that make
      ...
      {activeTab === 'core-concepts' && (
        <>
          ...
          <section id="core-rules" className="bin98-section">
            ...
            <p>
              <strong>Reminder:</strong> Mutexes guarantee mutual exclusion, not progress. Avoid
              deadlocks and starvation.
            </p>
          </section>
          <section id="core-types" className="bin98-section">
            <h2 className="bin98-heading">Types of Mutexes</h2>
            {mutexTypes.map((item) => (
              <p key={item.title}>
                <strong>{item.title}:</strong> {item.detail}
              </p>
          ...
          <section id="core-deadlock" className="bin98-section">
            <h2 className="bin98-heading">Deadlock Prevention</h2>
          ...
          <section id="core-granularity" className="bin98-section">
            <h2 className="bin98-heading">Lock Granularity</h2>
          ...
          <section id="core-usage" className="bin98-section">
            <h2 className="bin98-heading">Usage Patterns</h2>
      ...
      {activeTab === 'examples' && (
        <>
          ...
          <section id="ex-timeline" className="bin98-section">
            ...
            <p>
              Select a scenario and step through how locks behave. This highlights contention,
              deadlock, and scheduling effects.
            </p>
