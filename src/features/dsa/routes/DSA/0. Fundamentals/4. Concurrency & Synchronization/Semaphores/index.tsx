...
const bigPicture = [
  {
    ...
    notes: 'Unlike a mutex, a semaphore does not have ownership; any thread can signal.',
  },
  {
    title: 'Why it matters',
    details:
      'Semaphores model resource pools and coordination patterns like producer-consumer and rate limiting.',
    notes: 'They are powerful but easy to misuse without clear invariants.',
  },
  {
    title: 'What it teaches',
    details: 'Correctness relies on counting, invariants, and keeping P/V usage balanced.',
    notes:
...
const mentalModel = [
  {
    title: 'Counter',
    detail: 'Represents available permits; wait decrements, signal increments.',
  },
  {
    title: 'Blocking',
    detail: 'If the counter is zero, wait blocks until another thread signals.',
  },
  {
    title: 'No ownership',
    detail: 'Any thread can signal; semaphores do not enforce who releases.',
  },
  {
    title: 'Resource pool',
    detail: 'A semaphore of N permits allows up to N concurrent users of a resource.',
  },
]
...
const glossary = [
  {
    term: 'Semaphore',
    definition: 'A synchronization primitive that manages a nonnegative counter.',
  },
  {
    term: 'P / wait / down',
    definition: 'Atomically decrement the counter or block if it is zero.',
  },
  {
    term: 'V / signal / up',
    definition: 'Atomically increment the counter and wake a waiter if any.',
  },
  {
    term: 'Binary semaphore',
    definition: 'A semaphore with values 0 or 1; can behave like a mutex.',
  },
  ...
  { term: 'Fair semaphore', definition: 'A semaphore that wakes waiters in FIFO order.' },
  {
    ...
    definition: 'Many threads wake at once even though only a few can proceed.',
  },
]
...
const coreRules = [
  {
    ...
    detail: 'Know exactly what the counter represents (free slots, resources, credits).',
  },
  {
    title: 'Keep P/V balanced',
    detail: 'Every wait should eventually be matched with a signal, or the system will stall.',
  },
  {
    title: 'Do not mix roles',
    detail: 'Use different semaphores for different constraints to avoid confusion.',
  },
  {
    title: 'Avoid using as a mutex',
    detail: 'Binary semaphores can mimic mutexes but do not enforce ownership.',
  },
  {
    title: 'Do not signal before state change',
    detail: 'Signal should reflect actual resource availability.',
  },
  {
    title: 'Prefer higher-level constructs',
    detail: 'If possible, use condition variables or monitors for complex predicates.',
  },
]
...
const semaphoreTypes = [
  {
    ...
    detail: 'Values 0/1. Often used for mutual exclusion but lacks ownership safety.',
  },
  {
    title: 'Counting semaphore',
    detail: 'Values 0..N. Models N identical resources or slots.',
  },
  {
    title: 'Timed semaphore',
    detail: 'Supports timeouts to avoid blocking forever.',
  },
  {
    title: 'Fair semaphore',
    detail: 'Wakes waiters in FIFO order to reduce starvation.',
  },
]
...
const permitAccounting = [
  {
    ...
    detail: 'Counter equals number of available permits for a shared resource.',
  },
  {
    title: 'Acquire protocol',
    detail: 'wait() consumes a permit before entering the resource region.',
  },
  {
    title: 'Release protocol',
    detail: 'signal() returns a permit after exiting the resource region.',
  },
  {
    title: 'Bounded capacity',
    detail: 'The counter must never exceed the number of real resources.',
  },
  {
    title: 'Zero means block',
    detail: 'When the counter is zero, no permits exist and threads must wait.',
  },
]
...
const usagePatterns = [
  {
    title: 'Resource pool',
    detail: 'Permits represent a fixed pool (connections, buffers, GPU slots).',
  },
  {
    title: 'Producer-consumer',
    detail: 'Two semaphores track capacity (empty) and occupancy (full).',
  },
  {
    title: 'Rate limiter',
    detail: 'Permits are replenished periodically to cap throughput.',
  },
  {
    title: 'Barrier-like coordination',
    detail: 'Semaphores can approximate barriers but condition variables are usually clearer.',
  },
]
...
const debuggingChecklist = [
  {
    title: 'Balanced P/V?',
    detail: 'Every successful wait() must eventually signal() or the system leaks permits.',
  },
  {
    title: 'Counter bounds?',
    detail: 'Never allow the counter to go negative or exceed resource capacity.',
  },
  {
    title: 'Correct semaphore for each rule?',
    detail: 'Separate distinct constraints into separate semaphores.',
  },
  {
    title: 'Shutdown protocol?',
    detail: 'Define how blocked threads should exit if the system is stopping.',
  },
  {
    title: 'Spurious wakeups handled?',
    detail: 'Some implementations can still wake spuriously; check invariants.',
  },
  {
    title: 'No hidden ownership?',
    detail: 'Semaphores do not enforce owners; mistakes can be silent.',
  },
]
...
const faq = [
  ...
  },
  {
    ...
    answer: 'It should not. Over-release breaks the invariant and allows too many threads in.',
  },
  {
...
const exampleTable = [
  {
    pattern: 'Pool',
    permits: 'N connections',
    wait: 'acquire before use',
    signal: 'release after close',
  },
  {
    pattern: 'Buffer',
    permits: 'empty/full slots',
    wait: 'producer waits empty',
    signal: 'consumer signals empty',
  },
  {
    pattern: 'Rate limit',
    permits: 'tokens per interval',
    wait: 'request waits token',
    signal: 'refill loop',
  },
  {
    pattern: 'Parking',
    permits: 'free spots',
    wait: 'enter waits spot',
    signal: 'exit signals spot',
  },
]
...
const compareTools = [
  ...
  },
  {
    ...
    detail: 'Channels combine queueing and synchronization; semaphores only count permits.',
  },
  {
    title: 'Semaphore vs atomic',
    detail: 'Atomics manage simple state without blocking; semaphores coordinate blocking access.',
  },
]
...
const correctnessChecklist = [
  {
    title: 'Safety',
    detail: 'The counter never goes negative and accurately reflects available resources.',
  },
  {
    title: 'Liveness',
    detail: 'Waiters eventually proceed when permits become available.',
  },
  {
    title: 'No permit leaks',
    detail: 'Every acquire is matched by a release, even on error paths.',
  },
  {
    title: 'No over-release',
    detail: 'Do not signal more times than resources available; this violates the model.',
  },
  {
    title: 'Fairness',
    detail: 'If starvation is possible, use FIFO or priority-aware semaphores.',
  },
  {
    title: 'Shutdown behavior',
    detail: 'Define how waiters exit when the system is stopping.',
  },
]
...
const implementationNotes = [
  {
    ...
    detail: 'Semaphores are often built on OS wait queues or futex-like primitives.',
  },
  {
    title: 'Atomicity',
    detail: 'P and V must be atomic to avoid races and incorrect counts.',
  },
  {
  ...
  },
  {
    ...
    detail: 'Acquire/release semantics ensure state changes are visible to awakened threads.',
  },
]
...
const performanceTips = [
  {
    ...
    detail: 'If multiple permits become available, signal accordingly in one block.',
  },
  {
    title: 'Prefer try-wait in fast paths',
    detail: 'Avoid blocking when you can skip work or use a fallback path.',
  },
  {
    title: 'Limit contention',
    detail: 'Use multiple semaphores or sharded resources if a single one is hot.',
  },
  {
    title: 'Avoid thundering herd',
    detail: 'Signal only as many threads as there are available permits.',
  },
  {
    title: 'Instrument for leaks',
    detail: 'Track permits in debug builds to catch missing releases.',
  },
]
...
const commonPitfalls = [
  ...
  },
  {
    ...
    description: 'Missing a signal causes a deadlock; extra signals break the invariant.',
  },
  {
    mistake: 'Signaling before resource release',
    description: 'Wakeups can happen when no real resource is available.',
  },
  {
    mistake: 'Single semaphore for multiple rules',
    description: 'Mixing constraints in one counter makes reasoning difficult.',
  },
  {
    mistake: 'No shutdown path',
    description: 'Waiters can block forever when the system is shutting down.',
  },
  {
    mistake: 'Ignoring fairness',
    description: 'Starvation can occur if waiters are not scheduled fairly.',
  },
]
...
const pseudocode = [
  {
    ...
    explanation: 'Up to 3 threads may use the resource concurrently.',
  },
  {
    title: 'Producer-consumer (semaphore version)',
    code: `semaphore empty = capacity\nsemaphore full = 0\nmutex m\n\nproducer():\n  wait(empty)\n  lock(m)\n  enqueue(item)\n  unlock(m)\n  signal(full)\n\nconsumer():\n  wait(full)\n  lock(m)\n  item = dequeue()\n  unlock(m)\n  signal(empty)`,
    explanation: 'Semaphores control capacity; a mutex protects the queue.',
  },
  {
    title: 'Try-wait fast path',
    code: `if (tryWait(permits)):\n  doWork()\n  signal(permits)\nelse:\n  skipOrQueue()`,
    explanation: 'Try-wait is useful for opportunistic work.',
  },
]
...
const workedExamples = [
  {
    ...
    explanation: 'The semaphore caps concurrent connections to a server.',
  },
  {
    title: 'Rate limiter',
    code: `semaphore tokens = N\n\nrequest():\n  wait(tokens)\n  handleRequest()\n\nrefillLoop():\n  every second: signal(tokens)`,
    explanation: 'Tokens represent allowed requests per time window.',
  },
  {
    title: 'Parking lot',
    code: `semaphore spots = 50\n\nenter():\n  wait(spots)\n  park()\n\nexit():\n  leave()\n  signal(spots)`,
    explanation: 'Each permit corresponds to a free parking spot.',
  },
]
...
const timelineScenarios = [
  {
    ...
    summary: 'The semaphore ensures at most 2 threads are inside the resource.',
  },
  {
    id: 'bounded-buffer',
    ...
    summary: 'Two semaphores track capacity and occupancy.',
  },
  {
    id: 'leak',
    title: 'Permit leak',
    ...
    summary: 'Missing signal calls lead to permanent resource loss.',
  },
]
...
export default function SemaphoresPage(): JSX.Element {
  ...
  return (
    ...
    >
      <h1 className="bin98-doc-title">Semaphores</h1>
      <p>
        Semaphores are counters with atomic wait and signal operations. They are ideal for
        controlling access to a fixed-size resource pool and for expressing classic
        producer-consumer coordination. This document covers the mental model, usage rules, and how
        to avoid common mistakes like permit leaks.
      </p>
      ...
      {activeTab === 'big-picture' && (
        <>
          ...
          <section id="bp-why" className="bin98-section">
            ...
            <p>
              Semaphores are about availability, not ownership. They are a natural fit for shared
              resources, rate limiting, and producer-consumer pipelines.
            </p>
            <p>
              Misuse is costly: missing a signal causes leaks, while extra signals allow too many
              threads into a region.
            </p>
          </section>
          <hr className="bin98-divider" />
      ...
      {activeTab === 'core-concepts' && (
        <>
          ...
          <section id="core-rules" className="bin98-section">
            ...
            <p>
              <strong>Reminder:</strong> The counter must always equal available permits.
            </p>
          </section>
          <section id="core-types" className="bin98-section">
            <h2 className="bin98-heading">Types of Semaphores</h2>
          ...
          <section id="core-accounting" className="bin98-section">
            <h2 className="bin98-heading">Permit Accounting</h2>
