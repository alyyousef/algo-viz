    ...
    terms: [
      {
        term: 'Entry',
        definition:
          'A starting point from which Webpack begins building the dependency graph.',
      },
      {
        term: 'Output',
        definition:
          'The emitted assets and chunk files created from the compiled graph.',
      },
      {
        term: 'Loader',
        definition:
      ...
      },
      {
        term: 'Chunk',
        definition:
          'A piece of emitted bundle output representing some portion of the graph.',
      },
      {
        term: 'HMR',
        definition:
...
.vite-webpack-help-tab-active {
  position: relative;
  top: 1px;
  background: #ffffff;
}

.vite-webpack-help-main {
  flex: 1;
  min-height: 0;
  display: grid;
...
.vite-webpack-help-toc-title {
  margin: 0 0 10px;
  font-size: 12px;
  font-weight: 700;
}

.vite-webpack-help-toc-list {
  margin: 0;
  padding: 0;
  list-style: none;
}

.vite-webpack-help-toc-item {
  margin: 0 0 8px;
}

.vite-webpack-help-toc-link {
  color: #000;
  text-decoration: none;
  font-size: 12px;
}

.vite-webpack-help-content {
  overflow: auto;
  padding: 14px 20px 20px;
}

.vite-webpack-help-doc-title {
  margin: 0 0 10px;
  font-size: 20px;
  font-weight: 700;
}

.vite-webpack-help-section {
  margin: 0 0 20px;
}

.vite-webpack-help-heading {
  margin: 0 0 8px;
  font-size: 16px;
  font-weight: 700;
}

.vite-webpack-help-content p,
.vite-webpack-help-content li {
  font-size: 12px;
  line-height: 1.5;
}
...
.vite-webpack-help-content ul {
  margin: 0 0 10px 20px;
  padding: 0;
}

.vite-webpack-help-divider {
  margin: 14px 0;
  border: 0;
  border-top: 1px solid #d0d0d0;
}

.vite-webpack-help-codebox {
  margin: 6px 0 10px;
  padding: 8px;
  background: #f4f4f4;
...
.vite-webpack-help-codebox code {
  display: block;
  white-space: pre;
...
function renderContentSection(section: ContentSection, isLast: boolean): JSX.Element {
  return (
    <section key={section.id} id={section.id} className="vite-webpack-help-section">
      <h2 className="vite-webpack-help-heading">{section.title}</h2>
      ...
      {isLast ? null : <hr className="vite-webpack-help-divider" />}
    </section>
  )
}
...
function renderExampleSection(section: ExampleSection, isLast: boolean): JSX.Element {
  return (
    <section key={section.id} id={section.id} className="vite-webpack-help-section">
      ...
      <div className="vite-webpack-help-codebox">
...
export default function ViteVsWebpackPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Vite vs Webpack (${activeTabLabel})`
  ...
  return (
    <div className="vite-webpack-help-page">
      <style>{pageStyles}</style>
      <div className="vite-webpack-help-window" role="presentation">
        <header className="vite-webpack-help-titlebar">
          <span className="vite-webpack-help-titletext">Vite vs Webpack</span>
          <div className="vite-webpack-help-controls">
            <button
              className="vite-webpack-help-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="vite-webpack-help-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="vite-webpack-help-tabs" role="tablist" aria-label="Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              className={`vite-webpack-help-tab ${activeTab === tab.id ? 'vite-webpack-help-tab-active' : ''}`}
        ...
        <div className="vite-webpack-help-main">
          <aside className="vite-webpack-help-toc" aria-label="Table of contents">
            <h2 className="vite-webpack-help-toc-title">Contents</h2>
            <ul className="vite-webpack-help-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="vite-webpack-help-toc-item">
                  <a href={`#${section.id}`} className="vite-webpack-help-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="vite-webpack-help-content">
            <h1 className="vite-webpack-help-doc-title">Vite vs Webpack</h1>
