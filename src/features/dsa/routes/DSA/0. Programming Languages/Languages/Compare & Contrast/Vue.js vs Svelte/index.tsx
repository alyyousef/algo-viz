...
.vue-svelte-help-tab-active {
  position: relative;
  top: 1px;
  background: #ffffff;
}

.vue-svelte-help-main {
  flex: 1;
  min-height: 0;
  display: grid;
...
.vue-svelte-help-toc-title {
  margin: 0 0 10px;
  font-size: 12px;
  font-weight: 700;
}

.vue-svelte-help-toc-list {
  margin: 0;
  padding: 0;
  list-style: none;
}

.vue-svelte-help-toc-item {
  margin: 0 0 8px;
}

.vue-svelte-help-toc-link {
  color: #000;
  text-decoration: none;
  font-size: 12px;
}

.vue-svelte-help-content {
  overflow: auto;
  padding: 14px 20px 20px;
}

.vue-svelte-help-doc-title {
  margin: 0 0 10px;
  font-size: 20px;
  font-weight: 700;
}

.vue-svelte-help-section {
  margin: 0 0 20px;
}

.vue-svelte-help-heading {
  margin: 0 0 8px;
  font-size: 16px;
  font-weight: 700;
}

.vue-svelte-help-subheading {
  margin: 0 0 6px;
  font-size: 13px;
  font-weight: 700;
}

.vue-svelte-help-content p,
.vue-svelte-help-content li {
  font-size: 12px;
  line-height: 1.5;
}
...
.vue-svelte-help-content ul {
  margin: 0 0 10px 20px;
  padding: 0;
}

.vue-svelte-help-divider {
  margin: 14px 0;
  border: 0;
  border-top: 1px solid #d0d0d0;
}

.vue-svelte-help-codebox {
  margin: 6px 0 10px;
  padding: 8px;
  background: #f4f4f4;
...
export default function VueJsVsSveltePage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Vue.js vs Svelte (${activeTabLabel})`
  ...
  return (
    <div className="vue-svelte-help-page">
      <style>{pageStyles}</style>
      <div className="vue-svelte-help-window" role="presentation">
        <header className="vue-svelte-help-titlebar">
          <span className="vue-svelte-help-titletext">Vue.js vs Svelte</span>
          <div className="vue-svelte-help-controls">
            <button
              className="vue-svelte-help-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="vue-svelte-help-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="vue-svelte-help-tabs" role="tablist" aria-label="Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              className={`vue-svelte-help-tab ${activeTab === tab.id ? 'vue-svelte-help-tab-active' : ''}`}
        ...
        <div className="vue-svelte-help-main">
          <aside className="vue-svelte-help-toc" aria-label="Table of contents">
            <h2 className="vue-svelte-help-toc-title">Contents</h2>
            <ul className="vue-svelte-help-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="vue-svelte-help-toc-item">
                  <a href={`#${section.id}`} className="vue-svelte-help-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="vue-svelte-help-content">
            <h1 className="vue-svelte-help-doc-title">Vue.js vs Svelte</h1>
