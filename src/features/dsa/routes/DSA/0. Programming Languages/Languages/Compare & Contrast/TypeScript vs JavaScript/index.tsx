  ...
  },
  {
    ...
    terms: [
      ...
      },
      {
        term: 'Prototype',
        definition:
          'The object-linking mechanism underlying inheritance behavior in JavaScript.',
      },
      {
        term: 'Closure',
        definition:
  ...
  },
  {
    ...
    terms: [
      ...
      },
      {
        term: 'Build Step',
        definition:
          'Any preprocessing or compilation stage that happens before runtime execution.',
      },
    ],
  },
]
...
.ts-js-help-content p,
.ts-js-help-content li {
  font-size: 12px;
  line-height: 1.5;
}
...
export default function TypeScriptVsJavaScriptPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `TypeScript vs JavaScript (${activeTabLabel})`
  ...
  return (
    <div className="ts-js-help-page">
      <style>{pageStyles}</style>
      <div className="ts-js-help-window" role="presentation">
        <header className="ts-js-help-titlebar">
          <span className="ts-js-help-titletext">TypeScript vs JavaScript</span>
          <div className="ts-js-help-controls">
            <button
              className="ts-js-help-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="ts-js-help-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="ts-js-help-tabs" role="tablist" aria-label="Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              className={`ts-js-help-tab ${activeTab === tab.id ? 'ts-js-help-tab-active' : ''}`}
        ...
        <div className="ts-js-help-main">
          <aside className="ts-js-help-toc" aria-label="Table of contents">
            <h2 className="ts-js-help-toc-title">Contents</h2>
            <ul className="ts-js-help-toc-list">
              {sectionLinks[activeTab].map((section) => (
                <li key={section.id} className="ts-js-help-toc-item">
                  <a href={`#${section.id}`} className="ts-js-help-toc-link">
                    {section.label}
                  </a>
                </li>
              ))}
          ...
          <main className="ts-js-help-content">
            <h1 className="ts-js-help-doc-title">TypeScript vs JavaScript</h1>
