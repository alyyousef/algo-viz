  ...
  },
  {
    ...
    terms: [
      ...
      },
      {
        term: 'Repo',
        definition:
          'The Ecto repository module responsible for database interaction.',
      },
      {
        term: 'Schema',
        definition:
          'An Ecto module that describes structured data fields and persistence mapping.',
      },
      {
        term: 'OTP',
        definition:
...
export default function PhoenixElixirPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    document.title = `Phoenix (Elixir) (${activeTabLabel})`
    ...
    <div className="postgres-help-page">
      ...
      <div className="postgres-help-window" role="presentation">
        <header className="postgres-help-titlebar">
          <span className="postgres-help-titletext">Phoenix (Elixir)</span>
        ...
        <div className="postgres-help-main">
          ...
          <main className="postgres-help-content">
            <h1 className="postgres-help-doc-title">Phoenix (Elixir)</h1>
            <p className="postgres-help-doc-subtitle">
              Elixir backend framework reference covering the BEAM runtime,
              request handling, LiveView, Ecto, supervision, channels, and deployment tradeoffs.
            </p>
