...
const glossarySections: GlossarySection[] = [
  {
    ...
    terms: [
      ...
      },
      {
        term: 'Operation',
        definition:
          'A computation that consumes tensors and produces tensors.',
      },
      {
  ...
  },
  {
    ...
    terms: [
      ...
      },
      {
        term: 'tf.data',
        definition:
          'The TensorFlow API for building scalable and composable input pipelines.',
      },
      {
        term: 'Retracing',
        definition:
...
const tensorflowHelpStyles = `
.tensorflow-help98-page {
  min-height: 100dvh;
  background: #c0c0c0;
  color: #000;
...
.tensorflow-help98-controls {
  display: flex;
  gap: 2px;
  margin-left: auto;
}

.tensorflow-help98-control {
  width: 18px;
  height: 16px;
  display: inline-flex;
  align-items: center;
...
.tensorflow-help98-tab.active {
  position: relative;
  top: 1px;
  background: #ffffff;
}

.tensorflow-help98-main {
  display: grid;
...
.tensorflow-help98-toc-title {
  margin: 0 0 10px;
  font-size: 12px;
  font-weight: 700;
}

.tensorflow-help98-toc-list {
  margin: 0;
  padding: 0;
  list-style: none;
}

.tensorflow-help98-toc-list li {
  margin: 0 0 8px;
}

.tensorflow-help98-toc-list a {
  color: #000;
  font-size: 12px;
  text-decoration: none;
}

.tensorflow-help98-content {
  overflow: auto;
  padding: 14px 20px 24px;
}

.tensorflow-help98-doc-title {
  margin: 0 0 12px;
  font-size: 20px;
  font-weight: 700;
}

.tensorflow-help98-section {
  margin: 0 0 20px;
}

.tensorflow-help98-heading {
  margin: 0 0 8px;
  font-size: 16px;
  font-weight: 700;
}

.tensorflow-help98-content p,
.tensorflow-help98-content li,
.tensorflow-help98-content dd,
.tensorflow-help98-content dt {
  font-size: 12px;
  line-height: 1.5;
}
...
.tensorflow-help98-content ul {
  margin: 0 0 10px 18px;
  padding: 0;
}

.tensorflow-help98-divider {
  margin: 14px 0;
  border: 0;
  border-top: 1px solid #d0d0d0;
}

.tensorflow-help98-codebox {
  margin: 8px 0 10px;
  padding: 8px;
  background: #f4f4f4;
...
.tensorflow-help98-codebox code {
  display: block;
  white-space: pre;
...
.tensorflow-help98-glossary {
  margin: 0;
}

.tensorflow-help98-glossary dt {
  margin: 0 0 2px;
  font-weight: 700;
}
...
function renderContentSection(section: ContentSection, isLast: boolean): JSX.Element {
  return (
    <section key={section.id} id={section.id} className="tensorflow-help98-section">
      <h2 className="tensorflow-help98-heading">{section.title}</h2>
      ...
      {!isLast ? <hr className="tensorflow-help98-divider" /> : null}
    </section>
  )
}
...
function renderExampleSection(section: ExampleSection, isLast: boolean): JSX.Element {
  return (
    <section key={section.id} id={section.id} className="tensorflow-help98-section">
      ...
      <div className="tensorflow-help98-codebox">
...
function renderGlossarySection(section: GlossarySection, isLast: boolean): JSX.Element {
  return (
    <section key={section.id} id={section.id} className="tensorflow-help98-section">
      <h2 className="tensorflow-help98-heading">{section.title}</h2>
      <dl className="tensorflow-help98-glossary">
...
export default function TensorFlowPage(): JSX.Element {
  ...
  return (
    <div className="tensorflow-help98-page">
      <style>{tensorflowHelpStyles}</style>
      <div className="tensorflow-help98-window" role="presentation">
        <header className="tensorflow-help98-titlebar">
          <span className="tensorflow-help98-title">{PAGE_TITLE}</span>
          <div className="tensorflow-help98-controls">
            <button
              className="tensorflow-help98-control"
              type="button"
              aria-label="Minimize"
            ...
            <Link to="/algoViz" className="tensorflow-help98-control" aria-label="Close">
              X
            </Link>
          </div>
        </header>

        <div className="tensorflow-help98-tabs" role="tablist" aria-label="Sections">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              className={`tensorflow-help98-tab ${activeTab === tab.id ? 'active' : ''}`}
        ...
        <div className="tensorflow-help98-main">
          <aside className="tensorflow-help98-toc" aria-label="Table of contents">
            <h2 className="tensorflow-help98-toc-title">Contents</h2>
            <ul className="tensorflow-help98-toc-list">
          ...
          <main className="tensorflow-help98-content">
            <h1 className="tensorflow-help98-doc-title">{PAGE_TITLE}</h1>
            {introParagraphs.map((paragraph) => (
              <p key={paragraph}>{paragraph}</p>
            ))}
            <hr className="tensorflow-help98-divider" />
