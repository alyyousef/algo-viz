...
<ComparisonTable headers={['Complexity Class', 'Solvable in Polynomial Time?', 'Verifiable in Polynomial Time?']} rows={[ ['P', 'Yes', 'Yes'], ['NP', 'Maybe (If P=NP)', 'Yes'], ['NP-Complete', 'Maybe (If P=NP)', 'Yes'], ['NP-Hard', 'Maybe (If P=NP)', 'Not Guaranteed (Could be impossible)'] ]} />
