...
<ComparisonTable headers={['Interface', 'Style', 'Best For']} rows={[ ['Pyplot (State-based)', 'MATLAB-like, implicit state tracking.', 'Quick scripts, simple interactive plots.'], ['Object-Oriented (OO)', 'Explicitly creating Figure and Axes objects.', 'Complex plots, embedding in applications, multiple subplots.'] ]} />
