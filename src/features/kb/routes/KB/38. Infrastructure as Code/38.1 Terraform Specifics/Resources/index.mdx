...
<ComparisonTable 
  ...
  rows={[
    ['`resource`', 'Write / Create', 'Terraform completely manages the lifecycle (Create, Update, Delete).'],
    ['`data`', 'Read / Query', 'Terraform only fetches the data; it cannot modify or delete the target.']
  ]} 
/>
