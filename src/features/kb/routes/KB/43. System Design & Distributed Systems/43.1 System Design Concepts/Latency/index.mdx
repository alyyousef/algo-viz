...
<ComparisonTable headers={['Operation', 'Latency', 'Human Scale Equivalent']} rows={[ ['L1 Cache Reference', '~0.5 nanoseconds', '1 heartbeat (0.5s)'], ['Branch Mispredict', '~5 nanoseconds', '10 heartbeats (5s)'], ['Main Memory (RAM) Reference', '~100 nanoseconds', '3 minutes'], ['Read 1MB sequentially from SSD', '~1,000,000 ns (1 ms)', '1 month'], ['Send a packet CA -> EU -> CA', '~150,000,000 ns (150 ms)', '15 years!'] ]} />
