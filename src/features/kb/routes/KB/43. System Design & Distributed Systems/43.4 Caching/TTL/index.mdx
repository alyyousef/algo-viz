...
<ComparisonTable headers={['Data Type', 'Recommended TTL', 'Reasoning']} rows={[ ['Stock Market Ticker', '1 to 5 Seconds', 'Financial data mathematically must be hyper-fresh. However, even a 1-second TTL shields the database from 10,000 requests a second.'], ['E-Commerce Product Details', '15 to 60 Minutes', 'Product titles and descriptions rarely change. If an admin edits a typo, the business can usually tolerate the typo remaining on the live site for another 30 minutes.'], ['Historical Analytics Reports', '7 to 30 Days', 'A report for "Sales in 2021" will mathematically never change for the rest of eternity. Cache it as long as possible.'] ]} />
