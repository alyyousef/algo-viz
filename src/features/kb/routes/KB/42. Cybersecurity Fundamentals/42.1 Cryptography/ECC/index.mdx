...
<ComparisonTable headers={['Security Level (Symmetric Equivalent)', 'RSA Key Size', 'ECC Key Size']} rows={[ ['112-bit (Minimum Secure)', '2048-bit', '224-bit'], ['128-bit (Standard)', '3072-bit', '256-bit'], ['192-bit (Top Secret)', '7680-bit', '384-bit'], ['256-bit (Quantum-resistant symmetric)', '15360-bit', '521-bit'] ]} />
