...
<ComparisonTable headers={['Phase', 'Action']} rows={[ ['Plan', 'Establish the ISMS policy, objectives, processes, and procedures relevant to managing risk. (e.g., Conducting a formal Risk Assessment).'], ['Do', 'Implement and operate the ISMS policy, controls, processes, and procedures. (e.g., Rolling out mandatory Multi-Factor Authentication).'], ['Check', 'Assess and measure process performance against policies, and report the results to management. (e.g., Internal audits).'], ['Act', 'Take corrective and preventive actions based on the results of the internal audit to achieve continual improvement.'] ]} />
