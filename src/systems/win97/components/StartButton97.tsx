import React, { forwardRef, type ButtonHTMLAttributes, type Ref, type ReactNode } from 'react'
...
export interface StartButton97Props extends ButtonHTMLAttributes<HTMLButtonElement> {
  label?: ReactNode
  icon?: ReactNode
  pressed?: boolean
  size?: 'sm' | 'md' | 'lg'
