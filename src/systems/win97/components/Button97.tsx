import React, { forwardRef, type ButtonHTMLAttributes, type ReactNode, type Ref } from 'react'
...
const Button97 = forwardRef(function Button97(
  ...
  return (
    <button ref={ref} className={composedClassName} {...rest}>
      ...
      {iconRight ? <span className="btn-97__icon btn-97__icon--right">{iconRight}</span> : null}
    </button>
  )
})
