...
function updateImports(content, childrenText) {
  ...
  const shellImport = `import TopicPageShell from '@/features/kb/components/TopicPageShell'`
  const hooksImport = `import { type TopicTab, useTopicTabs } from '@/features/kb/hooks/useTopicTabs'`
